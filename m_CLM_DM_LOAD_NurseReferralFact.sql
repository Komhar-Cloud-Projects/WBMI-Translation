...
EXP_Detect_Changes AS (
	...
	-- 
	--    )
	IFF(Lkp_NurseReferralFactId IS NULL, 'NEW', IFF(Lkp_EdwNurseReferralPkId != NurseReferralId OR Lkp_claimant_dim_id != claimant_dim_id OR Lkp_claim_occurrence_dim_id != claim_occurrence_dim_id OR Lkp_NurseReferralDimId != NurseReferralDimId OR Lkp_ReferralTotalTimeWorkedHours != ReferralTotalTimeWorkedHours, 'UPDATE', 'NOCHANGE')) AS v_ChangedFlag,
