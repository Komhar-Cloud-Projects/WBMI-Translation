...
EXP_StringValues AS (
	...
	IFF(i_LegalEntityCode IS NULL OR LENGTH(i_LegalEntityCode) = 0 OR IS_SPACES(i_LegalEntityCode), 'N/A', LTRIM(RTRIM(i_LegalEntityCode))) AS o_LegalEntityCode,
	...
	IFF(i_LegalEntityDescription IS NULL OR LENGTH(i_LegalEntityDescription) = 0 OR IS_SPACES(i_LegalEntityDescription), 'N/A', LTRIM(RTRIM(i_LegalEntityDescription))) AS o_LegalEntityDescription,
	...
	IFF(i_LegalEntityAbbreviation IS NULL OR LENGTH(i_LegalEntityAbbreviation) = 0 OR IS_SPACES(i_LegalEntityAbbreviation), 'N/A', LTRIM(RTRIM(i_LegalEntityAbbreviation))) AS o_LegalEntityAbbreviation
	FROM SQ_LegalEntity
),
