...
EXP_Lkp_Values_workers_comp_claimant_work_history_PMS AS (
	...
	TO_DATE('1/1/1800', 'MM/DD/YYYY') AS o_work_hist_created_date
...
EXP_DETECT_CHANGES_workers_comp_claimant_work_history AS (
	...
	IFF(IN_EMP_LAST_DAY_WORKED IS NULL OR IN_EMP_LAST_DAY_WORKED = TO_DATE('1/1/1900', 'MM/DD/YYYY'), TO_DATE('1/1/1800', 'MM/DD/YYYY'), IN_EMP_LAST_DAY_WORKED) AS V_EMP_LAST_DAY_WORKED_STR,
	...
	--  
	-- 
	IFF(IN_RETURN_TO_WORK_DATE IS NULL OR IN_RETURN_TO_WORK_DATE = TO_DATE('1/1/1900', 'MM/DD/YYYY'), TO_DATE('1/1/1800', 'MM/DD/YYYY'), IN_RETURN_TO_WORK_DATE) AS V_RETURN_TO_WORK_DATE_STR,
	...
	-- 'UPDATE','NOCHANGE'))
	IFF(LKP_WC_CLAIMANT_WORK_HIST_AK_ID IS NULL, 'NEW', IFF(( LKP_EMP_LAST_DAY_WORKED <> V_EMP_LAST_DAY_WORKED_STR OR LKP_RETURN_TO_WORK_DATE <> V_RETURN_TO_WORK_DATE_STR OR LKP_return_to_work_type <> v_return_to_work_type OR LKP_return_to_work_with_same_emplyr_ind <> v_return_to_work_with_same_emplyr_ind OR LKP_return_to_work_with_restriction_ind <> v_return_to_work_with_restriction_ind OR v_emplyr_paid_litigated_ind <> LKP_emplyr_paid_litigated_ind OR LKP_emplyr_paid_amt <> v_emplyr_paid_amt OR LKP_source_sys_id <> v_source_sys_id ), 'UPDATE', 'NOCHANGE')) AS V_CHANGE_FLAG,
