...
EXP_CLAIM_TRANSACTION_VALIDATE AS (
	...
	IFF(LTRIM(RTRIM(loss_entry_operator)) IS NULL OR IS_SPACES(LTRIM(RTRIM(loss_entry_operator))) OR LENGTH(LTRIM(RTRIM(loss_entry_operator))) = 0, 'N/A', LTRIM(RTRIM(loss_entry_operator))) AS Out_loss_entry_operator,
	loss_cause,
	...
	IFF(LTRIM(RTRIM(loss_draft_no)) IS NULL OR IS_SPACES(LTRIM(RTRIM(loss_draft_no))) OR LENGTH(LTRIM(RTRIM(loss_draft_no))) = 0, 'N/A', loss_draft_no) AS Out_loss_draft_no,
	...
	IFF(LTRIM(RTRIM(loss_transaction_date)) IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), to_date(LTRIM(RTRIM(loss_transaction_date)), 'YYYYMMDD')) AS Out_loss_transaction_date,
	loss_draft_pay_to_1,
	loss_draft_pay_to_2,
	loss_draft_pay_to_3,
	...
	IFF(LTRIM(RTRIM(loss_draft_mail_to)) IS NULL OR IS_SPACES(LTRIM(RTRIM(loss_draft_mail_to))) OR LENGTH(LTRIM(RTRIM(loss_draft_mail_to))) = 0, 'N/A', LTRIM(RTRIM(loss_draft_mail_to))) AS Out_loss_draft_mail_to,
...
EXP_set_defaults_txn AS (
	...
	IFF(LTRIM(RTRIM(edw_financial_type_code)) IS NULL OR LENGTH(LTRIM(RTRIM(edw_financial_type_code))) = 0, 'N/A', LTRIM(RTRIM(edw_financial_type_code))) AS financial_type_code,
	...
	TO_DATE('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS claim_pay_ctgry_start_date,
	-- *INF*: TO_DATE('12/31/2100 23:59:59','MM/DD/YYYY HH24:MI:SS')
	TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS') AS claim_pay_ctgry_end_date,
	'N/A' AS char_default,
