...
EXP_NumericValues AS (
	...
	IFF(i_SupDCTPolicyOfferingLineOfBusinessProductRulesId IS NULL, - 1, i_SupDCTPolicyOfferingLineOfBusinessProductRulesId) AS o_SupDCTPolicyOfferingLineOfBusinessProductRulesId,
	...
	IFF(i_SupDCTPolicyOfferingLineOfBusinessProductRulesAKId IS NULL, - 1, i_SupDCTPolicyOfferingLineOfBusinessProductRulesAKId) AS o_SupDCTPolicyOfferingLineOfBusinessProductRulesAKId
	FROM SQ_SupDCTPolicyOfferingLineOfBusinessProductRules
),
EXP_StringValues AS (
	SELECT
	...
	IFF(i_ModifiedUserId IS NULL OR LENGTH(i_ModifiedUserId) = 0 OR IS_SPACES(i_ModifiedUserId), 'N/A', LTRIM(RTRIM(i_ModifiedUserId))) AS o_ModifiedUserId,
	...
	IFF(i_DCTPolicyDivision IS NULL OR LENGTH(i_DCTPolicyDivision) = 0 OR IS_SPACES(i_DCTPolicyDivision), 'N/A', LTRIM(RTRIM(i_DCTPolicyDivision))) AS o_DCTPolicyDivision,
	...
	IFF(i_DCTProductCode IS NULL OR LENGTH(i_DCTProductCode) = 0 OR IS_SPACES(i_DCTProductCode), 'N/A', LTRIM(RTRIM(i_DCTProductCode))) AS o_DCTProductCode,
	...
	IFF(i_DCTProductType IS NULL OR LENGTH(i_DCTProductType) = 0 OR IS_SPACES(i_DCTProductType), 'N/A', LTRIM(RTRIM(i_DCTProductType))) AS o_DCTProductType,
	...
	IFF(i_DCTLineOfBusinessCode IS NULL OR LENGTH(i_DCTLineOfBusinessCode) = 0 OR IS_SPACES(i_DCTLineOfBusinessCode), 'N/A', LTRIM(RTRIM(i_DCTLineOfBusinessCode))) AS o_DCTLineOfBusinessCode,
	...
	IFF(i_DCTCoverageType IS NULL OR LENGTH(i_DCTCoverageType) = 0 OR IS_SPACES(i_DCTCoverageType), 'N/A', LTRIM(RTRIM(i_DCTCoverageType))) AS o_DCTCoverageType
	FROM SQ_SupDCTPolicyOfferingLineOfBusinessProductRules
),
