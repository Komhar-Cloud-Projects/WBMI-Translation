...
EXP_sup_description AS (
	...
	IFF(
	    v_sic_code_descript IS NULL
	    or LENGTH(v_sic_code_descript)>0
	    and TRIM(v_sic_code_descript)=''
	    or LENGTH(v_sic_code_descript) = 0,
	    'N/A',
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSCodeDesc) AS naics_code_description,
	...
	IFF(
	    v_state_prov_code_description_M IS NULL
	    or LENGTH(v_state_prov_code_description_M)>0
	    and TRIM(v_state_prov_code_description_M)=''
	    or LENGTH(v_state_prov_code_description_M) = 0,
	    'N/A',
	...
	IFF(
	    v_state_prov_code_description_O IS NULL
	    or LENGTH(v_state_prov_code_description_O)>0
	    and TRIM(v_state_prov_code_description_O)=''
	    or LENGTH(v_state_prov_code_description_O) = 0,
	    'N/A',
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSIndustryGroupCode) AS NAICSIndustryGroupCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(IN_NAICSIndustryGroupCodeDesc)
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSIndustryGroupCodeDesc) AS NAICSIndustryGroupCodeDesc,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSubsectorCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSubsectorCode) AS NAICSSubsectorCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSubsectorCodeDesc)
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSubsectorCodeDesc) AS NAICSSubsectorCodeDesc,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSectorCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSectorCode) AS NAICSSectorCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSectorCodeDesc)
	UDF_DEFAULT_VALUE_FOR_STRINGS(IN_NAICSSectorCodeDesc) AS NAICSSectorCodeDesc
	FROM EXP_values
