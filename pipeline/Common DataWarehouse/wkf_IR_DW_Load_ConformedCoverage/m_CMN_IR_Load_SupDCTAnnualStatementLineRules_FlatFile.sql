...
EXP_Default AS (
	...
	IFF(v_NonSubASLCode IS NULL OR v_NonSubASLCode = '' OR v_NonSubASLCode = 'NULL', 'N/A', v_NonSubASLCode) AS o_NonSubASLCode,
	-- *INF*: IIF(ISNULL(v_InsuranceLineCode) OR v_InsuranceLineCode='' OR v_InsuranceLineCode='NULL', 'N/A', v_InsuranceLineCode)
	IFF(v_InsuranceLineCode IS NULL OR v_InsuranceLineCode = '' OR v_InsuranceLineCode = 'NULL', 'N/A', v_InsuranceLineCode) AS o_InsuranceLineCode,
	-- *INF*: IIF(ISNULL(v_CoverageCode) OR v_CoverageCode='' OR v_CoverageCode='NULL', 'N/A', v_CoverageCode)
	IFF(v_CoverageCode IS NULL OR v_CoverageCode = '' OR v_CoverageCode = 'NULL', 'N/A', v_CoverageCode) AS o_CoverageCode,
	-- *INF*: IIF(ISNULL(v_RatedCoverageCode) OR v_RatedCoverageCode='' OR v_RatedCoverageCode='NULL', 'N/A', v_RatedCoverageCode)
	IFF(v_RatedCoverageCode IS NULL OR v_RatedCoverageCode = '' OR v_RatedCoverageCode = 'NULL', 'N/A', v_RatedCoverageCode) AS o_RatedCoverageCode,
	-- *INF*: IIF(ISNULL(v_CoverageGroupCode) OR v_CoverageGroupCode='' OR v_CoverageGroupCode='NULL', 'N/A', v_CoverageGroupCode)
	IFF(v_CoverageGroupCode IS NULL OR v_CoverageGroupCode = '' OR v_CoverageGroupCode = 'NULL', 'N/A', v_CoverageGroupCode) AS o_CoverageGroupCode,
	-- *INF*: IIF(ISNULL(v_CoverageSummaryCode) OR v_CoverageSummaryCode='' OR v_CoverageSummaryCode='NULL', 'N/A', v_CoverageSummaryCode)
	IFF(v_CoverageSummaryCode IS NULL OR v_CoverageSummaryCode = '' OR v_CoverageSummaryCode = 'NULL', 'N/A', v_CoverageSummaryCode) AS o_CoverageSummaryCode,
	-- *INF*: IIF(ISNULL(v_DctRiskTypeCode) OR v_DctRiskTypeCode='' OR v_DctRiskTypeCode='NULL', 'N/A', v_DctRiskTypeCode)
	IFF(v_DctRiskTypeCode IS NULL OR v_DctRiskTypeCode = '' OR v_DctRiskTypeCode = 'NULL', 'N/A', v_DctRiskTypeCode) AS o_DctRiskTypeCode,
	-- *INF*: IIF(ISNULL(v_DctCoverageTypeCode) OR v_DctCoverageTypeCode='' OR v_DctCoverageTypeCode='NULL', 'N/A', v_DctCoverageTypeCode)
	IFF(v_DctCoverageTypeCode IS NULL OR v_DctCoverageTypeCode = '' OR v_DctCoverageTypeCode = 'NULL', 'N/A', v_DctCoverageTypeCode) AS o_DctCoverageTypeCode,
	...
	IFF(v_PmsRiskUnitGroupCode IS NULL OR v_PmsRiskUnitGroupCode = '' OR v_PmsRiskUnitGroupCode = 'NULL', 'N/A', v_PmsRiskUnitGroupCode) AS o_PmsRiskUnitGroupCode,
	-- *INF*: IIF(ISNULL(v_PmsRiskUnitCode) OR v_PmsRiskUnitCode='' OR v_PmsRiskUnitCode='NULL', 'N/A', v_PmsRiskUnitCode)
	IFF(v_PmsRiskUnitCode IS NULL OR v_PmsRiskUnitCode = '' OR v_PmsRiskUnitCode = 'NULL', 'N/A', v_PmsRiskUnitCode) AS o_PmsRiskUnitCode,
	-- *INF*: IIF(ISNULL(v_PmsMajorPerilCode) OR v_PmsMajorPerilCode='' OR v_PmsMajorPerilCode='NULL', 'N/A', v_PmsMajorPerilCode)
	IFF(v_PmsMajorPerilCode IS NULL OR v_PmsMajorPerilCode = '' OR v_PmsMajorPerilCode = 'NULL', 'N/A', v_PmsMajorPerilCode) AS o_PmsMajorPerilCode,
	-- *INF*: IIF(ISNULL(v_PmsProductTypeCode) OR v_PmsProductTypeCode='' OR v_PmsProductTypeCode='NULL', 'N/A', v_PmsProductTypeCode)
	IFF(v_PmsProductTypeCode IS NULL OR v_PmsProductTypeCode = '' OR v_PmsProductTypeCode = 'NULL', 'N/A', v_PmsProductTypeCode) AS o_PmsProductTypeCode,
	-- *INF*: IIF(ISNULL(v_DctPerilGroup) OR v_DctPerilGroup='' OR v_DctPerilGroup='NULL', 'N/A', v_DctPerilGroup)
	IFF(v_DctPerilGroup IS NULL OR v_DctPerilGroup = '' OR v_DctPerilGroup = 'NULL', 'N/A', v_DctPerilGroup) AS o_DctPerilGroup,
	...
	IFF(v_DctSubCoverageTypeCode IS NULL OR v_DctSubCoverageTypeCode = '' OR v_DctSubCoverageTypeCode = 'NULL', 'N/A', v_DctSubCoverageTypeCode) AS o_DctSubCoverageTypeCode,
	-- *INF*: IIF(ISNULL(v_DctCoverageVersion) OR v_DctCoverageVersion='' OR v_DctCoverageVersion='NULL', 'N/A', v_DctCoverageVersion)
	IFF(v_DctCoverageVersion IS NULL OR v_DctCoverageVersion = '' OR v_DctCoverageVersion = 'NULL', 'N/A', v_DctCoverageVersion) AS o_DctCoverageVersion
