...
EXP_DefaultValues AS (
	...
	IFF(
	    in_uw_mgr_first_name IS NULL, 'N/A',
	    IFF(
	        LENGTH(in_uw_mgr_first_name)>0
	    and TRIM(in_uw_mgr_first_name)='', 'N/A',
	...
	IFF(
	    in_uw_mgr_middle_name IS NULL, 'N/A',
	    IFF(
	        LENGTH(in_uw_mgr_middle_name)>0
	    and TRIM(in_uw_mgr_middle_name)='', 'N/A',
	...
	IFF(
	    in_uw_mgr_last_name IS NULL, 'N/A',
	    IFF(
	        LENGTH(in_uw_mgr_last_name)>0
	    and TRIM(in_uw_mgr_last_name)='', 'N/A',
	        in_uw_mgr_last_name
	    )
	) AS uw_mgr_last_name,
	-- *INF*: iif(isnull(in_uw_mgr_suffix),'N/A',iif(IS_SPACES(in_uw_mgr_suffix),'N/A',in_uw_mgr_suffix))
	IFF(
	    in_uw_mgr_suffix IS NULL, 'N/A',
	    IFF(
	        LENGTH(in_uw_mgr_suffix)>0 AND TRIM(in_uw_mgr_suffix)='', 'N/A', in_uw_mgr_suffix
	    )
	) AS uw_mgr_suffix,
...
EXP_DetectChanges AS (
	...
	-- 	'NOCHANGE'))
	IFF(
	    uw_mgr_id_old IS NULL, 'NEW',
	    IFF(
	        (source_uw_mgr_id <> source_uw_mgr_id_old)
