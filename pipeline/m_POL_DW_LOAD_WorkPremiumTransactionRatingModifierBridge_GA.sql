...
EXP_Modifiers AS (
	...
	IFF(
	    v_Modifier_RiskUnitGroup IS NOT NULL, v_Modifier_RiskUnitGroup,
	...
	DATEADD(SECOND,86399,CAST(TRUNC(GREATEST(i_PremiumTransactionEnteredDate, PremiumTransactionEffectiveDate), 'DAY') AS TIMESTAMP_NTZ(0))) AS o_PremiumTransactionBookedDate
	FROM SQ_PMS
