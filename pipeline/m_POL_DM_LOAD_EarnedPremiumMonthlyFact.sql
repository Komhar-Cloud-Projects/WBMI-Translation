...
EXP_EarnedPremiumCalculation_IN AS (
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_PremiumTransactionCode) AS PremiumTransactionCode_lkp,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_ReasonAmendedCode) AS ReasonAmendedCode_lkp,
	EarnedPremium,
...
EXP_Evaluate_Fields AS (
	...
	IFF(
	    rtrim(PremiumType) = 'D' AND DateFlagForWrittenPremium = 'Y', PremiumTransactionAmount, 0
	...
	IFF(
	    rtrim(PremiumType) = 'C' AND DateFlagForWrittenPremium = 'Y', PremiumTransactionAmount, 0
