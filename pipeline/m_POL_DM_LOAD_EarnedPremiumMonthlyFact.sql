...
EXP_EarnedPremiumCalculation_IN AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_PremiumTransactionCode
	) AS PremiumTransactionCode_lkp,
	...
	IFF(SourceSystemID = 'DCT',
		LKP_SUP_REASON_AMENDED_CODE_LOWER_ReasonAmendedCode.StandardReasonAmendedCode,
		ReasonAmendedCode
	...
	IFF(PremiumTransactionAKID = - 1,
		...
		LKP_COVERAGEDETAILDIM_PremiumTransactionID.CoverageDetailDimId
...
EXP_Evaluate_Fields AS (
	...
	IFF(rtrim(PremiumType
		...
		AND DateFlagForWrittenPremium = 'Y',
		PremiumTransactionAmount,
		0
	...
	IFF(rtrim(PremiumType
		...
		0
	) AS v_Monthly_DirectUnearnedPremium,
	...
	IFF(rtrim(PremiumType
		...
		0
	) AS ChangeInDirectUnearnedPremium,
	...
	IFF(rtrim(PremiumType
		...
		MonthlyChangeInDirectUnearnedPremium,
		0
	) AS MonthlyChangeInCededUnearnedPremium,
