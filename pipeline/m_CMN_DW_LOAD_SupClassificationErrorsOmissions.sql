...
EXP_Detect_Changes AS (
	...
	-- 'INSERT')						
	DECODE(TRUE,
		LKP_SUPCLASSIFICATIONERRORSOMMISIONS_CURRENTCHANGEFLAG_i_RatingStateCode_i_ClassCode_i_ClassCodeOriginatingOrganization_i_EffectiveDate_i_ClassDescription.SupClassificationErrorsOmissionsId IS NOT NULL, 'NOCHANGE',
		'INSERT'
	...
	DECODE(TRUE,
		...
		lkp_SupClassificationErrorsOmissionsId IS NULL 
