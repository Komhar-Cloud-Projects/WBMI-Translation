...
EXP_StringValues AS (
	...
	IFF(
	    i_ClassOfBusiness IS NULL
	    or LENGTH(i_ClassOfBusiness) = 0
	    or LENGTH(i_ClassOfBusiness)>0
	    and TRIM(i_ClassOfBusiness)='',
	    'N/A',
	...
	IFF(
	    i_TypeBureauCode IS NULL
	    or LENGTH(i_TypeBureauCode) = 0
	    or LENGTH(i_TypeBureauCode)>0
	    and TRIM(i_TypeBureauCode)='',
	    'N/A',
	...
	IFF(
	    i_BureauSpecialUseCode IS NULL
	    or LENGTH(i_BureauSpecialUseCode) = 0
	    or LENGTH(i_BureauSpecialUseCode)>0
	    and TRIM(i_BureauSpecialUseCode)='',
	    'N/A',
	...
	IFF(
	    i_LocationUnitNumber IS NULL
	    or LENGTH(i_LocationUnitNumber) = 0
	    or LENGTH(i_LocationUnitNumber)>0
	    and TRIM(i_LocationUnitNumber)='',
	    'N/A',
	...
	IFF(
	    i_BureauCode2 IS NULL
	    or LENGTH(i_BureauCode2) = 0
	    or LENGTH(i_BureauCode2)>0
	    and TRIM(i_BureauCode2)='',
	    'N/A',
