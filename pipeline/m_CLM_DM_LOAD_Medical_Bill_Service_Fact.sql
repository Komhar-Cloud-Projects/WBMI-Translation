...
EXP_Service_Amounts AS (
	...
	-- 0)
	decode(true,
		serv_charge <> 0, ( v_gross_serv_saving / serv_charge 
		) * 100,
		0
	...
	-- )
	decode(true,
		serv_charge <> 0, ( serv_bill_review_red / serv_charge 
		) * 100,
		0
	...
	-- )
	decode(true,
		serv_charge <> 0, ( serv_network_red / serv_charge 
		) * 100,
		0
	...
	IFF(in_med_bill_serv_dim_id IS NULL,
		- 1,
		in_med_bill_serv_dim_id
	) AS med_bill_serv_dim_id,
	...
	IFF(in_med_bill_dim_id IS NULL,
		- 1,
		in_med_bill_dim_id
	) AS med_bill_dim_id,
...
EXP_Detect_Changes AS (
	...
	IFF(LKP_med_bill_serv_fact_id IS NOT NULL,
		IFF(LKP_med_bill_dim_id <> med_bill_dim_id 
