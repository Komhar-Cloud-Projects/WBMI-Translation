...
EXP_NumericValues AS (
	...
	IFF(
	    i_SupDCTPolicyOfferingLineOfBusinessProductRulesId IS NULL, - 1,
	...
	IFF(
	    i_SupDCTPolicyOfferingLineOfBusinessProductRulesAKId IS NULL, - 1,
...
EXP_StringValues AS (
	...
	IFF(
	    i_ModifiedUserId IS NULL
	    or LENGTH(i_ModifiedUserId) = 0
	    or LENGTH(i_ModifiedUserId)>0
	    and TRIM(i_ModifiedUserId)='',
	    'N/A',
	...
	IFF(
	    i_DCTPolicyDivision IS NULL
	    or LENGTH(i_DCTPolicyDivision) = 0
	    or LENGTH(i_DCTPolicyDivision)>0
	    and TRIM(i_DCTPolicyDivision)='',
	    'N/A',
	...
	IFF(
	    i_DCTProductCode IS NULL
	    or LENGTH(i_DCTProductCode) = 0
	    or LENGTH(i_DCTProductCode)>0
	    and TRIM(i_DCTProductCode)='',
	    'N/A',
	...
	IFF(
	    i_DCTProductType IS NULL
	    or LENGTH(i_DCTProductType) = 0
	    or LENGTH(i_DCTProductType)>0
	    and TRIM(i_DCTProductType)='',
	    'N/A',
	...
	IFF(
	    i_DCTLineOfBusinessCode IS NULL
	    or LENGTH(i_DCTLineOfBusinessCode) = 0
	    or LENGTH(i_DCTLineOfBusinessCode)>0
	    and TRIM(i_DCTLineOfBusinessCode)='',
	    'N/A',
	...
	IFF(
	    i_DCTCoverageType IS NULL
	    or LENGTH(i_DCTCoverageType) = 0
	    or LENGTH(i_DCTCoverageType)>0
	    and TRIM(i_DCTCoverageType)='',
	    'N/A',
