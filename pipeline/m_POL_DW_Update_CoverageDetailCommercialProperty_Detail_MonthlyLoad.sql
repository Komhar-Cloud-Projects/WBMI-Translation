...
EXP_CoverageDetailCommercialProperty1 AS (
	...
	DECODE(
	    ...
	    v_ISOPropertyCauseofLossGroup = 'SCL', IFF(
	        i_OccupanyCategory IS NULL, 'N/A', i_OccupanyCategory
	    ),
	    'N/A'
	...
	IFF(
	    i_LineType = 'Property' or i_LineType = 'SBOPProperty', v_ISOSpecialCauseOfLossCategory,
	    'N/A'
	) AS o_ISOSpecialCauseOfLossCategory,
	-- *INF*: IIF(i_LineType='Property' or i_LineType='SBOPProperty',
	-- SUBSTR(i_ClassCode,1,4),'N/A')
	IFF(
	    i_LineType = 'Property' or i_LineType = 'SBOPProperty', SUBSTR(i_ClassCode, 1, 4), 'N/A'
	) AS o_ClassCode,
	-- *INF*: IIF(i_LineType='Property' or i_LineType='SBOPProperty',
	-- DECODE(TRUE,
	...
	-- 'N/A'),'N/A')
	IFF(
	    i_LineType = 'Property' or i_LineType = 'SBOPProperty',
	    DECODE(
	        TRUE,
	        i_RateType = 'S', 'Specific',
	        i_RateType = 'C', 'Class',
...
EXP_Cal AS (
	...
	RTRIM(LTrim(
	        IFF(
	            i_ISOPropertyCauseofLossGroup = 'BGI',
	            DECODE(
	                TRUE,
