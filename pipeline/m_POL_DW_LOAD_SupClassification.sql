...
EXP_DefaultValues AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_LineOfBusinessAbbreviation) AS o_LineOfBusinessAbbreviation,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_StateCode)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_StateCode) AS o_StateCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_OriginatingOrganizationCode)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_OriginatingOrganizationCode) AS o_OriginatingOrganizationCode,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_ClassDescription) AS o_ClassDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_RatingBasis)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_RatingBasis) AS o_RatingBasis,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_ClassGroupDescription)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_ClassGroupDescription) AS o_ClassGroupDescription
...
EXP_UpdateOrInsert AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(lkp_RatingBasis) AS v_lkp_RatingBasis,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(lkp_ClassGroupDescription)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(lkp_ClassGroupDescription) AS v_lkp_ClassGroupDescription,
