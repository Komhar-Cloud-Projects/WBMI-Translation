...
EXP_Detect_Changes AS (
	...
	--         'UPDATE', 
	-- 'NOCHANGE'))
	IFF(lkp_CompensableClaimDescription IS NULL, 'NEW', IFF(LTRIM(RTRIM(CS01_CODE_DES)) != LTRIM(RTRIM(lkp_CompensableClaimDescription)), 'UPDATE', 'NOCHANGE')) AS v_ChangeFlag,
