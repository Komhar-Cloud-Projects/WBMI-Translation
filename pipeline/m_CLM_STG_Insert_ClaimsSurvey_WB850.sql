WITH
SQ_Shortcut_to_ClaimsSurvey_WB850 AS (
...
EXP_AUDIT_FIELDS AS (
	...
	Q_ID_7,
	-- *INF*: IIF(IS_NUMBER(Q_ID_7),TO_INTEGER(Q_ID_7),NULL)
	IFF(REGEXP_LIKE(Q_ID_7, '^[0-9]+$'), CAST(Q_ID_7 AS INTEGER), NULL) AS ques7_resp_val,
	Q_ID_8,
	-- *INF*: IIF(IS_NUMBER(Q_ID_8),TO_INTEGER(Q_ID_8),NULL)
	IFF(REGEXP_LIKE(Q_ID_8, '^[0-9]+$'), CAST(Q_ID_8 AS INTEGER), NULL) AS ques8_resp_val,
	Q_ID_9,
	...
	Q_ID_11,
	-- *INF*: IIF(IS_NUMBER(Q_ID_11),TO_INTEGER(Q_ID_11),NULL)
	IFF(REGEXP_LIKE(Q_ID_11, '^[0-9]+$'), CAST(Q_ID_11 AS INTEGER), NULL) AS ques11_resp_val,
	CLAIM_NUM,
	'dummy' AS Dummy_String,
	sysdate AS Extract_Date,
	@{pipeline().parameters.SOURCE_SYSTEM_ID} AS SOURCE_SYSTEM_ID
	FROM SQ_Shortcut_to_ClaimsSurvey_WB850
),
...
JNR_Get_Date AS (SELECT
	...
	EXP_AUDIT_FIELDS.ques7_resp_val, 
	EXP_AUDIT_FIELDS.ques8_resp_val, 
	EXP_AUDIT_FIELDS.ques9_resp_val, 
	EXP_AUDIT_FIELDS.ques10_resp_val, 
	EXP_AUDIT_FIELDS.ques11_resp_val, 
...
claims_survey_result_stage AS (
	...
	(form_num, claim_rep_code, ques1_resp_val, ques2_resp_val, ques3_resp_val, ques4_resp_val, ques5_resp_val, ques6_resp_val, ques7_resp_val, ques8_resp_val, ques9_resp_val, ques10_resp_val, ques11_resp_val, entry_date, claim_num, extract_date, source_system_id)
	SELECT 
	FORM_ID AS FORM_NUM, 
