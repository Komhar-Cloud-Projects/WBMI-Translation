...
EXP_Detect_Changes AS (
	...
	-- 'INSERT')						
	DECODE(TRUE,
		LKP_SUPCLASSIFICATIONUMBRELLA_CURRENTCHANGEFLAG_i_RatingStateCode_i_ClassCode_i_EffectiveDate_i_ClassDescription_i_OriginatingOrganizationCode.SupClassificationUmbrellaId IS NOT NULL, 'NOCHANGE',
		'INSERT'
	...
	DECODE(TRUE,
		...
		lkp_SupClassificationUmbrellaId IS NULL 
		OR ( i_RatingStateCode = lkp_RatingStateCode 
			AND i_ClassCode = lkp_ClassCode 
			AND i_OriginatingOrganizationCode = lkp_OriginatingOrganizationCode 
			AND ( i_ClassDescription <> lkp_ClassDescription 
