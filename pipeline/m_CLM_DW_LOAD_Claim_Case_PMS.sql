...
EXP_Stage_Validate AS (
	...
	IFF(
	    LENGTH(v_ipfcgq_month_of_loss) = 1, '0' || v_ipfcgq_month_of_loss, v_ipfcgq_month_of_loss
	) || IFF(LENGTH(v_ipfcgq_day_of_loss) = 1, '0' || v_ipfcgq_day_of_loss, v_ipfcgq_day_of_loss) || v_ipfcgq_year_of_loss AS v_date_of_loss,
	...
	IFF(
	    v_ipfcgq_last_offer_date IS NULL
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_last_offer_date)))>0
	    and TRIM(LTRIM(RTRIM(v_ipfcgq_last_offer_date)))=''
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_last_offer_date))) = 0,
	    TO_TIMESTAMP('12/31/2100 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
	    TO_TIMESTAMP(v_ipfcgq_last_offer_date, 'YYYYMMDD')
	...
	-- 
	IFF(
	    in_ipfcgq_trail_date IS NULL
	    or LENGTH(LTRIM(RTRIM(in_ipfcgq_trail_date)))>0
	    and TRIM(LTRIM(RTRIM(in_ipfcgq_trail_date)))=''
	    or LENGTH(LTRIM(RTRIM(in_ipfcgq_trail_date))) = 0,
	    TO_TIMESTAMP('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
	    TO_TIMESTAMP(in_ipfcgq_trail_date, 'YYYYMMDD')
	) AS trail_date,
	...
	IFF(
	    v_ipfcgq_demand_date_1 IS NULL
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_demand_date_1)))>0
	    and TRIM(LTRIM(RTRIM(v_ipfcgq_demand_date_1)))=''
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_demand_date_1))) = 0,
	    TO_TIMESTAMP('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
	    TO_TIMESTAMP(v_ipfcgq_demand_date_1, 'YYYYMMDD')
	) AS suit_open_date,
	...
	-- 
	IFF(
	    v_ipfcgq_offer_date_1 IS NULL OR LENGTH(RTRIM(LTRIM(v_ipfcgq_offer_date_1))) = 0,
	    IFF(
	        v_ipfcgq_last_offer_date IS NULL
	    or LENGTH(RTRIM(LTRIM(v_ipfcgq_last_offer_date))) = 0,
	        TO_TIMESTAMP('12/31/2100 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
	        TO_TIMESTAMP(v_ipfcgq_last_offer_date, 'YYYYMMDD')
	    ),
	    TO_TIMESTAMP(v_ipfcgq_offer_date_1, 'YYYYMMDD')
	) AS suit_close_date,
	ipfcgq_docket_number AS in_ipfcgq_docket_number,
	-- *INF*: SUBSTR(in_ipfcgq_docket_number,0,INSTR(in_ipfcgq_docket_number,'"'))
	SUBSTR(in_ipfcgq_docket_number, 0, REGEXP_INSTR(in_ipfcgq_docket_number, '"')) AS v_ipfcgq_docket_number,
	...
	IFF(
	    LTRIM(RTRIM(v_ipfcgq_docket_number)) IS NULL
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_docket_number)))>0
	    and TRIM(LTRIM(RTRIM(v_ipfcgq_docket_number)))=''
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_docket_number))) = 0
	...
	IFF(
	    LTRIM(RTRIM(v_ipfcgq_suit_state_county)) IS NULL
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_suit_state_county)))>0
	    and TRIM(LTRIM(RTRIM(v_ipfcgq_suit_state_county)))=''
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_suit_state_county))) = 0
	...
	SUBSTR(in_ipfcgq_court, 0, REGEXP_INSTR(in_ipfcgq_court, '"')) AS v_ipfcgq_court,
	...
	IFF(
	    LTRIM(RTRIM(v_ipfcgq_court)) IS NULL
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_court)))>0
	    and TRIM(LTRIM(RTRIM(v_ipfcgq_court)))=''
	    or LENGTH(LTRIM(RTRIM(v_ipfcgq_court))) = 0
	    or v_ipfcgq_court = '"',
	    'N/A',
...
EXP_LKP_Values AS (
	...
	IFF(
	    suit_status IS NULL
	    or LENGTH(suit_status)>0
	    and TRIM(suit_status)=''
	    or LENGTH(suit_status) = 0,
	    'N/A',
	    suit_status
	) AS Out_suit_status,
	...
	IFF(
	    prim_litigation_handler_role_code IS NULL
	    or LENGTH(prim_litigation_handler_role_code)>0
	    and TRIM(prim_litigation_handler_role_code)=''
	    or LENGTH(prim_litigation_handler_role_code) = 0,
	    'N/A',
...
EXP_Detect_Changes AS (
	...
	IFF(
	    ...
	    IFF(
	        LTRIM(RTRIM(claim_case_num)) <> LTRIM(RTRIM(OLD_claim_case_num))
	        or LTRIM(RTRIM(court)) <> LTRIM(RTRIM(OLD_suit_county))
	        or LTRIM(RTRIM(suit_state_county)) <> LTRIM(RTRIM(OLD_suit_state))
	        ...
	        or LTRIM(RTRIM(prim_litigation_handler_role_code)) <> LTRIM(RTRIM(Old_prim_litigation_handler_role_code))
