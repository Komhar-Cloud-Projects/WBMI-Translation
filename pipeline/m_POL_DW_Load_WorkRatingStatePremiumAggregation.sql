...
EXPTRANS AS (
	...
	IFF(PolicyAKId = v_prev_PolicyAKId 
		AND RatingState = v_prev_RatingState,
		1,
		0
	) AS v_SameGroupFlag,
	...
	IFF(v_SameGroupFlag = 1,
		v_SubjectDirectWrittenPremium + v_Total_SubjectDirectWrittenPremium,
	...
	IFF(v_SameGroupFlag = 1,
		i_ClassifiedAdjustmentAmount + v_Total_ClassifiedAdjustmentAmount,
	...
	IFF(v_SameGroupFlag = 1,
		i_SubjectTransactionCount + v_Total_SubjectTransactionCount,
	...
	IFF(v_SameGroupFlag = 1,
		i_RateableTransactionCount + v_Total_RateableTransactionCount,
