...
EXP_Detect_Changes AS (
	...
	IFF(OLD_sup_wc_return_to_work_type_id IS NULL, 'NEW', IFF(LTRIM(RTRIM(OLD_return_to_work_descript)) != ( LTRIM(RTRIM(return_descript_OUT)) ), 'UPDATE', 'NOCHANGE')) AS V_changed_flag,
