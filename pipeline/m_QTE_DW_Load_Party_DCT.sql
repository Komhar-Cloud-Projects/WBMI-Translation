...
EXP_Detect_Change AS (
	...
	IFF(
	    i_PrimaryPhoneNumber IS NULL
	    or LENGTH(i_PrimaryPhoneNumber)>0
	    and TRIM(i_PrimaryPhoneNumber)=''
	    or LENGTH(i_PrimaryPhoneNumber) = 0,
	    'N/A',
	...
	IFF(
	    i_SicCodeTitle IS NULL
	    or LENGTH(i_SicCodeTitle)>0
	    and TRIM(i_SicCodeTitle)=''
	    or LENGTH(i_SicCodeTitle) = 0,
	    'N/A',
	...
	IFF(
	    i_NaicsCodeTitle IS NULL
	    or LENGTH(i_NaicsCodeTitle)>0
	    and TRIM(i_NaicsCodeTitle)=''
	    or LENGTH(i_NaicsCodeTitle) = 0,
	    'N/A',
	...
	IFF(
	    i_PrefixTitleCode IS NULL
	    or LENGTH(i_PrefixTitleCode)>0
	    and TRIM(i_PrefixTitleCode)=''
	    or LENGTH(i_PrefixTitleCode) = 0,
	    'N/A',
	...
	-- 'UPDATE', 'NOCHANGE'))
	IFF(
	    lkp_PartyAKId IS NULL, 'NEW',
	    IFF(
	        lkp_PrimaryPhoneNumber != v_PrimaryPhoneNumber
