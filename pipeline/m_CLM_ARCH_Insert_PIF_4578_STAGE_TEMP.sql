WITH
SQ_pif_4578_stage_temp AS (
	SELECT
		pif_4578_stage_temp_id,
		pif_symbol,
		pif_policy_number,
		pif_module,
		loss_rec_length,
		...
		record_count,
		source_system_id
	FROM pif_4578_stage_temp
),
EXP_arch_PIF_4578_stage AS (
	SELECT
	pif_4578_stage_temp_id AS pif_4578_stage_id,
	pif_symbol,
	pif_policy_number,
	pif_module,
	loss_rec_length,
	...
	FROM SQ_pif_4578_stage_temp
),
arch_pif_4578_stage_temp AS (
	INSERT INTO arch_pif_4578_stage_temp
	...
	SELECT 
	pif_4578_stage_id AS PIF_4578_STAGE_TEMP_ID, 
	PIF_SYMBOL, 
	PIF_POLICY_NUMBER, 
	PIF_MODULE, 
	LOSS_REC_LENGTH, 
