...
EXP_Src_Values_Default AS (
	...
	IS_SPACES(IN_ImpactType), 'N/A',
	LENGTH(IN_ImpactType) = 0, 'N/A',
	LTRIM(RTRIM(IN_ImpactType))) AS ImpactType,
	...
	IS_SPACES(IN_ImpactCategory), 'N/A',
	LENGTH(IN_ImpactCategory) = 0, 'N/A',
	LTRIM(RTRIM(IN_ImpactCategory))) AS ImpactCategory,
	...
	IS_SPACES(IN_Description), 'N/A',
	LENGTH(IN_Description) = 0, 'N/A',
	LTRIM(RTRIM(IN_Description))) AS Description,
	...
	IFF(ltrim(rtrim(IN_ImpactCategoryExpirationDate)) IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), IN_ImpactCategoryExpirationDate) AS v_ImpactCategoryExpirationDate,
...
EXP_Lag_ExpirationDate AS (
	...
	-- orig_ExpirationDate)
	decode(true,
	EdwSupNurseImpactPkId = v_PREV_ROW_EdwSupNurseImpactPkId, add_to_date(v_PREV_ROW_EffectiveDate, 'SS', - 1),
