...
SQ_WBCRRiskStage AS (
	SELECT
		...
		ExtractDate,
		SourceSystemId,
		CRRiskId AS CR_RiskId,
		WBCRRiskId AS WB_CR_RiskId,
		SessionId,
		PurePremium,
		Indicator28,
		Indicator85,
		CoverageWritten,
		Indicator,
		EndorsementSafeDepositBoxTransfer,
		EndorsementIncludeMoneyForInsurance,
		EndorsementIncludeDesignatedAgents,
		EndorsementAddFaithfulPerformance,
		EndorsementIncludeSecurities,
		EndorsementIncludeBulky,
		EndorsemenFaithfulPerformanceEmployeeorPosition,
		EndorsementAddBlanketExcessLimit,
		EndorsementEmployeeTheftExcessOver,
		EndorsementAddScheduleExcessLimit,
		EndorsementAddScheduleExcessLimitFor35,
		EndorsementAddTradingCoverage,
		EndorsmentFaithfulDutyCoverage,
		EndorsementIncludeDesignatedAgents_PerEmployee,
		EndorsementAddTradingCoverage_PerEmployee,
		EndorsementCreditCardOrChargeCard,
		EndorsementAddFaithfulPerformance_PerEmployee,
		...
		EndorsementIncludeComputerSoftwareContractors_PerEmployee,
		EndorsementRequireRecordOfChecksForGovernmentTheftMoney,
		EndorsementIncreaseLimitForSpecifiedPeriodsForGovernmentTheftMoney,
		EndorsementIncreaseLimitForSpecifiedPeriodsGovernment,
		EndorsementDecreaseLimitForGovernmentTheftMoney,
		EndorsementDecreaseLimitGovernment,
		EndorsementReducedLimitForDesignatedForGovernmentTheftMoney,
		EndorsementReducedLimitForDesignatedGovenment,
		EndorsementRequireRecordOfChecksForGovernmentOutsidePremises,
		EndorsementIncreaseLimitForSpecifiedPeriodsForGovernmentOutsidePremises,
		EndorsementLimitedToRobberyForGovernmentOutsidePremises,
		EndorsementIncreaseLimitForSpecifiedPeriodsGovernmentRobberyOther,
		EndorsementReducedLimitForDesignatedGovenmentRobberyOther,
		EndorsementRequireRecordOfChecksForGovernmentInsideRobberySecurities,
		EndorsementReducedLimitForDesignatedForGovernmentInsideRobberySecurities,
		...
		EndorsementIncludeDesignatedAgentsPerEmployeeGETF,
		EndorsementAddTradingCoveragePerEmployeeGETF,
		EndorsementAddFaithfulPerformancePerEmployeeGETF,
		EndorsementAddBlanketExcessLimitPerEmployeeGETF,
		EndorsementAddScheduleExcessLimitPerEmployeeGETF,
		EndorsementIncludeComputerSoftwareContractorsPerEmployeeGETF,
		EndorsementAddScheduleExcessLimitFor35PerEmployeeGETF,
		EndorsementIncludeDesignatedAgentsEmpTheftETF,
		EndorsementIncludeComputerSoftwareContractorsEmpTheftETF,
		EndorsementAddScheduleExcessLimitEmpTheftETF,
		EndorsementEmployeeTheftExcessLimitETF,
		EndorsementIncludePartnersEmpTheftETF,
		EndorsementAddTradingCoverageEmpTheftETF,
		EndorsementAddFaithfulPerformanceEmpTheftETF,
		EndorsementRuralUtilitiesCollectionAgentsEmpTheftETF,
		EndorsementAddBlanketExcessLimitEmpTheftETF,
		EndorsementWarehouseReceiptsEmpTheftETF,
		EndorsementCreditCardETF,
		EndorsementSpecialLimitForGovernment,
		EndorsementIncludePersonalAccountsETF,
		EndorsementWarehouseReceipts28ETF,
		EndorsementAddFaithfulPerformanceNamePositionETF,
		EndorsementIncludeDesignatedAgentsPerLossGETF,
		EndorsementIncludeDesignatedAgentsPerEmployee,
		EndorsementAddTradingPerLossGETFCoverage,
		EndorsementAddTradingCoveragePerEmployee,
		EndorsementAddFaithfulPerformancePerLossGETF,
		EndorsementAddFaithfulPerformancePerEmployee,
		EndorsementAddBlanketExcessLimitPerLossGETF,
		EndorsementAddBlanketExcessLimitPerEmployee,
		EndorsementAddScheduleExcessLimitPerLossGETF,
		EndorsementAddScheduleExcessLimitPerEmployee,
		EndorsementIncludeComputerSoftwareContractorsPerLossGETF,
		EndorsementIncludeComputerSoftwareContractorsPerEmployee,
		EndorsementAddScheduleExcessLimitFor35PerLossGETF,
		EndorsementAddScheduleExcessLimitFor35PerEmployee,
		EndorsementEmployeeTheftExcessOverGETF,
		EndorsementCreditCardGETF,
		EndorsemenFaithfulPerformanceEmployeeorPositionGETF,
		InsuringAgreement
	FROM WBCRRiskStage
),
EXP_Metadata AS (
