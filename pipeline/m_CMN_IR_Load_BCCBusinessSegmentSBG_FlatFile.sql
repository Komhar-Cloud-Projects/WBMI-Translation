...
Exp_BCCBusinessSegmentSBG AS (
	...
	ltrim(rtrim(In_BusinessClassificationCode
		)
	) AS Out_BusinessClassificationCode,
	...
	ltrim(rtrim(In_StrategicBusinessGroupDescription
		)
	) AS Out_StrategicBusinessGroupDescription,
	Argent_Business_Segment_Code AS In_Argent_Business_Segment_Code,
	-- *INF*: LTRIM(RTRIM(In_Argent_Business_Segment_Code))
	LTRIM(RTRIM(In_Argent_Business_Segment_Code
		)
	) AS Out_Argent_Business_Segment_Code,
	...
	LTRIM(RTRIM(In_Argent_Business_Segment_Description
		)
	) AS Out_Argent_Business_Segment_Description
