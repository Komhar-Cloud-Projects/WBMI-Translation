...
EXP_Source_Data_Collect AS (
	...
	IFF(v_Pol_key = '', IFF(v_PolicyNumber = '', '', v_PolicyNumber || v_PolicyVersion), v_Pol_key) AS v_PolicyKey,
	...
	IFF(LKP_INSURANCESEGMENT__1.InsuranceSegmentAKId IS NULL, - 1, LKP_INSURANCESEGMENT__1.InsuranceSegmentAKId) AS o_InsuranceSegmentAkid,
	-- *INF*: IIF(ISNULL(:LKP.LKP_STRATEGICPROFITCENTERAKID('1')),-1,:LKP.LKP_STRATEGICPROFITCENTERAKID('1'))
	IFF(LKP_STRATEGICPROFITCENTERAKID__1.StrategicProfitCenterAKId IS NULL, - 1, LKP_STRATEGICPROFITCENTERAKID__1.StrategicProfitCenterAKId) AS o_StrategicProfitAkid
...
EXP_DefaultingValues AS (
	...
	TO_DATE('2100-12-31 23:59:59 ', 'YYYY-MM-DD HH24:MI:SS') AS nonrenewal_flag_date,
	-- *INF*: TO_DATE('2100-12-31 23:59:59 ','YYYY-MM-DD HH24:MI:SS')
	TO_DATE('2100-12-31 23:59:59 ', 'YYYY-MM-DD HH24:MI:SS') AS audit_complt_date,
	-- *INF*: TO_DATE('2100-12-31 23:59:59 ','YYYY-MM-DD HH24:MI:SS')
	TO_DATE('2100-12-31 23:59:59 ', 'YYYY-MM-DD HH24:MI:SS') AS orig_acct_date,
