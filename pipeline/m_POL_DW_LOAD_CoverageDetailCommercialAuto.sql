...
EXP_MetaData AS (
	...
	TO_TIMESTAMP(i_PremiumTransactionExpirationDate, 'MM/DD/YYYY') AS v_PTExpDate,
	-- *INF*: DECODE(true,
	...
	IFF(
	    IS_DATE(i_LastChangeDateMonth || '/' || i_LastchangeDateDay || '/' || i_LastChangeDateCentury || i_LastChangeDateYear, 'MM/DD/YYYY'),
	    TO_TIMESTAMP(i_LastChangeDateMonth || '/' || i_LastchangeDateDay || '/' || i_LastChangeDateCentury || i_LastChangeDateYear, 'MM/DD/YYYY'),
	...
	IFF(
	    i_VehicleDeletedIndicator = 'D', v_VehicleDeleteDate,
	    TO_TIMESTAMP('2100-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS')
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_sar_state) AS o_sar_state,
	...
	SUBSTR(v_lkp_result, 1, REGEXP_INSTR(v_lkp_result, '@1') - 1) AS o_VehicleTypeSize,
	-- *INF*: SUBSTR(v_lkp_result,instr(v_lkp_result,'@1')+2,instr(v_lkp_result,'@2')-instr(v_lkp_result,'@1')-2)
	SUBSTR(v_lkp_result, REGEXP_INSTR(v_lkp_result, '@1') + 2, REGEXP_INSTR(v_lkp_result, '@2') - REGEXP_INSTR(v_lkp_result, '@1') - 2) AS o_BusinessUseClass,
...
EXP_CoverageDetailCommercialAuto AS (
	...
	CAST(TO_CHAR(i_VehicleWeight) || TO_CHAR(i_VehicleWeight2) AS FLOAT) AS v_VehicleWeight,
	...
	IFF(v_VehicleClassCode_4_5 IN ('71','72','73','74','75','76','77','78','79'), '1', '0') AS o_UsedInDumpingIndicator,
	VehicleDeleteDate,
	-- *INF*: DECODE(TRUE,
	...
	DECODE(
	    ...
	    i_sar_state = '15' AND i_sar_major_peril = '130' AND v_CoverageLimitType = 'PersonalInjuryProtectionBasicLimit' AND i_sar_code_4_1 = '0', '681',
	    i_sar_state = '15' AND i_sar_major_peril = '130' AND v_CoverageLimitType = 'PersonalInjuryProtectionExcessLimit' AND i_sar_code_4_1 = '0', '682',
	    i_sar_state = '22' AND i_sar_major_peril = '130' AND v_CoverageLimitType = 'PersonalInjuryProtectionBasicLimit' AND i_sar_code_4_1 IN ('1','3'), '671',
	    i_sar_state = '22' AND i_sar_major_peril = '130' AND v_CoverageLimitType = 'PersonalInjuryProtectionBasicLimit' AND i_sar_code_4_1 = '0', '681',
	    i_sar_state = '22' AND i_sar_major_peril = '130' AND v_CoverageLimitType = 'PersonalInjuryProtectionExcessLimit' AND i_sar_code_4_1 = '0', '695',
	    i_sar_state = '21' AND i_sar_major_peril = '130' AND i_sar_code_4_1 IN ('1','3'), '671',
	    i_sar_state = '21' AND i_sar_major_peril = '130' AND i_sar_code_4_1 = '0', '681',
	    'N/A'
...
EXP_DetectChanges AS (
	...
	SUBSTR('0000' || 
	    IFF(
	        i_YearMake IS NULL, '0000', TO_CHAR(i_YearMake)
	    ), - 4, 4) AS v_YearMake,
