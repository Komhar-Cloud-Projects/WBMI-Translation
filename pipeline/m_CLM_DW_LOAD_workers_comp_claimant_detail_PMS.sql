...
EXP_Lkp_Values_workers_comp_claimant_detail_PMS AS (
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_MARITAL_STATUS)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_MARITAL_STATUS)>0
	    and TRIM(IN_IPFCGQ_MARITAL_STATUS)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_LOSS_AIA_CODES_1_2)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_LOSS_AIA_CODES_1_2)>0
	    and TRIM(IN_IPFCGQ_LOSS_AIA_CODES_1_2)='',
	        'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_LOSS_AIA_CODES_3_4)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_LOSS_AIA_CODES_3_4)>0
	    and TRIM(IN_IPFCGQ_LOSS_AIA_CODES_3_4)='',
	        'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_LOSS_AIA_CODES_5_6)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_LOSS_AIA_CODES_5_6)>0
	    and TRIM(IN_IPFCGQ_LOSS_AIA_CODES_5_6)='',
	        'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_DEATH_INDICATOR)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_DEATH_INDICATOR)>0
	    and TRIM(IN_IPFCGQ_DEATH_INDICATOR)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_LOSS_COV_CODE_2)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_LOSS_COV_CODE_2)>0
	    and TRIM(IN_IPFCGQ_LOSS_COV_CODE_2)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IN_IPFCGQ_TYPE_DISABILITY)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IN_IPFCGQ_TYPE_DISABILITY)>0
	    and TRIM(IN_IPFCGQ_TYPE_DISABILITY)='', 'N/A',
...
EXP_DETECT_CHANGES_workers_comp_claimant_detail AS (
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_JURISDICTION_STATE)) IS NULL
	    or LENGTH(LTRIM(RTRIM(IPFCGQ_JURISDICTION_STATE)))>0
	    and TRIM(LTRIM(RTRIM(IPFCGQ_JURISDICTION_STATE)))=''
	    or LENGTH(LTRIM(RTRIM(IPFCGQ_JURISDICTION_STATE))) = 0,
	...
	-- --get the alpha state code from numeric
	IFF(
	    V_jurisdiction_state_code IS NULL
	    or LENGTH(V_jurisdiction_state_code)>0
	    and TRIM(V_jurisdiction_state_code)=''
	    or LENGTH(V_jurisdiction_state_code) = 0,
	    'N/A',
	...
	IFF(
	    IPFCGQ_DATE_RPTD_EMPLOYER IS NULL OR IPFCGQ_DATE_RPTD_EMPLOYER = 0,
	    TO_TIMESTAMP('1800/01/01', 'YYYY/MM/DD'),
	    TO_TIMESTAMP(TO_CHAR(IPFCGQ_DATE_RPTD_EMPLOYER), 'YYYYMMDD')
	) AS V_emplyr_notified_date,
	V_emplyr_notified_date AS emplyr_notified_date,
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_rpted_to_carrier_date,
	...
	IFF(
	    IPFCGQ_DATE_HIRE IS NULL OR IPFCGQ_DATE_HIRE = 0 OR LENGTH(TO_CHAR(IPFCGQ_DATE_HIRE)) < 8,
	    TO_TIMESTAMP('1800/01/01', 'YYYY/MM/DD'),
	    TO_TIMESTAMP(TO_CHAR(IPFCGQ_DATE_HIRE), 'YYYYMMDD')
	) AS V_hired_date,
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_EMPLOYMENT_STATUS)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_EMPLOYMENT_STATUS)>0
	    and TRIM(IPFCGQ_EMPLOYMENT_STATUS)='', 'N/A',
	...
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_wage_eff_date,
	...
	IFF(CAST(IPFCGQ_PRE_INJ_WAGE AS FLOAT) IS NULL, 0, CAST(IPFCGQ_PRE_INJ_WAGE AS FLOAT)) AS V_avg_wkly_wage,
	...
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_first_rpt_inj_date,
	V_first_rpt_inj_date AS first_rpt_inj_date,
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_supplementary_rpt_inj_date,
	...
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_inj_work_day_begin_time,
	...
	IFF(
	    IPFCGQ_DATE_OF_DISABILITY IS NULL OR IPFCGQ_DATE_OF_DISABILITY = 0,
	    TO_TIMESTAMP('1800/01/01', 'YYYY/MM/DD'),
	    TO_TIMESTAMP(TO_CHAR(IPFCGQ_DATE_OF_DISABILITY), 'YYYYMMDD')
	...
	IFF(
	    IPFCGQ_EMPLOYEE_DEATH_DATE IS NULL
	    or LENGTH(IPFCGQ_EMPLOYEE_DEATH_DATE)>0
	    and TRIM(IPFCGQ_EMPLOYEE_DEATH_DATE)='',
	    TO_TIMESTAMP('1800/01/01', 'YYYY/MM/DD'),
	    TO_TIMESTAMP(IPFCGQ_EMPLOYEE_DEATH_DATE, 'YYYYMMDD')
	) AS V_death_date,
	...
	-- *INF*: TO_DATE('01/01/1800 01:00:00','MM/DD/YYYY HH24:MI:SS')
	TO_TIMESTAMP('01/01/1800 01:00:00', 'MM/DD/YYYY HH24:MI:SS') AS V_subrogation_statute_exp_date,
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_MANGD_CARE_ORG_IND)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_MANGD_CARE_ORG_IND)>0
	    and TRIM(IPFCGQ_MANGD_CARE_ORG_IND)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_SUBROGATION_CODE)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_SUBROGATION_CODE)>0
	    and TRIM(IPFCGQ_SUBROGATION_CODE)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_ATTORNEY_AUTH_REP)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_ATTORNEY_AUTH_REP)>0
	    and TRIM(IPFCGQ_ATTORNEY_AUTH_REP)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_CONTROVERTED_CASE)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_CONTROVERTED_CASE)>0
	    and TRIM(IPFCGQ_CONTROVERTED_CASE)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_SURGERY)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_SURGERY)>0
	    and TRIM(IPFCGQ_SURGERY)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(IPFCGQ_WAGE_METHOD)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(IPFCGQ_WAGE_METHOD)>0
	    and TRIM(IPFCGQ_WAGE_METHOD)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(V_LKP_pms_occuptn_descript)) IS NULL, 'N/A',
	    IFF(
	        LENGTH(V_LKP_pms_occuptn_descript)>0
	    and TRIM(V_LKP_pms_occuptn_descript)='', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(TO_CHAR(IPFCGQ_TYPE_COVG))) IS NULL, 'N/A',
	    IFF(
	        LENGTH(TO_CHAR(IPFCGQ_TYPE_COVG))>0
	    and TRIM(TO_CHAR(IPFCGQ_TYPE_COVG))='', 'N/A',
	...
	-- 'UPDATE','NOCHANGE'))
	IFF(
	    LKP_claim_party_occurrence_ak_id IS NULL, 'NEW',
	    IFF(
	        (ltrim(rtrim(LKP_jurisdiction_state_code)) <> ltrim(rtrim(V_jurisdiction_state_code_Actual)))
	        or LKP_emplyr_notified_date <> V_emplyr_notified_date
	        or LKP_rpted_to_carrier_date <> V_rpted_to_carrier_date
	        or (ltrim(rtrim(LKP_jurisdiction_claim_num)) <> ltrim(rtrim(V_jurisdiction_claim_num)))
	        or (ltrim(rtrim(LKP_care_directed_ind)) <> ltrim(rtrim(V_care_directed_ind)))
	        or (ltrim(rtrim(LKP_care_directed_by)) <> ltrim(rtrim(V_care_directed_by)))
	        or (ltrim(rtrim(LKP_hired_state_code)) <> ltrim(rtrim(V_hired_state_code)))
	        or LKP_hired_date <> V_hired_date
	        or (ltrim(rtrim(LKP_tax_filing_status)) <> ltrim(rtrim(V_tax_filing_status)))
	        or (ltrim(rtrim(LKP_occuptn_code)) <> ltrim(rtrim(V_occuptn_code)))
	        or (ltrim(rtrim(LKP_employement_status_code)) <> ltrim(rtrim(V_employement_status_code)))
	        or LKP_len_of_time_in_crrnt_job <> V_len_of_time_in_crrnt_job
	        or (ltrim(rtrim(LKP_emp_dept_name)) <> ltrim(rtrim(V_emp_dept_name)))
	        or (ltrim(rtrim(LKP_emp_shift_num)) <> ltrim(rtrim(V_emp_shift_num)))
	        or (ltrim(rtrim(LKP_marital_status)) <> ltrim(rtrim(marital_status)))
	        ...
	        or (ltrim(rtrim(LKP_exemption_type)) <> ltrim(rtrim(V_exemption_type)))
	        or (ltrim(rtrim(LKP_emp_blind_ind)) <> ltrim(rtrim(V_emp_blind_ind)))
	        or (ltrim(rtrim(LKP_emp_over_65_ind)) <> ltrim(rtrim(V_emp_over_65_ind)))
	        or (ltrim(rtrim(LKP_spouse_blind_ind)) <> ltrim(rtrim(V_spouse_blind_ind)))
	        or (ltrim(rtrim(LKP_spouse_over_65_ind)) <> ltrim(rtrim(V_spouse_over_65_ind)))
	        or (ltrim(rtrim(LKP_education_lvl)) <> ltrim(rtrim(V_education_lvl)))
	        or (ltrim(rtrim(LKP_med_auth_ind)) <> ltrim(rtrim(V_med_auth_ind)))
	        or (ltrim(rtrim(LKP_auth_to_release_ssn_ind)) <> ltrim(rtrim(V_auth_to_release_ssn_ind)))
	        or (ltrim(rtrim(LKP_emp_id_num)) <> ltrim(rtrim(V_emp_id_num)))
	        or (ltrim(rtrim(LKP_emp_id_type)) <> ltrim(rtrim(V_emp_id_type)))
	        or LKP_emp_part_time_hour_week <> V_emp_part_time_hour_week
	        or (ltrim(rtrim(LKP_emp_dept_num)) <> ltrim(rtrim(V_emp_dept_num)))
	        or LKP_emp_part_time_hourly_week_rate_amt <> V_emp_part_time_hourly_week_rate_amt
	        or LKP_wage_rate_amt <> V_wage_rate_amt
	        or (ltrim(rtrim(LKP_wage_period_code)) <> ltrim(rtrim(V_wage_period_code)))
	        or LKP_wage_eff_date <> V_wage_eff_date
	        or LKP_weeks_worked <> V_weeks_worked
	        or (ltrim(rtrim(LKP_gross_amt_type)) <> ltrim(rtrim(V_gross_amt_type)))
	        ...
	        or (ltrim(rtrim(LKP_full_pay_inj_day_ind)) <> ltrim(rtrim(V_full_pay_inj_day_ind)))
	        or (ltrim(rtrim(LKP_salary_paid_ind)) <> ltrim(rtrim(V_salary_paid_ind)))
	        ...
	        or (ltrim(rtrim(LKP_phys_restriction_ind)) <> ltrim(rtrim(V_phys_restriction_ind)))
	        or (ltrim(rtrim(LKP_pre_exst_disability_ind)) <> ltrim(rtrim(V_pre_exst_disability_ind)))
	        or (ltrim(rtrim(LKP_premises_code)) <> ltrim(rtrim(V_premises_code)))
	        or (ltrim(rtrim(LKP_work_process_descript)) <> ltrim(rtrim(V_work_process_descript)))
	        or (ltrim(rtrim(LKP_task_descript)) <> ltrim(rtrim(V_task_descript)))
	        or (ltrim(rtrim(LKP_body_part_code)) <> ltrim(rtrim(body_part_code)))
	        or (ltrim(rtrim(LKP_nature_inj_code)) <> ltrim(rtrim(nature_inj_code)))
	        or (ltrim(rtrim(LKP_cause_inj_code)) <> ltrim(rtrim(cause_inj_code)))
	        or (ltrim(rtrim(LKP_safeguard_not_used_ind)) <> ltrim(rtrim(V_safeguard_not_used_ind)))
	        or (ltrim(rtrim(LKP_inj_substance_abuse_ind)) <> ltrim(rtrim(V_inj_substance_abuse_ind)))
	        or (ltrim(rtrim(LKP_sfty_device_not_used_ind)) <> ltrim(rtrim(V_sfty_device_not_used_ind)))
	        or (ltrim(rtrim(LKP_inj_rules_not_obeyed_ind)) <> ltrim(rtrim(V_inj_rules_not_obeyed_ind)))
	        or (ltrim(rtrim(LKP_inj_result_occuptnal_inj_ind)) <> ltrim(rtrim(V_inj_result_occuptnal_inj_ind)))
	        or (ltrim(rtrim(LKP_inj_result_occuptnal_disease_ndicator)) <> ltrim(rtrim(V_inj_result_occuptnal_disease_ndicator)))
	        or (ltrim(rtrim(LKP_inj_result_death_ind)) <> ltrim(rtrim(inj_result_death_ind)))
	        or (ltrim(rtrim(LKP_unsafe_act_descript)) <> ltrim(rtrim(V_unsafe_act_descript)))
	        or (ltrim(rtrim(LKP_responsible_for_inj_descript)) <> ltrim(rtrim(V_responsible_for_inj_descript)))
	        or (ltrim(rtrim(LKP_hazard_condition_descript)) <> ltrim(rtrim(V_hazard_condition_descript)))
	        or LKP_death_date <> V_death_date
	        or (ltrim(rtrim(LKP_emplyr_nature_bus_descript)) <> ltrim(rtrim(V_emplyr_nature_bus_descript)))
	        or (ltrim(rtrim(LKP_emplyr_type_code)) <> ltrim(rtrim(V_emplyr_type_code)))
	        or (ltrim(rtrim(LKP_insd_type_code)) <> ltrim(rtrim(V_insd_type_code)))
	        or LKP_subrogation_statute_exp_date <> V_subrogation_statute_exp_date
	        or (ltrim(rtrim(LKP_managed_care_org_type)) <> ltrim(rtrim(V_managed_care_org_type)))
	        or (ltrim(rtrim(LKP_subrogation_code)) <> ltrim(rtrim(V_subrogation_code)))
	        or (ltrim(rtrim(LKP_loss_condition)) <> ltrim(rtrim(V_loss_condition)))
	        or (ltrim(rtrim(LKP_attorney_or_au_rep_ind)) <> ltrim(rtrim(V_attorney_or_au_rep_ind)))
	        or LKP_hospital_cost <> V_hospital_cost
	        or LKP_doctor_cost <> V_doctor_cost
	        or LKP_other_med_cost <> V_other_med_cost
	        or (ltrim(rtrim(LKP_controverted_case_code)) <> ltrim(rtrim(V_controverted_case_code)))
	        or (ltrim(rtrim(LKP_surgery_ind)) <> ltrim(rtrim(V_surgery_ind)))
	        or (ltrim(rtrim(LKP_emplyr_loc_descript)) <> ltrim(rtrim(V_emplyr_loc_descript)))
	        or (ltrim(rtrim(LKP_inj_loc_comment)) <> ltrim(rtrim(V_inj_loc_comment)))
	        or (ltrim(rtrim(LKP_claim_ctgry_code)) <> ltrim(rtrim(V_claim_ctgry_code)))
	        or (ltrim(rtrim(LKP_act_status_code)) <> ltrim(rtrim(V_act_status_code)))
	        or (ltrim(rtrim(LKP_investigate_ind)) <> ltrim(rtrim(V_investigate_ind)))
	        or (ltrim(rtrim(LKP_emplyr_standard_industry_code)) <> ltrim(rtrim(V_emplyr_standard_industry_code)))
	        or (ltrim(rtrim(LKP_hospitalized_ind)) <> ltrim(rtrim(V_hospitalized_ind)))
	        or (ltrim(rtrim(LKP_wage_method_code)) <> ltrim(rtrim(V_wage_method_code)))
	        or (ltrim(rtrim(LKP_pms_occuptn_descript)) <> ltrim(rtrim(V_pms_occuptn_descript)))
	        or (ltrim(rtrim(LKP_pms_type_disability)) <> ltrim(rtrim(pms_type_disability)))
	        or (ltrim(rtrim(LKP_ncci_type_cov)) <> ltrim(rtrim(V_ncci_type_cov))),
	        'UPDATE',
	        'NOCHANGE'
	    )
	) AS V_CHANGE_FLAG,
...
EXP_INSERT AS (
	...
	TO_TIMESTAMP('01/01/1800', 'mm/dd/yyyy') AS DummyDate,
	0.00 AS DummyDecimal,
	0 AS DummnNum,
	'N/A' AS FROIclaimType,
	-- *INF*: to_date('12/31/2100','mm/dd/yyyy')
	TO_TIMESTAMP('12/31/2100', 'mm/dd/yyyy') AS DefaultHighDate
...
EXP_Lag_eff_from_date AS (
	...
	IFF(
	    wc_claimant_det_ak_id = v_PREV_ROW_wc_claimant_det_ak_id,
