...
EXP_Get_Values AS (
	...
	DECODE(TRUE,
		...
		NOT i_ExclusionReason IS NULL AND INSTR(i_ExclusionReason, 'Missing/blank WorkDCTPremiumTransactionTracking') = 0, CONCAT(i_ExclusionReason, ', Missing/blank WorkDCTPremiumTransactionTracking'),
