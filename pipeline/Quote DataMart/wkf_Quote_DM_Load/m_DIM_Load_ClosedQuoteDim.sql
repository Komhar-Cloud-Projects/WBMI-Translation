...
EXP_Values AS (
	...
	IFF(i_QuoteReasonClosedCode IS NULL OR IS_SPACES(i_QuoteReasonClosedCode) OR LENGTH(i_QuoteReasonClosedCode) = 0, '-1', LTRIM(RTRIM(i_QuoteReasonClosedCode))) AS o_QuoteReasonClosedCode,
	...
	IFF(i_QuoteReasonClosedComments IS NULL OR IS_SPACES(i_QuoteReasonClosedComments) OR LENGTH(i_QuoteReasonClosedComments) = 0, 'N/A', LTRIM(RTRIM(i_QuoteReasonClosedComments))) AS o_QuoteReasonClosedComments
	FROM SQ_Quote
),
...
EXP_ExistingChecking AS (
	...
	-- 
	-- 
	IFF(NOT i_QuoteReasonClosedDescription IS NULL, i_QuoteReasonClosedDescription, 'N/A') AS QuoteReasonClosedDescription,
