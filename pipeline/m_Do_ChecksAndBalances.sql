...
EXP_CountActiveORDeleted AS (
	...
	IFF(in(WBMIBalancingType, 'SupportID', 'Count', 'AKID', 'ActiveOrDeleted'), TO_DECIMAL(v_SourceOutPut), NULL) AS SourceCount,
	-- *INF*: IIF(WBMIBalancingType='Amount',TO_DECIMAL(v_SourceOutPut),NULL)
	IFF(WBMIBalancingType = 'Amount', TO_DECIMAL(v_SourceOutPut), NULL) AS SourceAmount,
	...
	IFF(TargetTable IS NULL, NULL, IFF(in(WBMIBalancingType, 'SupportID', 'Count', 'AKID', 'ActiveOrDeleted'), TO_DECIMAL(v_TargetOutPut), NULL)) AS TargetCount,
	-- *INF*: IIF( ISNULL(TargetTable),NULL,IIF(WBMIBalancingType='Amount',TO_DECIMAL(v_TargetOutPut),NULL))
	IFF(TargetTable IS NULL, NULL, IFF(WBMIBalancingType = 'Amount', TO_DECIMAL(v_TargetOutPut), NULL)) AS TargetAmount,
