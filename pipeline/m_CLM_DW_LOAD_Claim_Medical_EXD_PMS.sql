...
EXP_Values AS (
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(medicare_hicn) AS medicare_hicn1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(medicare_elig)
	UDF_DEFAULT_VALUE_FOR_STRINGS(medicare_elig) AS medicare_elig1,
	-- *INF*: IIF(ISNULL(cms_date_of_incid), TO_DATE('1/1/1800','MM/DD/YYYY'), cms_date_of_incid)
	IFF(cms_date_of_incid IS NULL, TO_TIMESTAMP('1/1/1800', 'MM/DD/YYYY'), cms_date_of_incid) AS cms_date_of_incid1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(cause_code)
	UDF_DEFAULT_VALUE_FOR_STRINGS(cause_code) AS cause_code1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(diag_code)
	UDF_DEFAULT_VALUE_FOR_STRINGS(diag_code) AS diag_code1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_ind)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_ind) AS self_insd_ind1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_type)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_type) AS self_insd_type1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_fst_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_fst_nm) AS self_insd_fst_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_last_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_last_nm) AS self_insd_last_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_dba_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_dba_nm) AS self_insd_dba_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(self_insd_lgl_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(self_insd_lgl_nm) AS self_insd_lgl_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(product_liab_ind)
	UDF_DEFAULT_VALUE_FOR_STRINGS(product_liab_ind) AS product_liab_ind1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(prod_generic_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(prod_generic_nm) AS prod_generic_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(prod_brand_nm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(prod_brand_nm) AS prod_brand_nm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(prod_manufacturer)
	UDF_DEFAULT_VALUE_FOR_STRINGS(prod_manufacturer) AS prod_manufacturer1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(prod_allege_harm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(prod_allege_harm) AS prod_allege_harm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(inj_par_rep_firm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(inj_par_rep_firm) AS inj_par_rep_firm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(cms_source_system_id)
	UDF_DEFAULT_VALUE_FOR_STRINGS(cms_source_system_id) AS cms_source_system_id1,
	...
	-- 'N/A'))
	IFF(
	    length(exceed_claim_key) > 0, ltrim(rtrim(exceed_claim_key)),
	    IFF(
	...
	-- 'N/A'))
	IFF(
	    length(exceed_claim_key) > 0, ltrim(rtrim(exceed_claimnt_key)),
	    IFF(
	        length(pms_policy_sym) > 0,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(clmt1_rep_firm) AS clmt1_rep_firm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(clmt2_rep_firm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(clmt2_rep_firm) AS clmt2_rep_firm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(clmt3_rep_firm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(clmt3_rep_firm) AS clmt3_rep_firm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(clmt4_rep_firm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(clmt4_rep_firm) AS clmt4_rep_firm1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(query_requested)
	UDF_DEFAULT_VALUE_FOR_STRINGS(query_requested) AS query_requested1,
	-- *INF*: IIF(ISNULL(query_request_date), TO_DATE('1/1/1800','MM/DD/YYYY'), query_request_date)
	IFF(query_request_date IS NULL, TO_TIMESTAMP('1/1/1800', 'MM/DD/YYYY'), query_request_date) AS query_request_date1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(last_cms_hicn)
	UDF_DEFAULT_VALUE_FOR_STRINGS(last_cms_hicn) AS last_cms_hicn1,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_icd_code_version) AS icd_code_version1
...
EXP_Detect_Changes AS (
	...
	-- , 'UPDATE','NOCHANGE'))
	IFF(
	    claim_med_id IS NULL, 'NEW',
	    IFF(
	        injured_party_id1 <> cms_document_cntl_num
