...
EXP_CMT_CLMT AS (
	...
	IFF(ltrim(rtrim(claim_party_role_code)) = 'CMT', 'CLMT', ltrim(rtrim(claim_party_role_code))) AS claim_party_role_code_out
	FROM JNR_claimant_dim_sources
),
...
EXP_claimant_dim AS (
	...
	IFF(in_edw_claimant_reserve_calculation_direct_loss_pk_id IS NULL, - 1, in_edw_claimant_reserve_calculation_direct_loss_pk_id) AS edw_claimant_reserve_calculation_direct_loss_pk_id_out,
	...
	IFF(in_edw_claimant_reserve_calculation_exp_pk_id IS NULL, - 1, in_edw_claimant_reserve_calculation_exp_pk_id) AS edw_claimant_reserve_calculation_exp_pk_id_out,
	...
	IFF(in_edw_claimant_reserve_calculation_subrogation_pk_id IS NULL, - 1, in_edw_claimant_reserve_calculation_subrogation_pk_id) AS edw_claimant_reserve_calculation_subrogation_pk_id_out,
	...
	IFF(in_edw_claimant_reserve_calculation_salvage_pk_id IS NULL, - 1, in_edw_claimant_reserve_calculation_salvage_pk_id) AS edw_claimant_reserve_calculation_salvage_pk_id_out,
	...
	IFF(in_edw_claimant_reserve_calculation_other_recovery_pk_id IS NULL, - 1, in_edw_claimant_reserve_calculation_other_recovery_pk_id) AS edw_claimant_reserve_calculation_other_recovery_pk_id_out,
	...
	IFF(claimant_date_type IS NULL OR claimant_date_type = 'N/A', 'N/A', rtrim(substr(claimant_date_type, 2))) AS v_claimant_date_type_out,
	...
	IFF(in_claimant_direct_loss_status_code IS NULL OR in_claimant_direct_loss_status_code = 'N/A', 'N/A', rtrim(substr(in_claimant_direct_loss_status_code, 2))) AS claimant_direct_loss_status_code_out,
	...
	IFF(in_claimant_exp_status_code IS NULL OR in_claimant_exp_status_code = 'N/A', 'N/A', rtrim(substr(in_claimant_exp_status_code, 2))) AS claimant_exp_status_code_out,
	...
	IFF(in_claimant_subrogation_status_code IS NULL OR in_claimant_subrogation_status_code = 'N/A', 'N/A', rtrim(substr(in_claimant_subrogation_status_code, 2))) AS claimant_subrogation_status_code_out,
	...
	IFF(in_claimant_salvage_status_code IS NULL OR in_claimant_salvage_status_code = 'N/A', 'N/A', rtrim(substr(in_claimant_salvage_status_code, 2))) AS claimant_salvage_status_code_out,
	...
	IFF(in_claimant_other_recovery_status_code IS NULL OR in_claimant_other_recovery_status_code = 'N/A', 'N/A', rtrim(substr(in_claimant_other_recovery_status_code, 2))) AS claimant_other_recovery_status_code_out,
	...
	-- 
	-- 
	IFF(v_claimant_date_type_out IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), IFF(v_claimant_date_type_out = 'OPEN', claimant_date, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'))) AS v_claimant_open_date,
	...
	-- 
	-- 
	IFF(v_claimant_date_type_out IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), IFF(v_claimant_date_type_out = 'CLOSED', claimant_date, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'))) AS v_claimant_close_date,
	...
	-- 
	-- 
	IFF(v_claimant_date_type_out IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), IFF(v_claimant_date_type_out = 'REOPEN', claimant_date, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'))) AS v_claimant_reopen_date,
	...
	-- 
	-- 
	IFF(v_claimant_date_type_out IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), IFF(v_claimant_date_type_out = 'CLOSEDAFTERREOPEN', claimant_date, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'))) AS v_claimant_closed_after_reopen_date,
	...
	-- 
	-- 
	IFF(v_claimant_date_type_out IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), IFF(v_claimant_date_type_out = 'NOTICEONLY', claimant_date, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'))) AS v_claimant_noticeonly_date,
	...
	-- 
	-- 
	IFF(ltrim(rtrim(in_claim_party_role_code)) = 'CMT', 'CLMT', ltrim(rtrim(in_claim_party_role_code))) AS claim_party_role_code_out,
	...
	IFF(in_denial_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_denial_date) AS denial_date_out,
	...
	IFF(in_emplyr_notified_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_emplyr_notified_date) AS emplyr_notified_date_out,
	...
	IFF(in_rpted_to_carrier_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_rpted_to_carrier_date) AS rpted_to_carrier_date_out,
	...
	IFF(in_hired_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_hired_date) AS hired_date_out,
	...
	IFF(in_wage_eff_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_wage_eff_date) AS wage_eff_date_out,
	...
	IFF(in_piece_work_num_of_weeks_excluding_overtime IS NULL, 0, in_piece_work_num_of_weeks_excluding_overtime) AS piece_work_num_of_weeks_excluding_overtime_out,
	...
	IFF(in_first_rpt_inj_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_first_rpt_inj_date) AS first_rpt_inj_date_out,
	...
	IFF(in_supplementary_rpt_inj_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_supplementary_rpt_inj_date) AS supplementary_rpt_inj_date_out,
	...
	IFF(in_inj_work_day_begin_time IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_inj_work_day_begin_time) AS inj_work_day_begin_time_out,
	...
	IFF(in_disability_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_disability_date) AS disability_date_out,
	...
	IFF(in_inj_result_occuptnal_disease_ndicator IS NULL, 'N/A', in_inj_result_occuptnal_disease_ndicator) AS inj_result_occuptnal_disease_ndicator_out,
	...
	IFF(in_emp_last_day_worked IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_emp_last_day_worked) AS emp_last_day_worked_out,
	...
	IFF(in_death_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_death_date) AS death_date_out,
	...
	IFF(in_return_to_work_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_return_to_work_date) AS return_to_work_date_out,
	...
	IFF(in_return_to_work_with_same_emplyr_ind IS NULL, 'N/A', in_return_to_work_with_same_emplyr_ind) AS return_to_work_with_same_emplyr_ind_out,
	...
	IFF(in_subrogation_statute_exp_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_subrogation_statute_exp_date) AS subrogation_statute_exp_date_out,
	...
	IFF(in_max_med_improvement_date IS NULL, TO_DATE('1/1/1800', 'MM/DD/YYYY'), in_max_med_improvement_date) AS max_med_improvement_date,
	...
	IFF(v_pre_injury_avg_wkly_wage_code_descript IS NULL, 'N/A', v_pre_injury_avg_wkly_wage_code_descript) AS pre_injury_avg_wkly_wage_code_descript,
	...
	--  
	IFF(TO_DECIMAL(v_post_inj_wkly_wage_amt, 2) IS NULL, 0, TO_DECIMAL(v_post_inj_wkly_wage_amt, 2)) AS post_inj_wkly_wage_amt,
	...
	IFF(v_impairment_disability_percentage1 IS NULL, LKP_CLAIM_ANSWER_QUES_edw_claim_party_occurrence_ak_id_NcciDciBodyPartDisabilityPercentage_Claim_GeneralCase_Questions.optn_text, v_impairment_disability_percentage1) AS v_impairment_disability_percentage2,
	-- *INF*: IIF(ISNULL(TO_DECIMAL(v_impairment_disability_percentage2,2)),0,TO_DECIMAL(v_impairment_disability_percentage2,2))
	IFF(TO_DECIMAL(v_impairment_disability_percentage2, 2) IS NULL, 0, TO_DECIMAL(v_impairment_disability_percentage2, 2)) AS v_impairment_disability_percentage3,
	...
	IFF(v_impairment_disability_percentage_basis_code IS NULL, 'N/A', v_impairment_disability_percentage_basis_code) AS impairment_disability_percentage_basis_code,
	...
	IFF(v_impairment_disability_percentage_basis_code_descript IS NULL, 'N/A', v_impairment_disability_percentage_basis_code_descript) AS impairment_disability_percentage_basis_code_descript,
	...
	TO_DATE(TO_CHAR(sysdate, 'YYYY-MM-DD'), 'YYYY-MM-DD') AS v_sysdate,
	...
	-- 
	--  
	IFF(v_restriction_begin_date1_str IS NULL, v_sysdate, TO_DATE(v_restriction_begin_date1_str, 'YYYY-MM-DD')) AS v_restriction_begin_date1,
	-- *INF*: IIF(ISNULL(v_restriction_begin_date2_str), v_sysdate, TO_DATE ( v_restriction_begin_date2_str,'YYYY-MM-DD'))
	IFF(v_restriction_begin_date2_str IS NULL, v_sysdate, TO_DATE(v_restriction_begin_date2_str, 'YYYY-MM-DD')) AS v_restriction_begin_date2,
	-- *INF*: IIF(ISNULL(v_restriction_begin_date3_str), v_sysdate, TO_DATE ( v_restriction_begin_date3_str,'YYYY-MM-DD'))
	IFF(v_restriction_begin_date3_str IS NULL, v_sysdate, TO_DATE(v_restriction_begin_date3_str, 'YYYY-MM-DD')) AS v_restriction_begin_date3,
	-- *INF*: IIF(ISNULL(v_restriction_begin_date4_str), v_sysdate, TO_DATE ( v_restriction_begin_date4_str,'YYYY-MM-DD'))
	IFF(v_restriction_begin_date4_str IS NULL, v_sysdate, TO_DATE(v_restriction_begin_date4_str, 'YYYY-MM-DD')) AS v_restriction_begin_date4,
	-- *INF*: IIF(ISNULL(v_restriction_begin_date5_str), v_sysdate, TO_DATE ( v_restriction_begin_date5_str,'YYYY-MM-DD'))
	IFF(v_restriction_begin_date5_str IS NULL, v_sysdate, TO_DATE(v_restriction_begin_date5_str, 'YYYY-MM-DD')) AS v_restriction_begin_date5,
	-- *INF*: :LKP.LKP_CLAIM_ANSWER_QUES
	...
	IFF(v_restriction_end_date1_str IS NULL, v_sysdate, TO_DATE(v_restriction_end_date1_str, 'YYYY-MM-DD')) AS v_restriction_end_date1,
	-- *INF*: IIF(ISNULL(v_restriction_end_date2_str), v_sysdate, TO_DATE ( v_restriction_end_date2_str,'YYYY-MM-DD'))
	IFF(v_restriction_end_date2_str IS NULL, v_sysdate, TO_DATE(v_restriction_end_date2_str, 'YYYY-MM-DD')) AS v_restriction_end_date2,
	-- *INF*: IIF(ISNULL(v_restriction_end_date3_str), v_sysdate, TO_DATE ( v_restriction_end_date3_str,'YYYY-MM-DD'))
	IFF(v_restriction_end_date3_str IS NULL, v_sysdate, TO_DATE(v_restriction_end_date3_str, 'YYYY-MM-DD')) AS v_restriction_end_date3,
	-- *INF*: IIF(ISNULL(v_restriction_end_date4_str), v_sysdate, TO_DATE ( v_restriction_end_date4_str,'YYYY-MM-DD'))
	IFF(v_restriction_end_date4_str IS NULL, v_sysdate, TO_DATE(v_restriction_end_date4_str, 'YYYY-MM-DD')) AS v_restriction_end_date4,
	-- *INF*: IIF(ISNULL(v_restriction_end_date5_str), v_sysdate, TO_DATE ( v_restriction_end_date5_str,'YYYY-MM-DD'))
	IFF(v_restriction_end_date5_str IS NULL, v_sysdate, TO_DATE(v_restriction_end_date5_str, 'YYYY-MM-DD')) AS v_restriction_end_date5,
	-- *INF*: :LKP.LKP_CLAIM_ANSWER_QUES
	...
	-- 
	--  
	IFF(v_daily_benefit_rate1_str IS NULL, 0, TO_DECIMAL(v_daily_benefit_rate1_str)) AS v_daily_benefit_rate1,
	-- *INF*: IIF(ISNULL(v_daily_benefit_rate2_str),0,  
	-- TO_DECIMAL( v_daily_benefit_rate2_str))
	IFF(v_daily_benefit_rate2_str IS NULL, 0, TO_DECIMAL(v_daily_benefit_rate2_str)) AS v_daily_benefit_rate2,
	-- *INF*: IIF(ISNULL(v_daily_benefit_rate3_str),0,  
	-- TO_DECIMAL( v_daily_benefit_rate3_str))
	IFF(v_daily_benefit_rate3_str IS NULL, 0, TO_DECIMAL(v_daily_benefit_rate3_str)) AS v_daily_benefit_rate3,
	-- *INF*: IIF(ISNULL(v_daily_benefit_rate4_str),0,  
	-- TO_DECIMAL( v_daily_benefit_rate4_str))
	IFF(v_daily_benefit_rate4_str IS NULL, 0, TO_DECIMAL(v_daily_benefit_rate4_str)) AS v_daily_benefit_rate4,
	-- *INF*: IIF(ISNULL(v_daily_benefit_rate5_str),0,  
	-- TO_DECIMAL( v_daily_benefit_rate5_str))
	IFF(v_daily_benefit_rate5_str IS NULL, 0, TO_DECIMAL(v_daily_benefit_rate5_str)) AS v_daily_benefit_rate5,
	...
	-- 
	IFF(v_restriction_accommodated1 = 'No' AND v_restriction_begin_date1 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date1, v_restriction_begin_date1, 'DD'), v_end_day1_5_6_day_wk - v_start_day1_5_6_day_wk), 0) AS v_neg_accom_period1,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated2 = 'No' AND v_restriction_begin_date2 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date2, v_restriction_begin_date2, 'DD'), v_end_day2_5_6_day_wk - v_start_day2_5_6_day_wk), 0) AS v_neg_accom_period2,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated3 = 'No' AND v_restriction_begin_date3 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date3, v_restriction_begin_date3, 'DD'), v_end_day3_5_6_day_wk - v_start_day3_5_6_day_wk), 0) AS v_neg_accom_period3,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated4 = 'No' AND v_restriction_begin_date4 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date4, v_restriction_begin_date4, 'DD'), v_end_day4_5_6_day_wk - v_start_day4_5_6_day_wk), 0) AS v_neg_accom_period4,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated5 = 'No' AND v_restriction_begin_date5 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date5, v_restriction_begin_date5, 'DD'), v_end_day5_5_6_day_wk - v_start_day5_5_6_day_wk), 0) AS v_neg_accom_period5,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated1 = 'Yes' AND v_restriction_begin_date1 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date1, v_restriction_begin_date1, 'DD'), v_end_day1_5_6_day_wk - v_start_day1_5_6_day_wk), 0) AS v_pos_accom_period1,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated2 = 'Yes' AND v_restriction_begin_date2 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date2, v_restriction_begin_date2, 'DD'), v_end_day2_5_6_day_wk - v_start_day2_5_6_day_wk), 0) AS v_pos_accom_period2,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated3 = 'Yes' AND v_restriction_begin_date3 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date3, v_restriction_begin_date3, 'DD'), v_end_day3_5_6_day_wk - v_start_day3_5_6_day_wk), 0) AS v_pos_accom_period3,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated4 = 'Yes' AND v_restriction_begin_date4 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date4, v_restriction_begin_date4, 'DD'), v_end_day4_5_6_day_wk - v_start_day4_5_6_day_wk), 0) AS v_pos_accom_period4,
	...
	-- ---         ELSE (this is a 5 or 6 day week)  Get the difference between the two lookup values to get the difference in dates
	-- ---                       for a 5 or 6 day week.
	IFF(v_restriction_accommodated5 = 'Yes' AND v_restriction_begin_date5 <> v_sysdate, IFF(v_work_day_flag = 7, DATE_DIFF(v_restriction_end_date5, v_restriction_begin_date5, 'DD'), v_end_day5_5_6_day_wk - v_start_day5_5_6_day_wk), 0) AS v_pos_accom_period5,
	...
	IFF(v_restriction_accommodated1 = 'No' AND v_restriction_begin_date1 <> v_sysdate, v_daily_benefit_rate1 * v_neg_accom_period1, 0) AS v_neg_impact1,
	-- *INF*: IIF(v_restriction_accommodated2 = 'No' AND v_restriction_begin_date2 <> v_sysdate, 
	...
	IFF(v_restriction_accommodated2 = 'No' AND v_restriction_begin_date2 <> v_sysdate, v_daily_benefit_rate2 * v_neg_accom_period2, 0) AS v_neg_impact2,
	-- *INF*: IIF(v_restriction_accommodated3 = 'No' AND v_restriction_begin_date3 <> v_sysdate, 
	...
	IFF(v_restriction_accommodated3 = 'No' AND v_restriction_begin_date3 <> v_sysdate, v_daily_benefit_rate3 * v_neg_accom_period3, 0) AS v_neg_impact3,
	-- *INF*: IIF(v_restriction_accommodated4 = 'No' AND v_restriction_begin_date4 <> v_sysdate, 
	...
	-- ---- IF Accommodate3 is equal to 'No' and this is a valid record from the CLAIM_ANSWER table then calculate
	-- ---- the negative impact in dollars for this entry(3 of up to 5).
	IFF(v_restriction_accommodated4 = 'No' AND v_restriction_begin_date4 <> v_sysdate, v_daily_benefit_rate4 * v_neg_accom_period4, 0) AS v_neg_impact4,
	-- *INF*: IIF(v_restriction_accommodated5 = 'No' AND v_restriction_begin_date5 <> v_sysdate, 
	...
	IFF(v_restriction_accommodated5 = 'No' AND v_restriction_begin_date5 <> v_sysdate, v_daily_benefit_rate5 * v_neg_accom_period5, 0) AS v_neg_impact5,
	-- *INF*: IIF(v_restriction_accommodated1 = 'Yes' AND v_restriction_begin_date1 <> v_sysdate, 
	...
	-- ---- the negative impact in dollars for this entry(1 of up to 5).
	IFF(v_restriction_accommodated1 = 'Yes' AND v_restriction_begin_date1 <> v_sysdate, v_daily_benefit_rate1 * v_pos_accom_period1, 0) AS v_pos_impact1,
	-- *INF*: IIF(v_restriction_accommodated2 = 'Yes' AND v_restriction_begin_date2 <> v_sysdate, 
	...
	-- ---- IF Accommodate1 is equal to 'Yes' and this is a valid record from the CLAIM_ANSWER table then calculate
	-- ---- the negative impact in dollars for this entry(2 of up to 5).
	IFF(v_restriction_accommodated2 = 'Yes' AND v_restriction_begin_date2 <> v_sysdate, v_daily_benefit_rate2 * v_pos_accom_period2, 0) AS v_pos_impact2,
	-- *INF*: IIF(v_restriction_accommodated3 = 'Yes' AND v_restriction_begin_date3 <> v_sysdate, 
	...
	-- ---- the negative impact in dollars for this entry(1 of up to 5).
	IFF(v_restriction_accommodated3 = 'Yes' AND v_restriction_begin_date3 <> v_sysdate, v_daily_benefit_rate3 * v_pos_accom_period3, 0) AS v_pos_impact3,
	-- *INF*: IIF(v_restriction_accommodated4 = 'Yes' AND v_restriction_begin_date4 <> v_sysdate, 
	...
	IFF(v_restriction_accommodated4 = 'Yes' AND v_restriction_begin_date4 <> v_sysdate, v_daily_benefit_rate4 * v_pos_accom_period4, 0) AS v_pos_impact4,
	-- *INF*: IIF(v_restriction_accommodated5 = 'Yes' AND v_restriction_begin_date5 <> v_sysdate, 
	...
	-- ---- the negative impact in dollars for this entry(5 of up to 5).
	IFF(v_restriction_accommodated5 = 'Yes' AND v_restriction_begin_date5 <> v_sysdate, v_daily_benefit_rate5 * v_pos_accom_period5, 0) AS v_pos_impact5,
	v_pos_impact1 +
v_pos_impact2 +
v_pos_impact3 +
v_pos_impact4 +
v_pos_impact5 AS o_pos_impact,
	...
	IFF(v_InjuredWorkerLostTime IS NULL, - 1, TO_INTEGER(v_InjuredWorkerLostTime)) AS InjuredWorkerLostTime,
	...
	IFF(in_AutomaticAdjudicationClaimIndicator IS NULL, 'N/A', in_AutomaticAdjudicationClaimIndicator) AS AutomaticAdjudicationClaimIndicator,
