...
EXP_Values AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_insurance_line) AS sar_insurance_line_Out,
	sar_location_x,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_location_x)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_location_x) AS sar_location_Out,
	sar_sub_location_x,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_sub_location_x)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_sub_location_x) AS sar_sub_location_x1,
	sar_risk_unit_group,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_risk_unit_group)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_risk_unit_group) AS sar_risk_unit_group_Out,
	sar_class_code_grp_x,
	sar_class_code_mem_x,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_risk_unit_group_seq) AS risk_unit_group_seq_Out,
	sar_unit,
	-- *INF*: IIF(LENGTH(LTRIM(RTRIM(sar_unit)))= 0 OR IS_SPACES(LTRIM(RTRIM(sar_unit))), '000000',sar_unit)
	IFF(LENGTH(LTRIM(RTRIM(sar_unit))) = 0 OR IS_SPACES(LTRIM(RTRIM(sar_unit))), '000000', sar_unit) AS v_sar_unit,
	v_sar_unit AS sar_risk_unit,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_risk_unit)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_risk_unit) AS sar_risk_unit_Out,
	sar_seq_rsk_unt_a,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_seq_rsk_unt_a)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_seq_rsk_unt_a) AS sar_rsk_unit_seq_out,
	sar_type_exposure,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_type_exposure)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_type_exposure) AS sar_type_exposure_out,
	sar_major_peril,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_major_peril)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_major_peril) AS sar_major_peril_out,
	sar_seq_no,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_seq_no)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_seq_no) AS sar_major_peril_seq_no,
	sar_cov_eff_year,
	...
	TO_DATE(v_sar_cov_eff_month || '/' || v_sar_cov_eff_day || '/' || v_sar_cov_eff_year, 'MM/DD/YYYY') AS sar_cov_eff_date,
	sar_part_code,
	sar_state,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_state)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_state) AS sar_state_Out,
	sar_loc_prov_territory,
	...
	IFF(IS_SPACES(sar_special_use) OR sar_special_use IS NULL OR LENGTH(sar_special_use) = 0, 'N/A', sar_special_use) AS sar_special_use_out,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_special_use)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_special_use) AS sar_special_use_lkp,
	sar_class_1_4,
	sar_class_5_6,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_class_code) AS sar_class_code_out,
	sar_exposure,
	sar_sub_line,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_sub_line)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_sub_line) AS sar_sub_line_out,
	sar_zip_postal_code,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_zip_postal_code)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_zip_postal_code) AS sar_zip_postal_code_out,
	sar_annual_state_line,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_annual_state_line)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_annual_state_line) AS sar_annual_state_line_out,
	sar_county_first_two,
	sar_county_last_one,
	sar_city,
	...
	IFF(IS_SPACES(v_sar_tax_location) OR v_sar_tax_location IS NULL OR LENGTH(v_sar_tax_location) = 0, 'N/A', v_sar_tax_location) AS sar_tax_location_out,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_tax_location)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_tax_location) AS sar_tax_location_lkp,
	sar_stat_breakdown_line,
	sar_user_line,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_product_line) AS sar_product_line,
	sar_section,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_section)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_section) AS sar_section_Out,
	sar_rating_date_ind,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(sar_rating_date_ind)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(sar_rating_date_ind) AS sar_rating_date_ind_Out,
	'N/A' AS default_NA,
	-- *INF*: TO_DATE('1/1/1800 00:00:00' , 'MM/DD/YYYY HH24:MI:SS')
	TO_DATE('1/1/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS') AS eff_from_date,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(V_sar_rsn_amend_Code) AS sar_rsn_amend_code,
	sar_code_1,
	sar_code_2,
	sar_code_3,
	sar_code_4,
	...
	IFF(IS_SPACES(v_sar_statistical_code) OR v_sar_statistical_code IS NULL OR LENGTH(v_sar_statistical_code) = 0, 'N/A', v_sar_statistical_code) AS sar_statistical_code_out,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_statistical_code)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(v_sar_statistical_code) AS sar_statistical_code_lkp
	FROM EXP_Default
),
LKP_V2_Coverage AS (
	SELECT
