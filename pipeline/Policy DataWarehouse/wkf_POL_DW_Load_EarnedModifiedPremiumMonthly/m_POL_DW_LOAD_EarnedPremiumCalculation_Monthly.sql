...
SQ_EDW_Tables_PMS AS (
	...
	SELECT @DATE2 AS eff_from_date,
	       WNMP.WorkNormalizedModifiedPremiumId,
	       P.pol_ak_id,
	       ...
	       WNMP.PremiumTransactionEnteredDate as PremiumTransactionEnteredDate,
	       A.PremiumMasterCoverageEffectiveDate,
	       A.PremiumMasterCoverageExpirationDate,
	       WNMP.PremiumMasterRunDate as PremiumMasterRunDate,
	       WNMP.ModifiedPremium as PremiumMasterPremium,
	...
	A.SourceSystemID
	FROM WorkNormalizedModifiedPremium WNMP with(nolock)
	inner join
	@{pipeline().parameters.SOURCE_DATABASE_NAME}.@{pipeline().parameters.SOURCE_TABLE_OWNER}.PremiumMasterCalculation A
	on WNMP.PremiumMasterCalculationId=A.PremiumMasterCalculationId 
	...
	WHERE  WNMP.PremiumMasterRunDate>= '01-01-1998'
	...
	AND WNMP.PremiumMasterRunDate<=@DATE6
	and convert(varchar(6),A.PremiumMasterCoverageExpirationDate,112)>=convert(varchar(6),@DATE6,112)
	and CONVERT(varchar(6),A.PremiumMasterCoverageExpirationDate,112)>=CONVERT(varchar(6),WNMP.PremiumMasterRunDate,112)
...
EXP_Values AS (
	...
	LAST_DAY(ADD_TO_DATE(v_RunDate, 'MM', - 1)) AS v_PreviousMonthRunDate,
	...
	-- 
	-- 
	SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(v_PreviousMonthRunDate, 'DD', 01), 'HH', 00), 'MI', 00), 'SS', 00) AS v_FirstDay_PreviousRundate,
...
EXP_Calculate_EarnedPremium AS (
	...
	IFF(LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_1_PremiumType.Returned_Value IS NULL, LKP_WORKEARNEDPREMIUMCOVERAGE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_1.Returned_Value, LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_1_PremiumType.Returned_Value) AS v_Previous_Returned_Value,
	-- *INF*: to_date(substr(v_Previous_Returned_Value,1,INSTR(v_Previous_Returned_Value,'|',1,1)-1),'YYYY/MM/DD HH24:MI:SS')
	to_date(substr(v_Previous_Returned_Value, 1, INSTR(v_Previous_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_PreviousMonthStatisticalCoverageCancellationDate,
	...
	to_decimal(substr(v_Previous_Returned_Value, INSTR(v_Previous_Returned_Value, '|', 1, 1) + 1, INSTR(v_Previous_Returned_Value, '|', 1, 2) - ( INSTR(v_Previous_Returned_Value, '|', 1, 1) + 1 )), 4) AS v_PreviousMonth_Min_Premium,
	...
	substr(v_Previous_Returned_Value, INSTR(v_Previous_Returned_Value, '|', 1, 2) + 1, INSTR(v_Previous_Returned_Value, '|', 1, 3) - ( INSTR(v_Previous_Returned_Value, '|', 1, 2) + 1 )) AS v_PrevoiusMonth_PremiumType,
	...
	IFF(v_PreviousMonthStatisticalCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_PreviousMonthStatisticalCoverageCancellationDate) AS v_PreviousCoverageCancellationDate,
	...
	IFF(( PremiumType = 'D' AND v_PrevoiusMonth_PremiumType = 'D' ) OR ( PremiumType = 'C' AND v_PrevoiusMonth_PremiumType = 'D' ) OR ( PremiumType = 'C' AND v_PrevoiusMonth_PremiumType = 'C' ), v_PreviousCoverageCancellationDate, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS')) AS v_PreviousStatisticalCoverageCancellationDate,
	-- *INF*: DATE_DIFF(
	...
	-- 
	-- 
	DATE_DIFF(LEAST(PreviousMonthRunDate, v_PreviousStatisticalCoverageCancellationDate, PremiumTransactionExpirationDate), PremiumTransactionEffectiveDate, 'DAY') AS v_LastMonthNumertor,
	-- *INF*: DATE_DIFF(
	-- LEAST(PremiumTransactionExpirationDate,v_PreviousStatisticalCoverageCancellationDate),
	-- PremiumTransactionEffectiveDate,'DAY')
	DATE_DIFF(LEAST(PremiumTransactionExpirationDate, v_PreviousStatisticalCoverageCancellationDate), PremiumTransactionEffectiveDate, 'DAY') AS v_LastMonthDenominator,
	...
	IFF(v_PreviousMonth_Min_Premium = 0.0, DATE_DIFF(PremiumTransactionExpirationDate, PremiumTransactionEffectiveDate, 'DAY'), DATE_DIFF(LEAST(PremiumTransactionExpirationDate, v_PreviousStatisticalCoverageCancellationDate), PremiumTransactionEffectiveDate, 'DAY')) AS v_LastMonthDenominator_Audit,
	...
	IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator = 0 ) OR v_LastMonthDenominator = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_LastMonthNumertor / v_LastMonthDenominator ), 4)) AS v_LastMonthEarnedPremium_CancellationRegular,
	...
	-- 
	-- 
	IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator_Audit = 0 ) OR v_LastMonthDenominator_Audit = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_LastMonthNumertor / v_LastMonthDenominator_Audit ), 4)) AS v_LastMonthEarnedPremium_CancellationAudit,
	...
	IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator = 0 ) OR v_LastMonthDenominator = 0, WrittenExposure, ROUND(WrittenExposure * ( v_LastMonthNumertor / v_LastMonthDenominator ), 4)) AS v_LastMonthEarnedExposure_CancellationRegular,
	...
	IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator_Audit = 0 ) OR v_LastMonthDenominator_Audit = 0, WrittenExposure, ROUND(WrittenExposure * ( v_LastMonthNumertor / v_LastMonthDenominator_Audit ), 4)) AS v_LastMonthEarnedExposure_CancellationAudit,
	...
	IFF(PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= FirstDay_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ), IFF(( trunc(PreviousMonthRunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_PreviousMonth_Min_Premium = 0.0, IFF(PreviousMonthRunDate >= v_Lkp_FirstAudit_RunDate, v_LastMonthEarnedPremium_CancellationRegular, v_LastMonthEarnedPremium_CancellationAudit), v_LastMonthEarnedPremium_CancellationRegular), 0.0), 0.0) AS LastMonthsEarnedPremium,
	...
	-- --)
	-- 
	IFF(PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= FirstDay_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ), IFF(( trunc(PreviousMonthRunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_PreviousMonth_Min_Premium = 0.0, IFF(PreviousMonthRunDate >= v_Lkp_FirstAudit_RunDate, v_LastMonthEarnedExposure_CancellationRegular, v_LastMonthEarnedExposure_CancellationAudit), v_LastMonthEarnedExposure_CancellationRegular), 0.0), 0.0) AS LastMonthsEarnedExposure,
	...
	to_date(substr(v_Current_Returned_Value, 1, INSTR(v_Current_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_CurrentMonthStatisticalCoverageCancellationDate,
	...
	to_decimal(substr(v_Current_Returned_Value, INSTR(v_Current_Returned_Value, '|', 1, 1) + 1, INSTR(v_Current_Returned_Value, '|', 1, 2) - ( INSTR(v_Current_Returned_Value, '|', 1, 1) + 1 )), 4) AS v_CurrentMonth_Min_Premium,
	...
	substr(v_Current_Returned_Value, INSTR(v_Current_Returned_Value, '|', 1, 2) + 1, INSTR(v_Current_Returned_Value, '|', 1, 3) - ( INSTR(v_Current_Returned_Value, '|', 1, 2) + 1 )) AS v_CurrentMonth_PremiumType,
	...
	IFF(v_CurrentMonthStatisticalCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_CurrentMonthStatisticalCoverageCancellationDate) AS v_CurrentCoverageCancellationDate,
	...
	IFF(( PremiumType = 'D' AND v_CurrentMonth_PremiumType = 'D' ) OR ( PremiumType = 'C' AND v_CurrentMonth_PremiumType = 'D' ) OR ( PremiumType = 'C' AND v_CurrentMonth_PremiumType = 'C' ), v_CurrentCoverageCancellationDate, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS')) AS v_CurrentStatisticalCoverageCancellationDate,
	...
	-- 
	-- 
	DATE_DIFF(LEAST(RunDate, v_CurrentStatisticalCoverageCancellationDate, PremiumTransactionExpirationDate), PremiumTransactionEffectiveDate, 'DAY') AS v_Numertor,
	-- *INF*: DATE_DIFF(
	...
	IFF(v_CurrentMonth_Min_Premium = 0.0, DATE_DIFF(PremiumTransactionExpirationDate, PremiumTransactionEffectiveDate, 'DAY'), DATE_DIFF(LEAST(PremiumTransactionExpirationDate, v_CurrentStatisticalCoverageCancellationDate), PremiumTransactionEffectiveDate, 'DAY')) AS v_Denominator_Audit,
	...
	IFF(( v_Numertor = 0 AND v_Denominator_Audit = 0 ) OR v_Denominator_Audit = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_Numertor / v_Denominator_Audit ), 4)) AS v_EarnedPremium_CancellationAudit,
	...
	-- )
	IFF(( v_Numertor = 0 AND v_Denominator = 0 ) OR v_Denominator = 0, WrittenExposure, ROUND(WrittenExposure * ( v_Numertor / v_Denominator ), 4)) AS v_EarnedExposure_CancellationRegular,
	...
	IFF(( v_Numertor = 0 AND v_Denominator_Audit = 0 ) OR v_Denominator_Audit = 0, WrittenExposure, ROUND(WrittenExposure * ( v_Numertor / v_Denominator_Audit ), 4)) AS v_EarnedExposure_CancellationAudit,
	...
	IFF(( trunc(RunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_CurrentMonth_Min_Premium = 0.0, IFF(RunDate >= v_Lkp_FirstAudit_RunDate, v_EarnedPremium_CancellationRegular, v_EarnedPremium_CancellationAudit), v_EarnedPremium_CancellationRegular), 0.0) AS v_EarnedPremium,
	...
	-- --)
	IFF(( trunc(RunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_CurrentMonth_Min_Premium = 0.0, IFF(RunDate >= v_Lkp_FirstAudit_RunDate, v_EarnedExposure_CancellationRegular, v_EarnedExposure_CancellationAudit), v_EarnedExposure_CancellationRegular), 0.0) AS v_EarnedExposure,
	...
	IFF(( PremiumTransactionBookedDate <= RunDate AND trunc(PremiumTransactionBookedDate, 'MM') < trunc(PremiumTransactionEffectiveDate, 'MM') AND trunc(PremiumTransactionEffectiveDate, 'MM') > trunc(RunDate, 'MM') ) AND PremiumTransactionAmount <> 0.0 OR ( DECODE(TRUE,
	v_ChangeInEarnedPremium <> 0.0, 1,
	InsuranceLine = 'WC' AND Lkp_FirstAudit_RunDate IS NULL AND v_CurrentMonth_Min_Premium = 0 AND PremiumTransactionAmount <> 0, 1,
	InsuranceLine = 'WC' AND v_CurrentMonth_Min_Premium = 0 AND ( NOT ( Lkp_FirstAudit_RunDate IS NULL ) ) AND v_ChangeInEarnedPremium = 0.0 AND RunDate < Lkp_FirstAudit_RunDate AND PremiumTransactionAmount <> 0, 1,
	InsuranceLine = 'WC' AND v_CurrentMonth_Min_Premium = 0 AND ( NOT ( Lkp_FirstAudit_RunDate IS NULL ) ) AND v_ChangeInEarnedPremium = 0.0 AND RunDate = Lkp_FirstAudit_RunDate AND PremiumTransactionAmount <> 0, 1,
	0) = 1 ), 1, 0) AS v_ChangeInEP_Zero_Flag,
...
EXP_Metadata AS (
	...
	TRUNC(PremiumTransactionEffectiveDate, 'MM') AS PremiumTransactionEffectiveDate_MM,
	...
	TRUNC(PremiumTransactionBookedDate, 'MM') AS PremiumTransactionBookedDate_MM,
	RunDate1 AS RunDate,
	-- *INF*: ADD_TO_DATE(RunDate,'MM',-1)
	ADD_TO_DATE(RunDate, 'MM', - 1) AS v_PreviousMonthRunDate,
	-- *INF*: SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART( v_PreviousMonthRunDate, 'DD', 1 ),'HH',0),'MI',0),'SS',0)
	SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(v_PreviousMonthRunDate, 'DD', 1), 'HH', 0), 'MI', 0), 'SS', 0) AS v_FirstDay_PreviousRundate,
	-- *INF*: TRUNC(RunDate,'MM')
	TRUNC(RunDate, 'MM') AS RunDate_MM,
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, 0.0)) AS v_PremiumAmount,
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), FullTermPremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), FullTermPremiumAmount, 0.0)) AS v_FullTermPremiumAmount,
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount - EarnedPremiumAmount, ChangeInEarnedPremium * ( - 1 ))) AS v_ChangeInUnEarnedPremium,
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), Exposure, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), Exposure, 0.0)) AS v_Exposure,
...
SQ_EDW_Tables_Audit AS (
	...
	@{pipeline().parameters.REASON_AMENDED_CODE}
	       and CONVERT(varchar(6),A.PremiumMasterCoverageExpirationDate,112)<CONVERT(varchar(6),WNMP.PremiumMasterRunDate,112)
	and CONVERT(varchar(6),WNMP.PremiumMasterRunDate,112)<=CONVERT(varchar(6),@DATE2,112)
	@{pipeline().parameters.WHERE_CLAUSE_PMS}
),
EXP_Values_Audit AS (
	SELECT
	...
	--                                ,'SS',00)
	-- 
	SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(v_PreviousMonthRunDate, 'DD', 01), 'HH', 00), 'MI', 00), 'SS', 00) AS Firstday_PreviousRundate,
	-- *INF*: SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART( V_Last_Day_of_Last_Month, 'DD', 1 ),'HH',0),'MI',0),'SS',0)
	SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(V_Last_Day_of_Last_Month, 'DD', 1), 'HH', 0), 'MI', 0), 'SS', 0) AS v_FirstDayofRunMonth,
	v_FirstDayofRunMonth AS FirstDayofRunMonth,
	BureauStatisticalCodeAKID,
...
EXP_Calculate_EarnedPremium_Audit AS (
	...
	to_date(substr(v_Previous_Returned_Value, 1, INSTR(v_Previous_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_PreviousMonthStatisticalCoverageCancellationDate,
	-- *INF*: IIF(ISNULL(v_PreviousMonthStatisticalCoverageCancellationDate),TO_DATE('12/31/2100 23:59:59','MM/DD/YYYY HH24:MI:SS'),v_PreviousMonthStatisticalCoverageCancellationDate)
	IFF(v_PreviousMonthStatisticalCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_PreviousMonthStatisticalCoverageCancellationDate) AS v_PreviousStatisticalCoverageCancellationDate,
	-- *INF*: DATE_DIFF(
	-- LEAST(PreviousMonthRunDate,v_PreviousStatisticalCoverageCancellationDate,PremiumTransactionExpirationDate),
	--                             PremiumTransactionEffectiveDate,'DAY')
	-- 
	...
	-- --ROUND(PremiumTransactionAmount * (v_LastMonthNumertor/v_LastMonthDenominator),2)
	-- --)
	IFF(( PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= Firstday_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ) ) OR ( PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND PremiumTransactionExpirationDate < PremiumTransactionEffectiveDate AND trunc(PreviousMonthRunDate, 'MONTH') = trunc(GREATEST(PremiumTransactionEnteredDate, PremiumTransactionBookedDate, PremiumTransactionEffectiveDate, PremiumTransactionExpirationDate), 'MONTH') ), IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator = 0 ) OR v_LastMonthDenominator = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_LastMonthNumertor / v_LastMonthDenominator ), 4)), 0.0) AS LastMonthsEarnedPremium,
	-- *INF*: IIF(
	-- (PremiumTransactionEnteredDate <= PreviousMonthRunDate AND 
	-- PremiumTransactionBookedDate <=PreviousMonthRunDate AND 
	-- PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND 
	...
	-- --ROUND(PremiumTransactionAmount * (v_LastMonthNumertor/v_LastMonthDenominator),2)
	-- --)
	IFF(( PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= Firstday_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ) ) OR ( PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND PremiumTransactionExpirationDate < PremiumTransactionEffectiveDate AND trunc(PreviousMonthRunDate, 'MONTH') = trunc(GREATEST(PremiumTransactionEnteredDate, PremiumTransactionBookedDate, PremiumTransactionEffectiveDate, PremiumTransactionExpirationDate), 'MONTH') ), IFF(( v_LastMonthNumertor = 0 AND v_LastMonthDenominator = 0 ) OR v_LastMonthDenominator = 0, WrittenExposure, ROUND(WrittenExposure * ( v_LastMonthNumertor / v_LastMonthDenominator ), 4)), 0.0) AS LastMonthsEarnedExposure,
	-- *INF*: IIF(ISNULL(:LKP.LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE(pol_ak_id,StatisticalCoverageAKID,RunDate,-1,PremiumType)),:LKP.LKP_WORKEARNEDPREMIUMCOVERAGE(pol_ak_id,StatisticalCoverageAKID,RunDate,-1),:LKP.LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE(pol_ak_id,StatisticalCoverageAKID,RunDate,-1,PremiumType))
	-- 
	-- --:LKP.LKP_WORKEARNEDPREMIUMCOVERAGE(StatisticalCoverageAKID,RunDate,-1)
	IFF(LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_RunDate_1_PremiumType.Returned_Value IS NULL, LKP_WORKEARNEDPREMIUMCOVERAGE_pol_ak_id_StatisticalCoverageAKID_RunDate_1.Returned_Value, LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_RunDate_1_PremiumType.Returned_Value) AS v_Current_Returned_Value,
	...
	to_date(substr(v_Current_Returned_Value, 1, INSTR(v_Current_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_CurrentMonthStatisticalCoverageCancellationDate,
	-- *INF*: IIF(ISNULL(v_CurrentMonthStatisticalCoverageCancellationDate),TO_DATE('12/31/2100 23:59:59','MM/DD/YYYY HH24:MI:SS'),v_CurrentMonthStatisticalCoverageCancellationDate)
	IFF(v_CurrentMonthStatisticalCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_CurrentMonthStatisticalCoverageCancellationDate) AS v_CurrentStatisticalCoverageCancellationDate,
	v_CurrentStatisticalCoverageCancellationDate AS O_StatisticalCoverageCancellationDate,
	-- *INF*: DATE_DIFF(
	-- LEAST(RunDate,v_CurrentStatisticalCoverageCancellationDate,PremiumTransactionExpirationDate),
	--                             PremiumTransactionEffectiveDate,'DAY')
	...
	-- ROUND(PremiumTransactionAmount * (v_Numertor/v_Denominator),4)
	-- ))
	IFF(PremiumTransactionEnteredDate > pol_exp_date, PremiumTransactionAmount, IFF(( v_Numertor = 0 AND v_Denominator = 0 ) OR v_Denominator = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_Numertor / v_Denominator ), 4))) AS v_EarnedPremium,
	-- *INF*: IIF(PremiumTransactionEnteredDate>pol_exp_date,PremiumTransactionAmount,v_EarnedPremium  -  LastMonthsEarnedPremium)
	IFF(PremiumTransactionEnteredDate > pol_exp_date, PremiumTransactionAmount, v_EarnedPremium - LastMonthsEarnedPremium) AS v_ChangeInEarnedPremium,
	...
	IFF(PremiumTransactionEnteredDate > pol_exp_date, WrittenExposure, IFF(( v_Numertor = 0 AND v_Denominator = 0 ) OR v_Denominator = 0, WrittenExposure, ROUND(WrittenExposure * ( v_Numertor / v_Denominator ), 4))) AS v_EarnedExposure,
	...
	IFF(PremiumTransactionEnteredDate > pol_exp_date, WrittenExposure, v_EarnedExposure - LastMonthsEarnedExposure) AS v_ChangeInEarnedExposure,
	v_ChangeInEarnedPremium AS ChangeInEarnedPremium,
	v_EarnedPremium AS EarnedPremium,
	v_ChangeInEarnedExposure AS ChangeInEarnedExposure,
	v_EarnedExposure AS EarnedExposure,
...
SQ_EDW_Tables_DCT AS (
	...
	RC.CoverageType,
	CC.CoverageCode
	FROM @{pipeline().parameters.SOURCE_DATABASE_NAME}.@{pipeline().parameters.SOURCE_TABLE_OWNER}.WorkNormalizedModifiedPremium WNMP with(nolock)
	inner join
	@{pipeline().parameters.SOURCE_DATABASE_NAME}.@{pipeline().parameters.SOURCE_TABLE_OWNER}.PremiumMasterCalculation PT
	on WNMP.PremiumMasterCalculationId=PT.PremiumMasterCalculationId 
	       INNER JOIN @{pipeline().parameters.SOURCE_DATABASE_NAME}.@{pipeline().parameters.SOURCE_TABLE_OWNER}.PolicyCoverage PC with(nolock)
	...
	AND ((WNMP.PremiumMasterRunDate <=@DATE1
	and convert(varchar(6),PT.PremiumMasterCoverageExpirationDate,112)>=convert(varchar(6),@DATE1,112))
	OR CONVERT(varchar(6),PT.PremiumMasterCoverageExpirationDate,112)<CONVERT(varchar(6),WNMP.PremiumMasterRunDate ,112))
...
EXP_Calculate_EarnedPremium_DCT AS (
	...
	PremiumTransactionBookedDate,
	-- *INF*: TRUNC(PremiumTransactionBookedDate,'MM')
	TRUNC(PremiumTransactionBookedDate, 'MM') AS v_PremiumTransactionBookedDate_MM,
	PremiumTransactionEffectiveDate,
	-- *INF*: TRUNC(PremiumTransactionEffectiveDate ,'MM')
	TRUNC(PremiumTransactionEffectiveDate, 'MM') AS v_PremiumTransactionEffectiveDate_MM,
	PremiumTransactionExpirationDate,
	PremiumType,
	ReasonAmendedCode,
	PremiumTransactionAmount,
	...
	RunDate,
	-- *INF*: TRUNC(RunDate,'MM')
	TRUNC(RunDate, 'MM') AS v_RunDate_MM,
	WrittenExposure,
	-- *INF*: :LKP.LKP_GET_FIRST_AUDIT(pol_ak_id)
	LKP_GET_FIRST_AUDIT_pol_ak_id.Rundate AS Lkp_FirstAudit_RunDate,
	-- *INF*: IIF(ISNULL(Lkp_FirstAudit_RunDate),TO_DATE('12/31/2100 23:59:59' , 'MM/DD/YYYY HH24:MI:SS'),Lkp_FirstAudit_RunDate)
	...
	IFF(LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_RatingCoverageAKID_PremiumType.Returned_Value IS NULL, LKP_WORKEARNEDPREMIUMCOVERAGE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_RatingCoverageAKID.Returned_Value, LKP_WORKEARNEDPREMIUMCOVERAGE_TYPE_pol_ak_id_StatisticalCoverageAKID_PreviousMonthRunDate_RatingCoverageAKID_PremiumType.Returned_Value) AS v_Previous_Returned_Value,
	-- *INF*: to_date(substr(v_Previous_Returned_Value,1,INSTR(v_Previous_Returned_Value,'|',1,1)-1),'YYYY/MM/DD HH24:MI:SS')
	to_date(substr(v_Previous_Returned_Value, 1, INSTR(v_Previous_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_PreviousMonthRatingCoverageCancellationDate,
	-- *INF*: to_decimal(substr(v_Previous_Returned_Value,INSTR(v_Previous_Returned_Value,'|',1,1)+1,INSTR(v_Previous_Returned_Value,'|',1,2)-(INSTR(v_Previous_Returned_Value,'|',1,1)+1)),4)
	to_decimal(substr(v_Previous_Returned_Value, INSTR(v_Previous_Returned_Value, '|', 1, 1) + 1, INSTR(v_Previous_Returned_Value, '|', 1, 2) - ( INSTR(v_Previous_Returned_Value, '|', 1, 1) + 1 )), 4) AS v_PreviousMonth_Min_Premium,
	...
	IFF(v_PreviousMonthRatingCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_PreviousMonthRatingCoverageCancellationDate) AS v_PreviousRatingCoverageCancellationDate,
	-- *INF*: DATE_DIFF(
	...
	-- 
	-- 
	DATE_DIFF(LEAST(PreviousMonthRunDate, v_PreviousRatingCoverageCancellationDate, PremiumTransactionExpirationDate), PremiumTransactionEffectiveDate, 'DAY') AS v_LastMonthNumertor,
	-- *INF*: DATE_DIFF(
	...
	-- 
	-- --use PreviousRatingCoverageCancellationDate and RatingCoverageEffectiveDate
	DATE_DIFF(LEAST(PremiumTransactionExpirationDate, v_PreviousRatingCoverageCancellationDate), PremiumTransactionEffectiveDate, 'DAY') AS v_LastMonthDenominator,
	...
	DATE_DIFF(PremiumTransactionExpirationDate, PremiumTransactionEffectiveDate, 'DAY') AS v_LastMonthDenominator_Audit,
	...
	IFF(PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= FirstDay_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ), IFF(( trunc(PreviousMonthRunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_PreviousMonth_Min_Premium = 0.0, IFF(PreviousMonthRunDate >= v_Lkp_FirstAudit_RunDate, v_LastMonthEarnedPremium_CancellationRegular, v_LastMonthEarnedPremium_CancellationAudit), v_LastMonthEarnedPremium_CancellationRegular), 0.0), 0.0) AS v_LastMonthsEarnedPremium,
	-- *INF*: IIF(PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <=PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate
	-- AND (PremiumTransactionExpirationDate >= FirstDay_PreviousRundate
	-- OR trunc(PremiumTransactionBookedDate,'DAY')=trunc(PreviousMonthRunDate,'DAY')),iif(( trunc(PreviousMonthRunDate,'MM')>=trunc(PremiumTransactionEffectiveDate ,'MM')),
	-- IIF(v_PreviousMonth_Min_Premium=0.0,IIF(PreviousMonthRunDate>=v_Lkp_FirstAudit_RunDate,v_LastMonthEarnedExposure_CancellationRegular,v_LastMonthEarnedExposure_CancellationAudit),v_LastMonthEarnedExposure_CancellationRegular),0.0)
	...
	-- --ROUND(PremiumTransactionAmount * (v_LastMonthNumertor/v_LastMonthDenominator),2)
	-- --)
	IFF(PremiumTransactionEnteredDate <= PreviousMonthRunDate AND PremiumTransactionBookedDate <= PreviousMonthRunDate AND PremiumTransactionEffectiveDate <= PreviousMonthRunDate AND ( PremiumTransactionExpirationDate >= FirstDay_PreviousRundate OR trunc(PremiumTransactionBookedDate, 'DAY') = trunc(PreviousMonthRunDate, 'DAY') ), IFF(( trunc(PreviousMonthRunDate, 'MM') >= trunc(PremiumTransactionEffectiveDate, 'MM') ), IFF(v_PreviousMonth_Min_Premium = 0.0, IFF(PreviousMonthRunDate >= v_Lkp_FirstAudit_RunDate, v_LastMonthEarnedExposure_CancellationRegular, v_LastMonthEarnedExposure_CancellationAudit), v_LastMonthEarnedExposure_CancellationRegular), 0.0), 0.0) AS v_LastMonthsEarnedExposure,
	...
	-- 
	IFF(LKP_WorkEarnedPremiumCoverage_type IS NULL, LKP_WorkEarnedPremiumCoverage, LKP_WorkEarnedPremiumCoverage_type) AS v_Current_Returned_Value,
	-- *INF*: to_date(substr(v_Current_Returned_Value,1,INSTR(v_Current_Returned_Value,'|',1,1)-1),'YYYY/MM/DD HH24:MI:SS')
	to_date(substr(v_Current_Returned_Value, 1, INSTR(v_Current_Returned_Value, '|', 1, 1) - 1), 'YYYY/MM/DD HH24:MI:SS') AS v_CurrentMonthRatingCoverageCancellationDate,
	-- *INF*: to_decimal(substr(v_Current_Returned_Value,INSTR(v_Current_Returned_Value,'|',1,1)+1,INSTR(v_Current_Returned_Value,'|',1,2)-(INSTR(v_Current_Returned_Value,'|',1,1)+1)),4)
	to_decimal(substr(v_Current_Returned_Value, INSTR(v_Current_Returned_Value, '|', 1, 1) + 1, INSTR(v_Current_Returned_Value, '|', 1, 2) - ( INSTR(v_Current_Returned_Value, '|', 1, 1) + 1 )), 4) AS v_CurrentMonth_Min_Premium,
	...
	IFF(v_CurrentMonthRatingCoverageCancellationDate IS NULL, TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS'), v_CurrentMonthRatingCoverageCancellationDate) AS v_CurrentRatingCoverageCancellationDate,
	-- *INF*: DATE_DIFF(
	...
	IFF(( v_Numertor = 0 AND v_Denominator_Audit = 0 ) OR v_LastMonthDenominator_Audit = 0, PremiumTransactionAmount, ROUND(PremiumTransactionAmount * ( v_Numertor / v_LastMonthDenominator_Audit ), 4)) AS v_EarnedPremium_CancellationAudit,
	...
	IFF(( v_Numertor = 0 AND v_Denominator_Audit = 0 ) OR v_LastMonthDenominator_Audit = 0, WrittenExposure, ROUND(WrittenExposure * ( v_Numertor / v_LastMonthDenominator_Audit ), 4)) AS v_EarnedExposure_CancellationAudit,
	...
	IFF(( v_RunDate_MM >= v_PremiumTransactionEffectiveDate_MM ), IFF(v_CurrentMonth_Min_Premium = 0.0, IFF(RunDate >= v_Lkp_FirstAudit_RunDate, v_EarnedPremium_CancellationRegular, v_EarnedPremium_CancellationAudit), v_EarnedPremium_CancellationRegular), 0.0) AS v_EarnedPremium,
	...
	IFF(( v_RunDate_MM >= v_PremiumTransactionEffectiveDate_MM ), IFF(v_CurrentMonth_Min_Premium = 0.0, IFF(RunDate >= v_Lkp_FirstAudit_RunDate, v_EarnedExposure_CancellationRegular, v_EarnedExposure_CancellationAudit), v_EarnedExposure_CancellationRegular), 0.0) AS v_EarnedExposure,
	...
	-- 
	-- --PremiumTransactionAmount=v_EarnedPremium and 
	IFF(( PremiumTransactionBookedDate <= RunDate AND v_PremiumTransactionBookedDate_MM < v_PremiumTransactionEffectiveDate_MM AND v_PremiumTransactionEffectiveDate_MM > v_RunDate_MM ) AND PremiumTransactionAmount <> 0.0 OR ( DECODE(TRUE,
	v_ChangeInEarnedPremium <> 0.0, 1,
	InsuranceLine = 'WC' AND Lkp_FirstAudit_RunDate IS NULL AND v_CurrentMonth_Min_Premium = 0 AND PremiumTransactionAmount <> 0, 1,
	InsuranceLine = 'WC' AND v_CurrentMonth_Min_Premium = 0 AND ( NOT ( Lkp_FirstAudit_RunDate IS NULL ) ) AND v_ChangeInEarnedPremium = 0.0 AND RunDate < Lkp_FirstAudit_RunDate AND PremiumTransactionAmount <> 0, 1,
	InsuranceLine = 'WC' AND v_CurrentMonth_Min_Premium = 0 AND ( NOT ( Lkp_FirstAudit_RunDate IS NULL ) ) AND v_ChangeInEarnedPremium = 0.0 AND RunDate = Lkp_FirstAudit_RunDate AND PremiumTransactionAmount <> 0, 1,
...
EXP_Metadata_DCT AS (
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, 0.0)) AS O_PremiumAmount,
	o_FullTermPremiumAmount AS FullTermPremiumAmount,
	-- *INF*: IIF((PremiumTransactionBookedDate_MM<PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM=RunDate_MM),FullTermPremiumAmount, IIF(PremiumTransactionEffectiveDate_MM<=PremiumTransactionBookedDate_MM AND (PremiumTransactionEffectiveDate_MM=RunDate_MM OR PremiumTransactionBookedDate_MM=RunDate_MM),FullTermPremiumAmount,0.0))  --IIF((PremiumTransactionEnteredDate <= v_PreviousMonthRunDate --AND PremiumTransactionBookedDate <=v_PreviousMonthRunDate --AND PremiumTransactionEffectiveDate <= v_PreviousMonthRunDate --AND (PremiumTransactionExpirationDate >= v_FirstDay_PreviousRundate --OR trunc(PremiumTransactionBookedDate,'DAY')=trunc(v_PreviousMonthRunDate,'DAY'))) --or (PremiumTransactionBookedDate <=v_PreviousMonthRunDate AND trunc(PremiumTransactionBookedDate,'MM')<trunc(PremiumTransactionEffectiveDate ,'MM')),0.0,PremiumAmount)   --IIF(PremiumTransactionBookedDate_MM<PremiumTransactionEffectiveDate_MM and PremiumTransactionBookedDate_MM=RunDate_MM,PremiumAmount, --iif(PremiumTransactionBookedDate_MM>=PremiumTransactionEffectiveDate_MM and PremiumTransactionEffectiveDate_MM=RunDate_MM,PremiumAmount,0.0))
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), FullTermPremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), FullTermPremiumAmount, 0.0)) AS v_FullTermPremiumAmount,
	v_FullTermPremiumAmount AS O_FullTermPremiumAmount,
	...
	IFF(( PremiumTransactionBookedDate_MM < PremiumTransactionEffectiveDate_MM AND PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount, IFF(PremiumTransactionEffectiveDate_MM <= PremiumTransactionBookedDate_MM AND ( PremiumTransactionEffectiveDate_MM = RunDate_MM OR PremiumTransactionBookedDate_MM = RunDate_MM ), PremiumAmount - EarnedPremiumAmount, ChangeInEarnedPremium * ( - 1 ))) AS o_ChangeInUnEarnedPremium,
