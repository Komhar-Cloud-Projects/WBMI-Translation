...
SQ_EarnedPremiumMonthlyCalculation_Balance AS (
	...
	EPMC.Exposure
	from @{pipeline().parameters.TARGET_TABLE_OWNER}.WorkEarnedModifiedPremium EPMC
...
EarnedPremiumMonthlyCalculation AS (
	INSERT INTO @{pipeline().parameters.TARGET_TABLE_OWNER}.WorkEarnedModifiedPremium
