...
EXP_Stage AS (
	...
	-- i_RetroactiveDate
	-- )
	IFF(LineType = 'DirectorsAndOfficersNFP', LKP_WBNDOCOVERAGEDIRECTORSANDOFFICERSNFPSTAGE_CoverageId.RetroactiveDate, i_RetroactiveDate) AS o_RetroactiveDate
...
EXP_Metadata AS (
	...
	-- 'N/A')
	DECODE(true,
	IN(i_LineType, 'GeneralLiability', 'SBOPGeneralLiability') AND NOT LKP_SUPCLASSIFICATIONGENERALLIABILITY_i_ClassCode_i_SublineCode_i_RatingStateCode.lkp_result IS NULL, LKP_SUPCLASSIFICATIONGENERALLIABILITY_i_ClassCode_i_SublineCode_i_RatingStateCode.lkp_result,
	IN(i_LineType, 'GeneralLiability', 'SBOPGeneralLiability') AND NOT LKP_SUPCLASSIFICATIONGENERALLIABILITY_i_ClassCode_i_SublineCode_99.lkp_result IS NULL, LKP_SUPCLASSIFICATIONGENERALLIABILITY_i_ClassCode_i_SublineCode_99.lkp_result,
	'N/A') AS v_lkp_result,
	-- *INF*: IIF(ISNULL(i_RetroactiveDate),
	-- TO_DATE('1800-01-01 00:00:00','YYYY-MM-DD HH24:MI:SS'),
	-- i_RetroactiveDate
	-- )
	IFF(i_RetroactiveDate IS NULL, TO_DATE('1800-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), i_RetroactiveDate) AS v_RetroactiveDate,
	-- *INF*: DECODE(TRUE,
	...
	DECODE(TRUE,
	i_LineType <> 'DirectorsAndOfficersNFP' AND i_LiabilityFormCode = 'OCCURRENCE', '3',
	( i_LiabilityFormCode = 'CLAIMSMADE' OR IN(i_LineType, 'DirectorsAndOfficersNFP', 'DirectorsAndOffsCondos', 'EmploymentPracticesLiab') ) AND i_RetroactiveDate IS NULL, '4',
	( i_LiabilityFormCode = 'CLAIMSMADE' OR IN(i_LineType, 'DirectorsAndOfficersNFP', 'DirectorsAndOffsCondos', 'EmploymentPracticesLiab') ) AND NOT i_RetroactiveDate IS NULL, '1',
	'N/A') AS v_LiabilityFormCode,
	i_PremiumTransactionID AS o_PremiumTransactionID,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_CoverageGUID) AS o_CoverageGUID,
	...
	-- )
	IFF(v_lkp_result = 'N/A' OR v_lkp_result IS NULL, 'N/A', IFF(SUBSTR(v_lkp_result, 1, instr(v_lkp_result, '@1') - 1) IS NULL OR LENGTH(SUBSTR(v_lkp_result, 1, instr(v_lkp_result, '@1') - 1)) = 0, 'N/A', SUBSTR(v_lkp_result, 1, instr(v_lkp_result, '@1') - 1))) AS o_ClassSummary,
	-- *INF*: IIF(v_lkp_result='N/A' OR ISNULL(v_lkp_result), 'N/A',
	...
	-- )
	IFF(v_lkp_result = 'N/A' OR v_lkp_result IS NULL, 'N/A', IFF(SUBSTR(v_lkp_result, ( instr(v_lkp_result, '@1') + 2 ), ( instr(v_lkp_result, '@2') - ( instr(v_lkp_result, '@1') + 2 ) )) IS NULL OR LENGTH(SUBSTR(v_lkp_result, ( instr(v_lkp_result, '@1') + 2 ), ( instr(v_lkp_result, '@2') - ( instr(v_lkp_result, '@1') + 2 ) ))) = 0, 'N/A', SUBSTR(v_lkp_result, ( instr(v_lkp_result, '@1') + 2 ), ( instr(v_lkp_result, '@2') - ( instr(v_lkp_result, '@1') + 2 ) )))) AS o_ClassGroup
	FROM EXP_Valuate
