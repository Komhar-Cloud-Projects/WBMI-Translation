...
EXP_StringValues AS (
	...
	IFF(i_ProgramCode IS NULL OR LENGTH(i_ProgramCode) = 0 OR IS_SPACES(i_ProgramCode), 'N/A', LTRIM(RTRIM(i_ProgramCode))) AS o_ProgramCode,
	...
	IFF(i_ProgramDescription IS NULL OR LENGTH(i_ProgramDescription) = 0 OR IS_SPACES(i_ProgramDescription), 'N/A', LTRIM(RTRIM(i_ProgramDescription))) AS o_ProgramDescription
	FROM SQ_Program
),
