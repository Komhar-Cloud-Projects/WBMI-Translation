...
EXP_StringValues AS (
	...
	IFF(i_SourceProductCode IS NULL OR LENGTH(i_SourceProductCode) = 0 OR IS_SPACES(i_SourceProductCode), 'N/A', LTRIM(RTRIM(i_SourceProductCode))) AS o_SourceProductCode
	FROM SQ_SupProduct
),
