...
EXP_Consolidate_Data_from_Lookups AS (
	...
	IFF(i_ReinsuranceCoverageDimID IS NOT NULL, i_ReinsuranceCoverageDimID, - 1) AS o_ReinsuranceCoverageDimID,
...
EXP_Evaluate_Fields AS (
	...
	IFF(InsuranceSegmentCode = '3', 0, i_PremiumMasterAgencyCommissionRate) AS PremiumMasterAgencyCommissionRate,
	...
	DECODE(
	    TRUE,
	    RTRIM(i_PremiumMasterPremiumType) IN ('C','D') AND ReasonAmendedCode IN ('CWO','COL','CWB'), 0,
	    rtrim(i_PremiumMasterPremiumType) = 'D' and ReasonAmendedCode != 'CWO' and ReasonAmendedCode != 'CWB', PremiumMasterPremium,
	    0
	...
	DECODE(
	    TRUE,
	    RTRIM(i_PremiumMasterPremiumType) IN ('C','D') AND ReasonAmendedCode IN ('CWO','COL','CWB'), 0,
	    rtrim(i_PremiumMasterPremiumType) = 'C' and ReasonAmendedCode != 'CWO' and ReasonAmendedCode != 'CWB', PremiumMasterPremium,
	    0
	...
	IFF(
	    ReasonAmendedCode != 'CWB',
	    IFF(
	        rtrim(i_PremiumMasterPremiumType) = 'D'
	...
	DECODE(
	    ...
	    o_MajorPerilCode = '050' AND o_PremiumMasterPremiumType = 'C' AND StateProvinceCode = '12' AND StrategicProfitCenterCode = '1' AND i_PolicyEffectiveDate < v_MineSubPLDate, v_PremiumMasterCededWrittenPremium * (.20),
	    o_MajorPerilCode = '050' AND o_PremiumMasterPremiumType = 'C' AND StateProvinceCode = '12' AND StrategicProfitCenterCode <> '1' AND i_PremiumMasterBookedDate >= v_CLMineSubDate, v_PremiumMasterCededWrittenPremium * (.15),
	    o_MajorPerilCode = '050' AND o_PremiumMasterPremiumType = 'C' AND StateProvinceCode IN ('13','16'), v_PremiumMasterCededWrittenPremium * (.30),
	    v_PremiumMasterCededWrittenPremium * i_PremiumMasterAgencyCommissionRate
	...
	IFF(ReasonAmendedCode = 'CWB', 0, ROUND(v_PremiumMasterAgencyCededWrittenCommission, 2)) AS PremiumMasterAgencyCededWrittenCommission,
	...
	IFF(ReasonAmendedCode = 'CWB', 0, PremiumMasterAgencyCededWrittenCommission) AS o_PremiumMasterAgencyCededWrittenCommission,
	-- *INF*: IIF(ReasonAmendedCode='CWB',0,v_PremiumMasterAgencyDirectWrittenCommission - PremiumMasterAgencyCededWrittenCommission)
	IFF(
	    ReasonAmendedCode = 'CWB', 0,
	...
	IFF(
	    ReasonAmendedCode = 'CWB', 0,
	    IFF(
	        PremiumMasterTransactionCode IN ('14','24')
	...
	IFF(
	    ReasonAmendedCode = 'CWB', 0,
	    IFF(
	        PremiumMasterTransactionCode IN ('20','21','22','23','24','25','28','29','67'),
	        PremiumMasterPremium,
	        0
	    )
	...
	DECODE(
	    TRUE,
	    RTRIM(i_PremiumMasterPremiumType) IN ('C','D') AND ReasonAmendedCode IN ('CWO','COL'), PremiumMasterPremium,
	    PremiumMasterTransactionCode IN ('10','11','12','13','14','15','18','22','23','24','25','28') AND ReasonAmendedCode IN ('COL','CWO'), PremiumMasterPremium,
	    0
	...
	DECODE(
	    TRUE,
	    i_StandardInsuranceLineCode <> 'WC', 0,
	    SUBSTR(i_ClassCode, 1, 4) IN ('9887','9658'), v_PremiumMasterDirectWrittenPremium,
	    0
	...
	DECODE(
	    TRUE,
	    i_StandardInsuranceLineCode <> 'WC', 0,
	    SUBSTR(i_ClassCode, 1, 4) IN ('9659','9889'), v_PremiumMasterDirectWrittenPremium,
	    0
