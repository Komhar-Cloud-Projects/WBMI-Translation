...
EXP_Post_Source AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_Line_of_Business) AS o_Line_of_Business,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_Insurance_Line)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_Insurance_Line) AS o_Insurance_Line,
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_class_of_business) AS o_class_of_business,
...
EXP_Consolidate_Data_from_Lookups AS (
	...
	IFF(NOT i_ReinsuranceCoverageDimID IS NULL, i_ReinsuranceCoverageDimID, - 1) AS o_ReinsuranceCoverageDimID,
...
EXP_Evaluate_Fields AS (
	...
	DECODE(TRUE,
		IN(RTRIM(i_PremiumMasterPremiumType), 'C', 'D') AND IN(ReasonAmendedCode, 'CWO', 'COL', 'CWB'), 0,
		rtrim(i_PremiumMasterPremiumType) = 'D' AND ReasonAmendedCode != 'CWO' AND ReasonAmendedCode != 'CWB', PremiumMasterPremium,
		0) AS v_PremiumMasterDirectWrittenPremium,
	...
	DECODE(TRUE,
		...
		0) AS v_PremiumMasterCededWrittenPremium,
	...
	IFF(ReasonAmendedCode != 'CWB', IFF(rtrim(i_PremiumMasterPremiumType) = 'D' AND InsuranceSegmentCode <> '3', PremiumMasterPremium, 0) * i_PremiumMasterAgencyCommissionRate, PremiumMasterPremium) AS v_PremiumMasterAgencyDirectWrittenCommission,
	...
	DECODE(TRUE,
		...
		o_MajorPerilCode = '050' AND o_PremiumMasterPremiumType = 'C' AND StateProvinceCode = '12' AND StrategicProfitCenterCode <> '1' AND i_PremiumMasterBookedDate >= v_CLMineSubDate, v_PremiumMasterCededWrittenPremium * ( .15 ),
		o_MajorPerilCode = '050' AND o_PremiumMasterPremiumType = 'C' AND IN(StateProvinceCode, '13', '16'), v_PremiumMasterCededWrittenPremium * ( .30 ),
		v_PremiumMasterCededWrittenPremium * i_PremiumMasterAgencyCommissionRate) AS v_PremiumMasterAgencyCededWrittenCommission,
	...
	IFF(ReasonAmendedCode = 'CWB', 0, v_PremiumMasterAgencyDirectWrittenCommission - PremiumMasterAgencyCededWrittenCommission) AS o_PremiumMasterAgencyNetWrittenCommission,
	...
	IFF(ReasonAmendedCode = 'CWB', 0, IFF(IN(PremiumMasterTransactionCode, '14', '24') AND i_PremiumMasterPremiumType = 'D' AND IN(StrategicProfitCenterCode, '2', '3', '5') AND IN(InsuranceSegmentCode, '2', '3'), PremiumMasterPremium, 0)) AS o_PremiumMasterAuditPremium,
	-- *INF*: IIF(ReasonAmendedCode='CWB',0,IIF(IN(PremiumMasterTransactionCode,'20','21','22','23','24','25','28','29','67'),PremiumMasterPremium,0))
	IFF(ReasonAmendedCode = 'CWB', 0, IFF(IN(PremiumMasterTransactionCode, '20', '21', '22', '23', '24', '25', '28', '29', '67'), PremiumMasterPremium, 0)) AS o_PremiumMasterReturnedPremium,
	...
	DECODE(TRUE,
		IN(RTRIM(i_PremiumMasterPremiumType), 'C', 'D') AND IN(ReasonAmendedCode, 'CWO', 'COL'), PremiumMasterPremium,
		IN(PremiumMasterTransactionCode, '10', '11', '12', '13', '14', '15', '18', '22', '23', '24', '25', '28') AND IN(ReasonAmendedCode, 'COL', 'CWO'), PremiumMasterPremium,
