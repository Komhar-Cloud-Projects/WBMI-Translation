...
EXP_CalculateData AS (
	...
	TO_DATE(substr(i_Effective_Date, 1, 19), 'YYYY-MM-DD HH24:MI:SS') AS o_EffectiveDate,
	-- *INF*: TO_DATE(substr(i_Expiration_Date,1,19),'YYYY-MM-DD HH24:MI:SS')
	-- --TO_DATE('1800-01-01 00:00:00','YYYY-MM-DD HH24:MI:SS')
	TO_DATE(substr(i_Expiration_Date, 1, 19), 'YYYY-MM-DD HH24:MI:SS') AS o_ExpirationDate,
