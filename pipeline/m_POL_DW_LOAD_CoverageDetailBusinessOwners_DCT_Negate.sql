...
EXP_Metadata AS (
	...
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_BuildingBCCCode) AS o_BuildingBCCCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_BuildingClassCodeDescription)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(i_BuildingClassCodeDescription) AS o_BuildingClassCodeDescription
