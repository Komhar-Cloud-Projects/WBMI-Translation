...
EXP_CalculateValue AS (
	...
	IFF(IN(v_StandardInsuranceLineCode, 'CR') OR v_flag = 1, 'N/A', :UDF.DEFAULT_VALUE_FOR_STRINGS(i_RiskUnitGroup)) AS v_Risk_Unit_Group,
	...
	IFF(v_flag = 1 OR ( v_StandardInsuranceLineCode = 'GL' AND ( v_MajorPerilCode <> '540' OR NOT IN(v_ClassCode, '11111', '22222', '22250', '92100', '17000', '17001', '17002', '80051', '80052', '80053', '80054', '80055', '80056', '80057', '80058') ) ) OR IN(v_StandardInsuranceLineCode, 'WC', 'IM', 'CG', 'CA') = 1, 'N/A', :UDF.DEFAULT_VALUE_FOR_STRINGS(i_RiskUnit)) AS v_RiskUnit,
	...
	IFF(v_PremiumTransactionBookedDateID IS NULL, v_default_clndr_id, v_PremiumTransactionBookedDateID) AS o_RunDateID,
	-- *INF*: IIF(REG_MATCH(v_Zero_Risk_Unit_Group,'[^0-9a-zA-Z]'),'N/A',v_Zero_Risk_Unit_Group)
	IFF(REG_MATCH(v_Zero_Risk_Unit_Group, '[^0-9a-zA-Z]'), 'N/A', v_Zero_Risk_Unit_Group) AS o_RiskUnitGroup,
	...
	IFF(NOT v_ProductCode IS NULL, v_ProductCode, '000') AS o_ProductCode,
	-- *INF*: IIF(NOT ISNULL(v_PolicyOfferingCode), v_PolicyOfferingCode, '000')
	IFF(NOT v_PolicyOfferingCode IS NULL, v_PolicyOfferingCode, '000') AS o_PolicyOfferingCode,
	-- *INF*: IIF(NOT ISNULL(v_InsuranceReferenceLineOfBusinessCode), v_InsuranceReferenceLineOfBusinessCode, '000')
	IFF(NOT v_InsuranceReferenceLineOfBusinessCode IS NULL, v_InsuranceReferenceLineOfBusinessCode, '000') AS o_InsuranceReferenceLineOfBusinessCode,
	-- *INF*: IIF(NOT ISNULL(v_EnterpriseGroupCode), v_EnterpriseGroupCode, '1')
	IFF(NOT v_EnterpriseGroupCode IS NULL, v_EnterpriseGroupCode, '1') AS o_EnterpriseGroupCode,
	-- *INF*: IIF(NOT ISNULL(v_InsuranceReferenceLegalEntityCode), v_InsuranceReferenceLegalEntityCode, '1')
	IFF(NOT v_InsuranceReferenceLegalEntityCode IS NULL, v_InsuranceReferenceLegalEntityCode, '1') AS o_InsuranceReferenceLegalEntityCode,
	-- *INF*: IIF(NOT ISNULL(v_StrategicProfitCenterCode), v_StrategicProfitCenterCode, '6')
	IFF(NOT v_StrategicProfitCenterCode IS NULL, v_StrategicProfitCenterCode, '6') AS o_StrategicProfitCenterCode,
	-- *INF*: IIF(NOT ISNULL(v_InsuranceSegmentCode), v_InsuranceSegmentCode, 'N/A')
	IFF(NOT v_InsuranceSegmentCode IS NULL, v_InsuranceSegmentCode, 'N/A') AS o_InsuranceSegmentCode,
...
EXP_Calculate AS (
	...
	DECODE(i_SourceSystemID,
		...
		'DCT', LKP_INSURANCEREFERENCECOVERAGEDIM_DCT_i_RiskType_i_CoverageType_i_StandardInsuranceLineCode_i_PerilGroup_i_SubCoverageTypeCode_i_CoverageVersion.InsuranceReferenceCoverageDimId) AS v_InsuranceReferenceCoverageDimId,
...
EXP_DetectChange AS (
	...
	-- )
	DECODE(TRUE,
		i_pol_ak_id = v_Prev_Pol_AK_ID AND i_CoverageGUID = v_Prev_CoverageGUID AND i_CoverageLimitType = v_Prev_CoverageLimitType, TO_DECIMAL(i_CoverageLimitValue) - v_Prev_CoverageLimitValue,
		TO_DECIMAL(i_CoverageLimitValue)) AS v_CoverageLimitValue,
...
EXP_DefaultValue AS (
	...
	ON LKP_CALENDER_DIM_TRUNC_PremiumTransactionBookedDate_D.clndr_date = TRUNC(PremiumTransactionBookedDate, 'D')
...
EXP_DetectMainCoverage AS (
	...
	DECODE(SourceSystemID = 'PMS',
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '500' AND ProductCode = '300' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'O' AND RiskUnit = 'N/A', 100,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '500' AND ProductCode = '300' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '540' AND ProductTypeCode = 'O' AND RiskUnit = 'N/A', 99,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '500' AND ProductCode = '300' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'P' AND RiskUnit = 'N/A', 98,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '370' AND ProductCode = '370' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '355' AND MajorPerilCode = '530' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 97,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '365' AND ProductCode = '365' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '345' AND MajorPerilCode = '530' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 96,
		...
		PolicySymbol = 'CD' AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '310' AND ProductCode = '310' AND InsuranceReferenceLineOfBusinessCode = '310' AND RiskUnitGroup = '367' AND MajorPerilCode = '540' AND ProductTypeCode = 'N/A' AND in(RiskUnit, '80054', '80055', '80056', '80058'), 93,
		PolicySymbol = 'CD' AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '310' AND ProductCode = '310' AND InsuranceReferenceLineOfBusinessCode = '310' AND RiskUnitGroup = '367' AND MajorPerilCode = '540' AND ProductTypeCode = 'N/A' AND in(RiskUnit, '80051', '80052', '80053', '80057'), 92,
		IN(PolicySymbol, 'CU', 'NU') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '900' AND ProductCode = '900' AND InsuranceReferenceLineOfBusinessCode = '900' AND RiskUnitGroup = '370' AND MajorPerilCode = '517' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 91,
		...
		IN(PolicySymbol, 'NE', 'ER') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '330' AND ProductCode = '330' AND InsuranceReferenceLineOfBusinessCode = '330' AND RiskUnitGroup = '366' AND MajorPerilCode = '540' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 89,
		PolicyOfferingCode = '100' AND StandardInsuranceLineCode = 'WC' AND ( IN(PolicySymbol, 'VA', 'VB', 'VC', 'VD', 'VE', 'VF', 'VG', 'VH', 'VI', 'VJ', 'VK', 'VL', 'VM', 'VN', 'VO', 'VP', 'VQ', 'VR', 'VS', 'VT', 'VU', 'VV', 'VW', 'WA', 'WB', 'WC', 'WD', 'WG', 'WH', 'WI', 'WK', 'WJ', 'WN', 'WO', 'WP', 'WR', 'WS', 'WT', 'WU', 'WV', 'WW', 'WY', 'YA', 'YB', 'YC', 'YD', 'YE', 'YF', 'YG', 'YH', 'YI', 'YJ', 'YK', 'YL', 'YM', 'YN', 'YO', 'YP', 'YQ', 'YR', 'YS', 'YT', 'YU', 'YV', 'YW', 'YX', 'ZZ') OR IN(PolicySymbol, 'A0', 'A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'LA', 'LB', 'LC', 'LE', 'LF', 'LG', 'LH', 'LI', 'LJ', 'LK', 'LL', 'LM', 'LN', 'AB', 'AC', 'AD', 'AE', 'AF', 'AG', 'AH', 'AI', 'AJ', 'AK', 'AL', 'AM', 'AN', 'AO', 'AP', 'AQ', 'AR', 'AT', 'AU', 'AV', 'AW', 'AX', 'AY', 'AZ', 'JA', 'JB', 'JC', 'JD', 'JE', 'JF', 'JG', 'JH', 'JI', 'JJ', 'JK', 'JL', 'JM', 'JN', 'JO', 'JP', 'JQ', 'JR', 'JS', 'JT', 'JU', 'JV', 'JW', 'JX', 'JY', 'JZ', 'J1', 'J2', 'J3', 'J4', 'J5', 'J6') OR IN(PolicySymbol, 'RA', 'RB', 'RC', 'RD', 'RE', 'RF', 'RG', 'RH', 'RI', 'RJ', 'RK', 'RL', 'RM', 'RN', 'RO', 'RP', 'RQ', 'RR', 'RS', 'RT', 'RU', 'RV', 'RW', 'RX', 'RW', 'RX', 'SA', 'SB', 'SC', 'SD', 'SE', 'SF', 'SG', 'SH', 'SI', 'SJ', 'SK', 'SL', 'SM', 'SN', 'SO', 'SP', 'SR', 'SS', 'ST', 'SU', 'SV', 'SW', 'SX', 'SY', 'TH', 'TI', 'TJ', 'TK', 'TL', 'TM', 'TN', 'TO', 'TP', 'TQ', 'TR', 'TS', 'TT', 'TV', 'TW') ) AND ProductCode = '100' AND InsuranceReferenceLineOfBusinessCode = '100' AND RiskUnitGroup = '010' AND MajorPerilCode = '032' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 88,
		IN(PolicySymbol, 'NA', 'NB') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '430' AND ProductCode = '430' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'O' AND RiskUnit = 'N/A', 87,
		IN(PolicySymbol, 'BC', 'BD') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '410' AND ProductCode = '410' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'O' AND RiskUnit = 'N/A', 86,
		...
		IN(PolicySymbol, 'WE', 'WF', 'WL', 'WZ') AND StandardInsuranceLineCode = 'WC' AND PolicyOfferingCode = '100' AND ProductCode = '100' AND InsuranceReferenceLineOfBusinessCode = '100' AND RiskUnitGroup = 'N/A' AND MajorPerilCode = '032' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 81,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '320' AND ProductCode = '320' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'P' AND RiskUnit = 'N/A', 80,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '500' AND ProductCode = '320' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '340' AND MajorPerilCode = '530' AND ProductTypeCode = 'P' AND RiskUnit = 'N/A', 79,
		IN(PolicySymbol, 'NN') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '312' AND ProductCode = '312' AND InsuranceReferenceLineOfBusinessCode = '312' AND RiskUnitGroup = '287' AND MajorPerilCode = '540' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 78,
		IN(PolicySymbol, 'CP', 'NS') AND StandardInsuranceLineCode = 'GL' AND PolicyOfferingCode = '500' AND ProductCode = '370' AND InsuranceReferenceLineOfBusinessCode = '300' AND RiskUnitGroup = '355' AND MajorPerilCode = '530' AND ProductTypeCode = 'N/A' AND RiskUnit = 'N/A', 77,
		0) AS v_DetectFlag_PMS,
...
EXP_Calculate_DimID AS (
	...
	DECODE(i_SourceSystemID,
		...
		'DCT', LKP_INSURANCEREFERENCECOVERAGEDIM_DCT_i_RiskType_i_CoverageType_StandardInsuranceLineCode_i_PerilGroup_i_SubCoverageTypeCode_i_CoverageVersion.InsuranceReferenceCoverageDimId) AS v_InsuranceReferenceCoverageDimId,
	-- *INF*: IIF(ISNULL(lkp_contract_cust_dim_id),-1,lkp_contract_cust_dim_id)
	IFF(lkp_contract_cust_dim_id IS NULL, - 1, lkp_contract_cust_dim_id) AS o_contract_cust_dim_id,
	-- *INF*: IIF(ISNULL(lkp_pol_dim_id),-1,lkp_pol_dim_id)
	IFF(lkp_pol_dim_id IS NULL, - 1, lkp_pol_dim_id) AS o_pol_dim_id,
...
EXP_DetectChange_Policy AS (
	...
	-- ---TO_DECIMAL(i_LimitValue))
	DECODE(TRUE,
		PolicyAKId = v_Prev_PolicyAKId AND i_LimitTypeDimID = v_Prev_LimitTypeDimId AND StandardInsuranceLineCode = v_Prev_StandardInsuranceLineCode, TO_DECIMAL(i_LimitValue) - v_Prev_LimitValue,
		TO_DECIMAL(i_LimitValue)) AS v_LimitValue,
	-- *INF*: DECODE(TRUE,
	...
	-- --v_LimitValue
	-- --)
	TO_DECIMAL(i_LimitValue) AS v_Prev_LimitValue,
