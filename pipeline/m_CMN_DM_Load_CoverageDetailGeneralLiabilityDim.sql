...
EXP_GetMetaData AS (
	...
	IFF(i_RetroactiveDate IS NULL, TO_DATE('2100-12-31', 'YYYY-MM-DD'), i_RetroactiveDate) AS v_RetroactiveDate,
	...
	IFF(i_ISOGeneralLiabilityClassGroupDescription IS NULL, 'N/A', i_ISOGeneralLiabilityClassGroupDescription) AS v_ISOGeneralLiabilityClassGroupDescription,
	-- *INF*: DECODE(TRUE,
