...
EXP_MetaData AS (
	...
	IFF(LTRIM(RTRIM(ClassEffectiveDate)) IS NULL OR IS_SPACES(LTRIM(RTRIM(ClassEffectiveDate))) OR LENGTH(LTRIM(RTRIM(ClassEffectiveDate))) = 0 OR LTRIM(RTRIM(SUBSTR(ClassEffectiveDate, 1, 10))) = '1900-01-01', TO_DATE('1800-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE(SUBSTR(ClassEffectiveDate, 1, 19), 'YYYY-MM-DD HH24:MI:SS')) AS o_ClassEffectiveDate,
	...
	-- 
	IFF(LTRIM(RTRIM(ClassExpirationDate)) IS NULL OR IS_SPACES(LTRIM(RTRIM(ClassExpirationDate))) OR LENGTH(LTRIM(RTRIM(ClassExpirationDate))) = 0 OR LTRIM(RTRIM(SUBSTR(ClassExpirationDate, 1, 10))) = '2999-01-01', TO_DATE('2100-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE(SUBSTR(ClassExpirationDate, 1, 19), 'YYYY-MM-DD HH24:MI:SS')) AS o_ClassExpirationDate,
