...
SQ_PassThroughChargeTransaction AS (
	...
	WHERE  PTCT.SourceSystemID='DCT'  AND spc.StrategicProfitCenterAbbreviation <> 'WB - PL' 
	...
	--added check for SPC to exclude PL policies in driver table from being negated
),
EXP_Default AS (
	SELECT
