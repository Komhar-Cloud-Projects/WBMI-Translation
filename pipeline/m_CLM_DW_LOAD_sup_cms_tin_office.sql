...
EXP_Default_Values AS (
	...
	-- 
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_tin_num) AS office_tin_num1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_cd)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_cd) AS office_cd1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_name)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_name) AS office_name1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_addr1)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_addr1) AS office_mail_addr11,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_addr2)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_addr2) AS office_mail_addr21,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_city)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_city) AS office_mail_city1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_state)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_state) AS office_mail_state1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_zip)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_zip) AS office_mail_zip1,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_zip4)
	:UDF.DEFAULT_VALUE_FOR_STRINGS(office_mail_zip4) AS office_mail_zip41
...
EXP_detect_changes AS (
	...
	-- , 'UPDATE', 'NOCHANGE'))
	-- 
	IFF(sup_cms_tin_office_id IS NULL, 'NEW', IFF(( office_tin_num != office_tin_num1 OR office_cd != office_cd1 OR office_name != office_name1 OR office_mail_address1 != office_mail_addr11 OR office_mail_address2 != office_mail_addr21 OR office_mail_city != office_mail_city1 OR office_mail_state != office_mail_state1 OR office_mail_zip != office_mail_zip1 OR office_mail_zip4 != office_mail_zip41 ), 'UPDATE', 'NOCHANGE')) AS v_CHANGED_FLAG,
