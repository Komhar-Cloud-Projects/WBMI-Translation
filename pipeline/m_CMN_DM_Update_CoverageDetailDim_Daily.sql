...
EXP_Value AS (
	...
	IFF(
	    i_StatisticalCoverageCancellationDate IS NULL,
	...
	IFF(
	    i_PremiumTransactionEffectiveDate IS NULL,
	    TO_TIMESTAMP('1800-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
	...
	--   )
	IFF(
	    (v_PremiumTransactionEffectiveDate <= v_RunDate
	    and i_PremiumTransactionExpirationDate > v_RunDate
	    and TO_CHAR(v_RunDate, 'YYYY-MM_DD') = TO_CHAR(CURRENT_TIMESTAMP, 'YYYY-MM-DD'))
	    or (v_PremiumTransactionEffectiveDate <= v_RunDate
	    and DATE_PART(i_PremiumTransactionExpirationDate, 'YYYY') > DATE_PART(v_RunDate, 'YYYY'))
	    or (v_PremiumTransactionEffectiveDate <= v_RunDate
	    and DATE_PART(i_PremiumTransactionExpirationDate, 'YYYY') = DATE_PART(v_RunDate, 'YYYY')
	    and DATE_PART(i_PremiumTransactionExpirationDate, 'MM') >= DATE_PART(v_RunDate, 'MM')),
	...
	IFF(
	    i_RunDate IS NULL, TO_TIMESTAMP('1800-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), i_RunDate
	) AS v_RunDate,
	...
	IFF(
	    v_CoverageEffectiveDate > v_PremiumTransactionEffectiveDate, v_CoverageEffectiveDate,
	...
	IFF(
	    i_PremiumTransactionExpirationDate IS NULL,
	    TO_TIMESTAMP('2100-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'),
