...
EXP_Detect_Insert_Update AS (
	...
	-- 
	-- 
	IFF(v_Claim = 'NEW', 'TRUNCATE', DECODE(NewLookupRow,
		1, 'INSERT',
		2, 'UPDATE',
		0, 'NOCHANGE')) AS v_Out_SQL,
...
EXP_Insert_Noninserts AS (
	...
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'D' AND v_claim_D_Old = 'NEW' OR v_claim_D_Old = 'OLD', 'OLD', 'NEW'), IFF(financial_type_code = 'D', 'NEW', 'NA')) AS v_claim_D,
	...
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'E' AND v_claim_E_Old = 'NEW' OR v_claim_E_Old = 'OLD', 'OLD', 'NEW'), IFF(financial_type_code = 'E', 'NEW', 'NA')) AS v_claim_E,
	...
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'S' AND v_claim_S_Old = 'NEW' OR v_claim_S_Old = 'OLD', 'OLD', 'NEW'), IFF(financial_type_code = 'S', 'NEW', 'NA')) AS v_claim_S,
	...
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'B' AND v_claim_B_Old = 'NEW' OR v_claim_B_Old = 'OLD', 'OLD', 'NEW'), IFF(financial_type_code = 'B', 'NEW', 'NA')) AS v_claim_B,
	...
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'R' AND v_claim_R_Old = 'NEW' OR v_claim_R_Old = 'OLD', 'OLD', 'NEW'), IFF(financial_type_code = 'R', 'NEW', 'NA')) AS v_claim_R,
	...
	IFF(v_claim_D = 'NEW', IFF(financial_type_code = 'D', reserve_date_type, 'NA'), IFF(financial_type_code = 'D', reserve_date_type, v_claim_fin_type_D_old)) AS v_claim_fin_type_D,
	...
	IFF(v_claim_E = 'NEW', IFF(financial_type_code = 'E', reserve_date_type, 'NA'), IFF(financial_type_code = 'E', reserve_date_type, v_claim_fin_type_E_old)) AS v_claim_fin_type_E,
	...
	IFF(v_claim_S = 'NEW', IFF(financial_type_code = 'S', reserve_date_type, 'NA'), IFF(financial_type_code = 'S', reserve_date_type, v_claim_fin_type_S_old)) AS v_claim_fin_type_S,
	...
	IFF(v_claim_B = 'NEW', IFF(financial_type_code = 'B', reserve_date_type, 'NA'), IFF(financial_type_code = 'B', reserve_date_type, v_claim_fin_type_B_old)) AS v_claim_fin_type_B,
	...
	IFF(v_claim_R = 'NEW', IFF(financial_type_code = 'R', reserve_date_type, 'NA'), IFF(financial_type_code = 'R', reserve_date_type, v_claim_fin_type_R_old)) AS v_claim_fin_type_R,
	...
	IFF(financial_type_code = 'D', IFF(count_claimants = count_notice_only, '1NOTICEONLY', IFF(count_open_reopen >= 1, '2OPEN', '3CLOSED')), IFF(v_claim_D = 'OLD' OR v_claim_D = 'NEW', v_claim_overall_status_old_D)) AS v_claim_overall_status_crrnt_D,
	...
	IFF(financial_type_code = 'E', IFF(count_claimants = count_notice_only, '1NOTICEONLY', IFF(count_open_reopen >= 1, '2OPEN', '3CLOSED')), IFF(v_claim_E = 'OLD' OR v_claim_E = 'NEW', v_claim_overall_status_old_E)) AS v_claim_overall_status_crrnt_E,
	...
	IFF(financial_type_code = 'S', IFF(count_claimants = count_notice_only, '1NOTICEONLY', IFF(count_open_reopen >= 1, '2OPEN', '3CLOSED')), IFF(v_claim_S = 'OLD' OR v_claim_S = 'NEW', v_claim_overall_status_old_S)) AS v_claim_overall_status_crrnt_S,
	...
	IFF(financial_type_code = 'B', IFF(count_claimants = count_notice_only, '1NOTICEONLY', IFF(count_open_reopen >= 1, '2OPEN', '3CLOSED')), IFF(v_claim_B = 'OLD' OR v_claim_B = 'NEW', v_claim_overall_status_old_B)) AS v_claim_overall_status_crrnt_B,
	...
	IFF(financial_type_code = 'R', IFF(count_claimants = count_notice_only, '1NOTICEONLY', IFF(count_open_reopen >= 1, '2OPEN', '3CLOSED')), IFF(v_claim_R = 'OLD' OR v_claim_R = 'NEW', v_claim_overall_status_old_R)) AS v_claim_overall_status_crrnt_R,
	...
	-- ))))),'INSERT')
	IFF(claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id, IFF(financial_type_code = 'D', IFF(v_claim_D = 'NEW', 'INSERT', IFF(v_claim_overall_status_crrnt_D = v_claim_overall_status_old_D, 'NOCHANGE', 'INSERT')), IFF(financial_type_code = 'E', IFF(v_claim_E = 'NEW', 'INSERT', IFF(v_claim_overall_status_crrnt_E = v_claim_overall_status_old_E, 'NOCHANGE', 'INSERT')), IFF(financial_type_code = 'S', IFF(v_claim_S = 'NEW', 'INSERT', IFF(v_claim_overall_status_crrnt_S = v_claim_overall_status_old_S, 'NOCHANGE', 'INSERT')), IFF(financial_type_code = 'B', IFF(v_claim_B = 'NEW', 'INSERT', IFF(v_claim_overall_status_crrnt_B = v_claim_overall_status_old_B, 'NOCHANGE', 'INSERT')), IFF(financial_type_code = 'R', IFF(v_claim_R = 'NEW', 'INSERT', IFF(v_claim_overall_status_crrnt_R = v_claim_overall_status_old_R, 'NOCHANGE', 'INSERT'))))))), 'INSERT') AS v_insert_flag,
	...
	-- 
	IFF(financial_type_code = 'D', IFF(v_insert_flag = 'INSERT', DECODE(v_claim_overall_status_crrnt_D,
		'1NOTICEONLY', '1NOTICEONLY',
		'2OPEN', IFF(v_claim_overall_status_old_D = '3CLOSED', IFF(v_claim_D = 'OLD', '4REOPEN', '2OPEN'), '2OPEN'),
		'3CLOSED', IFF(v_claim_reserve_date_type_out_old_D = '4REOPEN', '5CLOSEDAFTERREOPEN', '3CLOSED')), v_claim_reserve_date_type_out_old_D), v_claim_reserve_date_type_out_old_D) AS v_claim_reserve_date_type_out_crrnt_D,
	...
	IFF(financial_type_code = 'E', IFF(v_insert_flag = 'INSERT', DECODE(v_claim_overall_status_crrnt_E,
		'1NOTICEONLY', '1NOTICEONLY',
		'2OPEN', IFF(v_claim_overall_status_old_E = '3CLOSED', IFF(v_claim_E = 'OLD', '4REOPEN', '2OPEN'), '2OPEN'),
		'3CLOSED', IFF(v_claim_reserve_date_type_out_old_E = '4REOPEN', '5CLOSEDAFTERREOPEN', '3CLOSED')), v_claim_reserve_date_type_out_old_E), v_claim_reserve_date_type_out_old_E) AS v_claim_reserve_date_type_out_crrnt_E,
	...
	IFF(financial_type_code = 'S', IFF(v_insert_flag = 'INSERT', DECODE(v_claim_overall_status_crrnt_S,
		'1NOTICEONLY', '1NOTICEONLY',
		'2OPEN', IFF(v_claim_overall_status_old_S = '3CLOSED', IFF(v_claim_S = 'OLD', '4REOPEN', '2OPEN'), '2OPEN'),
		'3CLOSED', IFF(v_claim_reserve_date_type_out_old_S = '4REOPEN', '5CLOSEDAFTERREOPEN', '3CLOSED')), v_claim_reserve_date_type_out_old_S), v_claim_reserve_date_type_out_old_S) AS v_claim_reserve_date_type_out_crrnt_S,
	...
	IFF(financial_type_code = 'B', IFF(v_insert_flag = 'INSERT', DECODE(v_claim_overall_status_crrnt_B,
		'1NOTICEONLY', '1NOTICEONLY',
		'2OPEN', IFF(v_claim_overall_status_old_B = '3CLOSED', IFF(v_claim_B = 'OLD', '4REOPEN', '2OPEN'), '2OPEN'),
		'3CLOSED', IFF(v_claim_reserve_date_type_out_old_B = '4REOPEN', '5CLOSEDAFTERREOPEN', '3CLOSED')), v_claim_reserve_date_type_out_old_B), v_claim_reserve_date_type_out_old_B) AS v_claim_reserve_date_type_out_crrnt_B,
	...
	IFF(financial_type_code = 'R', IFF(v_insert_flag = 'INSERT', DECODE(v_claim_overall_status_crrnt_R,
		'1NOTICEONLY', '1NOTICEONLY',
		'2OPEN', IFF(v_claim_overall_status_old_R = '3CLOSED', IFF(v_claim_R = 'OLD', '4REOPEN', '2OPEN'), '2OPEN'),
		'3CLOSED', IFF(v_claim_reserve_date_type_out_old_R = '4REOPEN', '5CLOSEDAFTERREOPEN', '3CLOSED')), v_claim_reserve_date_type_out_old_R), v_claim_reserve_date_type_out_old_R) AS v_claim_reserve_date_type_out_crrnt_R,
	...
	DECODE(financial_type_code,
		...
		'S', v_claim_reserve_date_type_out_crrnt_S,
		'B', v_claim_reserve_date_type_out_crrnt_B,
		'R', v_claim_reserve_date_type_out_crrnt_R) AS claim_reserve_date_type_out,
...
EXP_Expire_rows AS (
	...
	-- 
	DECODE(TRUE,
		claim_occurrence_ak_id = v_prev_row_claim_occurrence_ak_id AND source_sys_id = v_source_sys_id AND financial_type_code = v_prev_row_financial_type_code, ADD_TO_DATE(v_eff_from_date, 'SS', - 1),
