...
EXP_NumericValues AS (
	...
	IFF(i_EndorsementCoverageFormAKId IS NULL,
		- 1,
		i_EndorsementCoverageFormAKId
	) AS o_EndorsementCoverageFormAKId,
...
EXP_StringValues AS (
	...
	IFF(i_EndorsementCoverageForm IS NULL 
		OR LENGTH(i_EndorsementCoverageForm
		) = 0 
		OR LENGTH(i_EndorsementCoverageForm)>0 AND TRIM(i_EndorsementCoverageForm)='',
		'N/A',
