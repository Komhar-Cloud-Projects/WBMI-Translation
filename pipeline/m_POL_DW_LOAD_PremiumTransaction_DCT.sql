...
EXP_Default AS (
	...
	DECODE(TRUE,
		...
		GREATEST(i_PeriodStartDate, i_TransactionEffectiveDate)) AS v_EffectiveDate,
	-- *INF*: DECODE(TRUE,
	...
	DECODE(TRUE,
		...
		LEAST(i_PeriodEndDate, i_TransactionExpirationDate)) AS v_ExpirationDate,
	-- *INF*: IIF(
	...
	IFF(v_TransactionPurpose != 'Offset', i_TransactionCreatedDate, LKP_WORKDCTPOLICY_ENTEREDDATE_INITIAL_v_PolicyNumber_v_PolicyVersion_i_TransactionCreatedDate_i_TransactionEffectiveDate.TransactionCreatedDate) AS v_PremiumTransactionEnteredDate_Initial,
	...
	IFF(v_TransactionPurpose != 'Offset', v_BookedDate, GREATEST(TRUNC(LKP_WORKDCTPOLICY_INITIAL_v_PolicyNumber_v_PolicyVersion_i_TransactionCreatedDate_i_TransactionEffectiveDate.BookedDate, 'MM'), v_BookedDate)) AS v_PremiumTransactionBookedDate_Initial,
	...
	IFF(NOT v_PremiumTransactionBookedDate_Initial IS NULL, v_PremiumTransactionBookedDate_Initial, GREATEST(TRUNC(LKP_WORKDCTPOLICY_v_PolicyNumber_v_PolicyVersion_i_TransactionCreatedDate_i_TransactionEffectiveDate.BookedDate, 'MM'), v_BookedDate)) AS v_PremiumTransactionBookedDate,
	...
	IFF(v_EffectiveDate IS NULL, TO_DATE('21001231235959', 'YYYYMMDDHH24MISS'), v_EffectiveDate) AS o_TransactionEffectiveDate,
	-- *INF*: IIF(ISNULL(v_ExpirationDate),TO_DATE('21001231235959' , 'YYYYMMDDHH24MISS'),v_ExpirationDate) 
	IFF(v_ExpirationDate IS NULL, TO_DATE('21001231235959', 'YYYYMMDDHH24MISS'), v_ExpirationDate) AS o_TransactionExpirationDate,
	...
	IFF(i_CommissionPercentage IS NULL OR i_CommissionPercentage = - 1, v_FinalCommission, v_CommissionPercentage) AS o_AgencyActualCommissionRate,
...
EXP_Format_PremiumTransaction AS (
	...
	substr(i_PremiumTransactionKey, 1, instr(i_PremiumTransactionKey, '~', 1, 1)) AS o_Policyakid,
