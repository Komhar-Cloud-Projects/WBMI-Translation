...
EXP_values AS (
	...
	IFF(
	    substr(in_prior_pol_key, 1, 1) = '+', 'N/A',
	    IFF(
	        substr(in_prior_pol_key, 14, 1) = '+', 'N/A', in_prior_pol_key
	    )
	) AS prior_pol_key,
	pol_status_code,
	pol_issue_code,
...
EXP_sup_description AS (
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(prdcr_code) AS producer_code,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_co_num_descript) AS pol_co_num_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_prim_bus_class_code_descript) AS prim_bus_class_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_reins_code_descript) AS reins_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_co_line_code_descript) AS pol_co_line_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_cancellation_rsn_code_descript) AS pol_cancellation_rsn_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_state_of_domicile_code_abbrev) AS state_of_domicile_code_abbrev,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_state_of_domicile_code_descript) AS state_of_domicile_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_wbconnect_upload_code_descript) AS wbconnect_upload_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_serv_center_support_code_descript) AS serv_center_support_code_descript,
	EXP_values.pol_term,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_term_descript) AS pol_term_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_status_code_descript) AS pol_status_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_issue_code_descript) AS pol_issue_code_descript,
	EXP_values.pol_age,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_industry_risk_grade_code_descript) AS industry_risk_grade_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_mvr_request_code_descript) AS mvr_request_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_renl_code_descript) AS renl_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_pol_audit_frqncy_descript) AS pol_audit_frqncy_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_variation_ind_descript) AS variation_ind_descript,
	EXP_values.county,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_non_smoker_disc_code_descript) AS non_smoker_disc_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_excess_claim_code_descript) AS excess_claim_code_descript,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_target_mrkt_code_descript) AS target_mrkt_code_descript,
	EXP_values.pkg_code,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_mrktng_pkg_description) AS mrktng_pkg_description,
	...
	Decode(
	    TRUE,
	    substr(pol_sym, 1, 1) = 'N', 'N',
	    substr(pol_sym, 1, 1) IN ('R','S','T') and pms_pol_lob_code = 'WCP', 'N',
	    substr(pol_sym, 1, 1) IN ('A','J','L'), 'A',
	    'W'
	) AS reporting_dvsn_code,
	EXP_values.ClassOfBusiness,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(ClassOfBusiness)
	UDF_DEFAULT_VALUE_FOR_STRINGS(ClassOfBusiness) AS class_of_business,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(v_ClassOfBusinessCodeDescription) AS ClassOfBusinessCodeDescription,
	'N/A' AS policy_type,
	'N/A' AS prog_code,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardInsuranceSegmentCode) AS o_StandardInsuranceSegmentCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardInsuranceSegmentDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardInsuranceSegmentDescription) AS o_StandardInsuranceSegmentDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardBusinessClassCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardBusinessClassCode) AS o_StandardBusinessClassCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardBusinessClassCodeDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardBusinessClassCodeDescription) AS o_StandardBusinessClassCodeDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyTerm)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyTerm) AS o_StandardPolicyTerm,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyTermDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyTermDescription) AS o_StandardPolicyTermDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyStatusCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyStatusCode) AS o_StandardPolicyStatusCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyStatusCodeDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyStatusCodeDescription) AS o_StandardPolicyStatusCodeDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyIssueCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyIssueCode) AS o_StandardPolicyIssueCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyIssueCodeDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyIssueCodeDescription) AS o_StandardPolicyIssueCodeDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardIndustryRiskGradeCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardIndustryRiskGradeCode) AS o_StandardIndustryRiskGradeCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardIndustryRiskGradeCodeDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardIndustryRiskGradeCodeDescription) AS o_StandardIndustryRiskGradeCodeDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyAuditFrequency)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyAuditFrequency) AS o_StandardPolicyAuditFrequency,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardPolicyAuditFrequencyDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardPolicyAuditFrequencyDescription) AS o_StandardPolicyAuditFrequencyDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardStateAbbreviation)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardStateAbbreviation) AS o_StandardStateAbbreviation,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardStateDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardStateDescription) AS o_StandardStateDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardSurchargeExemptCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardSurchargeExemptCode) AS o_StandardSurchargeExemptCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(StandardSurchargeExemptDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(StandardSurchargeExemptDescription) AS o_StandardSurchargeExemptDescription,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_ProgramCode)
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_ProgramCode) AS o_ProgramCode,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_ProgramDescription)
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_ProgramDescription) AS o_ProgramDescription,
	...
	UDF_DEFAULT_VALUE_FOR_INTEGERS(i_BusinessClassDimId) AS o_BusinessClassDimId,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_IssuedUWID) AS o_IssuedUWID,
	EXP_values.IssuedUnderwriter AS i_IssuedUnderwriter,
	-- *INF*: :UDF.DEFAULT_VALUE_FOR_STRINGS(i_IssuedUnderwriter)
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_IssuedUnderwriter) AS o_IssuedUnderwriter,
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_company_number_UDF_LTRIM_RTRIM_pol_co_num.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_company_number_UDF_LTRIM_RTRIM_pol_co_num.code = UDF_LTRIM_RTRIM(pol_co_num)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_DCT_sup_business_classification_code_UDF_LTRIM_RTRIM_prim_bus_class_code.source_sys_id = UDF_LTRIM_RTRIM('DCT')
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_DCT_sup_business_classification_code_UDF_LTRIM_RTRIM_prim_bus_class_code.code = UDF_LTRIM_RTRIM(prim_bus_class_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_reinsurance_code_UDF_LTRIM_RTRIM_reins_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_reinsurance_code_UDF_LTRIM_RTRIM_reins_code.code = UDF_LTRIM_RTRIM(reins_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_company_line_code_UDF_LTRIM_RTRIM_pol_co_line_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_company_line_code_UDF_LTRIM_RTRIM_pol_co_line_code.code = UDF_LTRIM_RTRIM(pol_co_line_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_reason_amended_code_UDF_LTRIM_RTRIM_pol_cancellation_rsn_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_reason_amended_code_UDF_LTRIM_RTRIM_pol_cancellation_rsn_code.code = UDF_LTRIM_RTRIM(pol_cancellation_rsn_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_state_abbrev_UDF_LTRIM_RTRIM_state_of_domicile_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_state_abbrev_UDF_LTRIM_RTRIM_state_of_domicile_code.code = UDF_LTRIM_RTRIM(state_of_domicile_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_EXCEED_sup_state_UDF_LTRIM_RTRIM_state_of_domicile_code.source_sys_id = UDF_LTRIM_RTRIM('EXCEED')
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_EXCEED_sup_state_UDF_LTRIM_RTRIM_state_of_domicile_code.tablename = 'sup_state'
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_EXCEED_sup_state_UDF_LTRIM_RTRIM_state_of_domicile_code.code = UDF_LTRIM_RTRIM(state_of_domicile_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_wbconnect_upload_code_UDF_LTRIM_RTRIM_wbconnect_upload_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_wbconnect_upload_code_UDF_LTRIM_RTRIM_wbconnect_upload_code.code = UDF_LTRIM_RTRIM(wbconnect_upload_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_service_center_support_code_UDF_LTRIM_RTRIM_serv_center_support_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_service_center_support_code_UDF_LTRIM_RTRIM_serv_center_support_code.code = UDF_LTRIM_RTRIM(serv_center_support_code)

	LEFT JOIN LKP_ALL_SUPPORT_TABLES LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_term_UDF_LTRIM_RTRIM_pol_term
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_term_UDF_LTRIM_RTRIM_pol_term.source_sys_id = UDF_LTRIM_RTRIM('PMS')
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_term_UDF_LTRIM_RTRIM_pol_term.tablename = 'sup_policy_term'
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_term_UDF_LTRIM_RTRIM_pol_term.code = UDF_LTRIM_RTRIM(pol_term)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_status_code_UDF_LTRIM_RTRIM_pol_status_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_status_code_UDF_LTRIM_RTRIM_pol_status_code.code = UDF_LTRIM_RTRIM(pol_status_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_issue_code_UDF_LTRIM_RTRIM_pol_issue_code.source_sys_id = UDF_LTRIM_RTRIM('PMS')
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_issue_code_UDF_LTRIM_RTRIM_pol_issue_code.code = UDF_LTRIM_RTRIM(pol_issue_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_industry_risk_grade_code_UDF_LTRIM_RTRIM_industry_risk_grade_code.source_sys_id = UDF_LTRIM_RTRIM('PMS')
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_industry_risk_grade_code_UDF_LTRIM_RTRIM_industry_risk_grade_code.code = UDF_LTRIM_RTRIM(industry_risk_grade_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_mvr_request_code_UDF_LTRIM_RTRIM_mvr_request_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_mvr_request_code_UDF_LTRIM_RTRIM_mvr_request_code.code = UDF_LTRIM_RTRIM(mvr_request_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_renewal_code_UDF_LTRIM_RTRIM_renl_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_renewal_code_UDF_LTRIM_RTRIM_renl_code.code = UDF_LTRIM_RTRIM(renl_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_audit_frequency_UDF_LTRIM_RTRIM_pol_audit_frqncy.source_sys_id = UDF_LTRIM_RTRIM('PMS')
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_PMS_sup_policy_audit_frequency_UDF_LTRIM_RTRIM_pol_audit_frqncy.code = UDF_LTRIM_RTRIM(pol_audit_frqncy)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_variation_code_UDF_LTRIM_RTRIM_variation_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_policy_variation_code_UDF_LTRIM_RTRIM_variation_code.code = UDF_LTRIM_RTRIM(variation_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_non_smoker_discount_code_UDF_LTRIM_RTRIM_non_smoker_disc_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_non_smoker_discount_code_UDF_LTRIM_RTRIM_non_smoker_disc_code.code = UDF_LTRIM_RTRIM(non_smoker_disc_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_excess_claim_code_UDF_LTRIM_RTRIM_excess_claim_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_excess_claim_code_UDF_LTRIM_RTRIM_excess_claim_code.code = UDF_LTRIM_RTRIM(excess_claim_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_target_market_code_UDF_LTRIM_RTRIM_target_mrkt_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_target_market_code_UDF_LTRIM_RTRIM_target_mrkt_code.code = UDF_LTRIM_RTRIM(target_mrkt_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_marketing_package_code_UDF_LTRIM_RTRIM_pkg_code.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_marketing_package_code_UDF_LTRIM_RTRIM_pkg_code.code = UDF_LTRIM_RTRIM(pkg_code)
	...
	ON LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_association_program_code_UDF_LTRIM_RTRIM_ClassOfBusiness.source_sys_id = UDF_LTRIM_RTRIM(i_source_sys_id)
	...
	AND LKP_ALL_SUPPORT_TABLES__UDF_LTRIM_RTRIM_i_source_sys_id_sup_association_program_code_UDF_LTRIM_RTRIM_ClassOfBusiness.code = UDF_LTRIM_RTRIM(ClassOfBusiness)
...
Exp_CollectdifferentExpPolicyKey AS (
	...
	IFF(
	    lkp_GetPriorPolicyKey_V2_Policy_Step4 IS NULL
	    or lkp_GetPriorPolicyKey_V2_Policy_Step4 = ''
	    or LENGTH(lkp_GetPriorPolicyKey_V2_Policy_Step4)>0
	    and TRIM(lkp_GetPriorPolicyKey_V2_Policy_Step4)='',
	    'N/A',
	...
	DECODE(
	    True,
	    (lkp_GetExpiringPriorPolicyKey_Step1 IS NULL AND lkp_GetExpiringPriorPolicyKey_Step1 != 'N/A' AND lkp_GetExpiringPriorPolicyKey_Step1 <> '' and NOT LENGTH(lkp_GetExpiringPriorPolicyKey_Step1)>0 AND TRIM(lkp_GetExpiringPriorPolicyKey_Step1NOT )=''), lkp_GetExpiringPriorPolicyKey_Step1,
	    (lkp_DeriveExpiringPriorPolicyKey_Step2 IS NULL and lkp_DeriveExpiringPriorPolicyKey_Step2 != 'N/A' AND lkp_DeriveExpiringPriorPolicyKey_Step2 <> '' and NOT LENGTH(lkp_DeriveExpiringPriorPolicyKey_Step2)>0 AND TRIM(lkp_DeriveExpiringPriorPolicyKey_Step2NOT )=''), lkp_DeriveExpiringPriorPolicyKey_Step2,
	    'N/A'
...
Exp_FinalDerivationOfExpiringPolicyKey AS (
	...
	DECODE(
	    True,
	    (ExpiringPriorPolicyKey_Step1_2 IS NULL and ExpiringPriorPolicyKey_Step1_2 != 'N/A' AND ExpiringPriorPolicyKey_Step1_2 <> '' and NOT LENGTH(ExpiringPriorPolicyKey_Step1_2)>0 AND TRIM(ExpiringPriorPolicyKey_Step1_2NOT )=''), ExpiringPriorPolicyKey_Step1_2,
	    (ExpiringPriorPolicyKey_Step3 IS NULL and ExpiringPriorPolicyKey_Step3 != 'N/A' AND ExpiringPriorPolicyKey_Step3 <> '' and NOT LENGTH(ExpiringPriorPolicyKey_Step3)>0 AND TRIM(ExpiringPriorPolicyKey_Step3NOT )=''), ExpiringPriorPolicyKey_Step3,
	    (ExpiringPriorPolicyKey_Step4 IS NULL and ExpiringPriorPolicyKey_Step4 != 'N/A' AND ExpiringPriorPolicyKey_Step4 <> '' and NOT LENGTH(ExpiringPriorPolicyKey_Step4)>0 AND TRIM(ExpiringPriorPolicyKey_Step4NOT )=''), ExpiringPriorPolicyKey_Step4,
	    'N/A'
	) AS o_ExpiringPriorPolicyKey
