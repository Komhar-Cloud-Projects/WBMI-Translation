...
EXP_Claimant_Coverage_Dim AS (
	...
	IFF(
	    in_claimant_cov_det_reserve_calculation_id_D IS NULL, - 1,
	...
	IFF(
	    in_claimant_cov_date_type IS NULL OR in_claimant_cov_date_type = 'N/A', 'N/A',
	...
	IFF(
	    claimant_cov_direct_loss_status_type IS NULL OR claimant_cov_direct_loss_status_type = 'N/A',
	    'N/A',
	    RTRIM(SUBSTR(claimant_cov_direct_loss_status_type, 2))
	...
	IFF(
	    in_claimant_cov_det_reserve_calculation_id_E IS NULL, - 1,
	...
	IFF(
	    claimant_cov_exp_status_type IS NULL OR claimant_cov_exp_status_type = 'N/A', 'N/A',
	...
	IFF(
	    in_claimant_cov_det_reserve_calculation_id_S IS NULL, - 1,
	...
	IFF(
	    claimant_cov_salvage_status_type IS NULL OR claimant_cov_salvage_status_type = 'N/A', 'N/A',
	...
	IFF(
	    in_claimant_cov_det_reserve_calculation_id_B IS NULL, - 1,
	...
	IFF(
	    claimant_cov_subgrogation_status_type IS NULL OR claimant_cov_subgrogation_status_type = 'N/A',
	    'N/A',
	...
	IFF(
	    in_claimant_cov_det_reserve_calculation_id_R IS NULL, - 1,
	...
	IFF(
	    claimant_cov_other_recovery_status_type IS NULL
	...
	IFF(
	    in_claimant_cov_supplemental_ind IS NULL OR in_claimant_cov_supplemental_ind = 'N/A', 'N/A',
	...
	IFF(
	    in_claimant_cov_financial_ind IS NULL OR in_claimant_cov_financial_ind = 'N/A', 'N/A',
	...
	IFF(
	    in_claimant_cov_recovery_ind IS NULL OR in_claimant_cov_recovery_ind = 'N/A', 'N/A',
	...
	IFF(
	    in_claimant_cov_notice_only_ind IS NULL OR in_claimant_cov_notice_only_ind = 'N/A', 'N/A',
	...
	IFF(
	    LTRIM(RTRIM(i_s3p_wc_class_descript)) IS NULL
	    or LENGTH(LTRIM(RTRIM(i_s3p_wc_class_descript)))>0
	    and TRIM(LTRIM(RTRIM(i_s3p_wc_class_descript)))='',
	    'N/A',
	...
	IFF(
	    lkp_loss_disability_descript IS NULL OR lkp_loss_disability_descript = 'N/A', 'N/A',
	...
	-- 
	IFF(
	    v_claimant_cov_date_type IS NULL,
	...
	IFF(
	    i_claimant_cov_eff_date IS NULL,
...
EXP_Verify_Lookup_Results AS (
	...
	IFF(
	    RTRIM(LTRIM(StandardInsuranceLineDescription)) IS NULL, 'N/A',
	...
	IFF(
	    RTRIM(LTRIM(StandardMajorPerilDescription)) IS NULL, 'N/A',
	...
	IFF(
	    RTRIM(LTRIM(StandardTypeBureauCode)) IS NULL, 'N/A', RTRIM(LTRIM(StandardTypeBureauCode))
	...
	IFF(
	    RTRIM(LTRIM(StandardTypeBureauCodeShortDescription)) IS NULL, 'N/A',
	...
	IFF(
	    RTRIM(LTRIM(StandardTypeBureauCodeLongDescription)) IS NULL, 'N/A',
	...
	IFF(
	    RTRIM(LTRIM(risk_unit_grp_descript)) IS NULL, 'N/A', RTRIM(LTRIM(risk_unit_grp_descript))
	...
	IFF(
	    RTRIM(LTRIM(StandardRiskUnitDescription)) IS NULL, 'N/A',
	...
	IFF(
	    RTRIM(LTRIM(reserve_ctgry_descript)) IS NULL, 'N/A', RTRIM(LTRIM(reserve_ctgry_descript))
