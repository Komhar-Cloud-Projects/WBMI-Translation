WITH
SQ_WbClPolicyStage AS (
	SELECT
		WBCLPolicyStageId AS WbClPolicyStageId,
		ExtractDate,
		SourceSystemId,
		WB_PolicyId,
		WB_CL_PolicyId,
		SessionId,
		ApplicantBuildingsMoreThan2Apartments,
		OperationType,
		OperationTypeNext30Days,
		DescriptionOfChildCarePremises,
		ChildCarePremisesOther,
		OperationTypePersonalAppearance,
		OperationTypeNext30DaysPersonalAppearance,
		DoNotAutomaticallyRenewThisPolicy,
		AlteredTermsRequired,
		SMARTIndicator,
		AuditType,
		AuditTypePolicyPeriodOverride,
		AuditTypePermanentOverride,
		AuditTypeOverrideReason,
		AssignedAuditor,
		AssignedAuditorPolicyPeriodOverride,
		AssignedAuditorPermanentOverride,
		AssignedAuditorOverrideReason,
		CloseAudit,
		CloseAuditReason,
		AuditPriority,
		HasCorrespondingFrontingPolicy,
		...
		IncludePolicy,
		MailPolicyToInsured,
		TaskFlagNewPolicyWCPoolWI,
		TaskFlagPolicyBound,
		TaskFlagPolicyIssued,
		TaskFlagWIPolicyTotalWrittenPremiumChangeAboveThreshold,
		TaskFlagPolicyCLTotalAboveThreshold,
		TaskFlagPolicyNSITotalAboveThreshold,
		TaskFlagFormSelectedWB2035,
		TaskFlagFormSelectedWB2044C,
		TaskFlagFormSelectedWB1514,
		TaskFlagFormSelectedWB1078,
		TaskFlagAuditPolicyCancelled,
		TaskFlagAuditPolicyCancelledWCPoolArgent,
		TaskFlagAuditPolicyReinstated,
		TaskFlagAuditRequiredMidTerm,
		TaskFlagAuditRequiredPremliminary,
		TaskFlagCancelNonPayReinsurance,
		TaskFlagCancelReinsurance,
		TaskFlagFormSelectedNW0034,
		TaskFlagFormSelectedNW0044,
		TaskFlagFormSelectedWB1558,
		TaskFlagFormSelectedWB2115,
		TaskFlagFormSelectedWB2138,
		TaskFlagFormSelectedWB2185,
		TaskFlagFormSelectedWB345,
		TaskFlagFormSelectedWB610,
		TaskFlagNewPolicy,
		TaskFlagPolicyCanceledWithFiling,
		TaskFlagPolicyCanceledWithNonPayFiling,
		TaskFlagPolicyCoverageRemovedWithFiling,
		TaskFlagPolicyEndorsement,
		TaskFlagPolicyFinalAudit,
		TaskFlagPolicyFinalAuditWithCustomerCare,
		TaskFlagPolicyFinalAuditWithReinsurer,
		TaskFlagPolicyReissue,
		TaskFlagPolicyRenewal,
		TaskFlagPolicyRewrite,
		TaskFlagPolicySignatureRequiredIteration,
		TaskFlagPolicyWithRiskGradeDNW,
		TaskFlagWIPolicyTotalWrittenPremiumAboveThreshold,
		TaskFlagPolicyWithReinsuranceAndCertificateReceived,
		TaskFlagFormSelectedWB1214,
		TaskFlagFormSelectedWB1214IA,
		TaskFlagFormSelectedWB1930,
		TaskFlagFormSelectedWB2580,
		IsBCCCodeHotelsAndMotels,
		NoteFlagLPServicesOrderedOnIssue,
		InitialPendingOnTransaction,
		StoreInfoAnswersOnApprove,
		StoreReferralAnswers,
		ReinsuranceApplied,
		ReinsuranceRemoved,
		AuditablePremium,
		SBOPIndicator,
		...
		TaskFlagLPServiceRequestArgent,
		TaskFlagLPServiceRequestNSI,
		TaskFlagLPServiceScheduledPolicyCancel,
		TaskFlagLPServiceScheduledPolicyCancelNonpayment,
		SAFER,
		USDOTNumber,
		FilingName,
		...
		Deleted,
		IsAtCollections,
		TaskFlagCancelPending,
		TaskFlagCancelPendingArgent,
		PreviousEffectiveDate,
		TaskFlagConversionProcessRenewal,
		TaskFlagPolicySMARTTotalAboveThreshold,
		CATotalLimitForReinsuranceTask,
		SMARTTotalLimitForReinsuranceTask,
		EstimatedQuotePremium,
		NoncomplianceofWCPoolAudit
	FROM WbClPolicyStage
),
EXP_Metadata AS (
	SELECT
	WbClPolicyStageId,
	...
	-- *INF*: DECODE(i_ApplicantBuildingsMoreThan2Apartments, 'T', '1', 'F', '0', 
	-- NULL)
	DECODE(
	...
	DECODE(
	    ...
	    'F', '0',
	    NULL
	) AS o_TaskFlagPolicyCoverageRemovedWithFiling1,
	...
	DECODE(
	    ...
	    'F', '0',
	    NULL
	) AS o_TaskFlagFormSelectedWB19301,
	...
	IsBCCCodeHotelsAndMotels AS i_IsBCCCodeHotelsAndMotels,
...
ArchWbClPolicyStage AS (
	...
	o_TaskFlagPolicyCoverageRemovedWithFiling1 AS TASKFLAGPOLICYCOVERAGEREMOVEDWITHFILING, 
	...
	o_TaskFlagFormSelectedWB19301 AS TASKFLAGFORMSELECTEDWB1930, 
