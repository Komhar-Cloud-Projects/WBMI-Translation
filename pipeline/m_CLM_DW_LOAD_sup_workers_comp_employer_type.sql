...
EXP_Detect_Changes AS (
	...
	IFF(OLD_sup_wc_emplyr_type_id IS NULL, 'NEW', IFF(LTRIM(RTRIM(OLD_emplyr_type_descript)) != ( LTRIM(RTRIM(employer_type_desc_OUT)) ), 'UPDATE', 'NOCHANGE')) AS V_changed_flag,
