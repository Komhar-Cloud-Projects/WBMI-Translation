...
EXP_GetValue AS (
	...
	IFF(i_BusinessClassDimId IS NULL,
		- 1,
		i_BusinessClassDimId
	...
	IFF(i_BusinessClassDescription IS NULL,
		'N/A',
		i_BusinessClassDescription
	) AS o_BusinessClassDescription,
	...
	IFF(i_BusinessSegmentCode IS NULL,
		'N/A',
		i_BusinessSegmentCode
	...
	IFF(i_BusinessSegmentDescription IS NULL,
		'N/A',
		i_BusinessSegmentDescription
	...
	IFF(i_StrategicBusinessGroupCode IS NULL,
		'N/A',
		i_StrategicBusinessGroupCode
	...
	-- 
	IFF(i_StrategicBusinessGroupDescription IS NULL,
		'N/A',
		i_StrategicBusinessGroupDescription
	...
	-- 
	IFF(i_ArgentBusinessSegmentCode IS NULL,
		'N/A',
		i_ArgentBusinessSegmentCode
	...
	IFF(i_ArgentBusinessSegmentDescription IS NULL,
		'N/A',
		i_ArgentBusinessSegmentDescription
	...
	-- ,'1','0')
	DECODE(TRUE,
		ExpirationDate != lkp_ExpirationDate 
		OR i_BusinessClassDescription != lkp_BusinessClassDescription 
