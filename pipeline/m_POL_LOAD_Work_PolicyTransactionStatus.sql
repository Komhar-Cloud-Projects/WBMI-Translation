...
EXP_Evaluate AS (
	...
	DECODE(
	    ...
	    arch_sar_yr2000_cust_use <> sar_yr2000_cust_use AND (arch_sar_agents_comm_rate <> sar_agents_comm_rate OR arch_sar_section <> sar_section OR arch_sar_class_code <> sar_class_code OR arch_sar_sub_line <> sar_sub_line), 'COVERAGEDETAILLEVELCHANGE'
	) AS v_Status_flag,
