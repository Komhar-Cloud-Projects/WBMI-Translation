...
Exp_Get_Values AS (
	...
	Decode(TRUE,
		...
		TransactionTypeCode = 'Reissue', '30',
		TransactionTypeCode = 'Rewrite', '31',
		'-1') AS o_standardPremiumTransactionCode,
	-- *INF*: IIF(ISNULL(:LKP.LKP_RATINGCOVERAGE(CoverageKey)),-1,:LKP.LKP_RATINGCOVERAGE(CoverageKey))
	IFF(LKP_RATINGCOVERAGE_CoverageKey.RatingCoverageAKID IS NULL, - 1, LKP_RATINGCOVERAGE_CoverageKey.RatingCoverageAKID) AS v_RatingCoverageAkid,
	...
	TRUNC(GREATEST(TransactionCreatedDate, TransactionEffectiveDate), 'MM') AS v_TransactionIssueDate,
	-- *INF*: TRUNC(GREATEST(v_TransactionIssueDate,v_ExtractDate), 'MM')
	TRUNC(GREATEST(v_TransactionIssueDate, v_ExtractDate), 'MM') AS o_TransactionIssueDate,
	TransactionReasonCode,
	DeductibleAmount,
	0 AS o_ExperienceModificationFactor,
	-- *INF*: TO_DATE('12/31/2100 23:59:59','MM/DD/YYYY HH24:MI:SS')
	TO_DATE('12/31/2100 23:59:59', 'MM/DD/YYYY HH24:MI:SS') AS o_ExperienceModificationEffectiveDate,
	...
	TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS') AS o_StateRatingEffectiveDate,
...
EXP_Input_CFA AS (
	...
	-- )
	IFF(NOT LKP_SUPSTATECFAXREF_PERCENT_PolicyStateCode_pol_eff_date.CFARate IS NULL, LKP_SUPSTATECFAXREF_PERCENT_PolicyStateCode_pol_eff_date.CFARate, LKP_SUPSTATECFAXREF_PERCENT__N_A_pol_eff_date.CFARate) AS v_CFARate,
	-- *INF*: GREATEST(TRUNC(v_ExtractDate,'MM'),TRUNC(PremiumTransactionEffectiveDate,'MM'),TRUNC(EffectiveDate,'MM'))
	-- 
	-- 
	-- 
	GREATEST(TRUNC(v_ExtractDate, 'MM'), TRUNC(PremiumTransactionEffectiveDate, 'MM'), TRUNC(EffectiveDate, 'MM')) AS o_BookedDate,
	...
	-- 
	-- 
	IFF(LKP_CFATransactionEffectiveDate IS NULL, TO_DATE('01/01/1800 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), LKP_CFATransactionEffectiveDate) AS v_CFATransactionEffectiveDate,
