...
Exp_SetDefaultValue AS (
	...
	UDF_DEFAULT_VALUE_FOR_INTEGERS(i_contract_cust_dim_id) AS o_contract_cust_dim_id,
	...
	UDF_DEFAULT_VALUE_FOR_STRINGS(i_cust_num) AS o_cust_num,
	0 AS MasterFlag,
	...
	UDF_DEFAULT_VALUE_FOR_INTEGERS(i_ContractCustomerEmailAddressAKID) AS o_ContractCustomerEmailAddressAKID,
	...
	UDF_DEFAULT_VALUE_FOR_INTEGERS(i_ContractCustomerEmailAddressID) AS o_ContractCustomerEmailAddressID
