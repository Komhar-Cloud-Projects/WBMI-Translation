...
SQ_claim_transaction AS (
	...
	WHERE CT.err_flag > = 0
	---AND CT.claim_trans_id IN (5410504,5410505,5410506,5410507,5410574,5410575,5410576,5410577)
),
EXP_Default AS (
	SELECT
	claim_trans_id,
...
EXP_Derive_Values AS (
	...
	mplt_Coverage_Temp_Policy_Transaction_Attributes.risk_state_prov_code_Out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.risk_zip_code_Out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.terr_code_Out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.tax_loc_Out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.class_code_Out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.exposure_Out AS exposure_out,
	mplt_Coverage_Temp_Policy_Transaction_Attributes.sub_line_code_Out,
	...
	-- *INF*: DECODE(TRUE, 
	-- IN(risk_state_prov_code_Out,'60','61','62','63','64','65','66','67','68','69','70','71','72','73','74','75','76','77','78','79','80') AND pms_trans_code = '25',1,
	...
	-- 
	DECODE(TRUE,
		risk_state_prov_code_Out IN ('60','61','62','63','64','65','66','67','68','69','70','71','72','73','74','75','76','77','78','79','80') 
