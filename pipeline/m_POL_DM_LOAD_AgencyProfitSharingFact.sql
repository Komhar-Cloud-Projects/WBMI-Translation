...
EXP_DefaultHandle3 AS (
	...
	IFF(
	    i_ProfitSharingEligibleDirectWrittenPremium IS NULL, 0,
	...
	IFF(
	    i_ProfitSharingEligibleDirectEarnedPremium IS NULL, 0,
	...
	-- 
	IFF(
	    i_ProfitSharingEligibleDirectIncurredLoss IS NULL, 0,
...
Exp_DataCollect AS (
	...
	IFF(
	    LKP_SALESDIVISIONDIM_AgencyCode.SalesDivisionDimID IS NULL, - 1,
...
EXP_Data_PrimaryAgency AS (
	...
	IFF(
	    LKP_SALESDIVISIONDIM_LegalPrimaryAgencyCode.SalesDivisionDimID IS NULL, - 1,
...
EXP_CalValues_PrimaryAgency AS (
	...
	DATE_PART(RunDate, 'MM') AS v_RunMonth,
	...
	IFF(
	    v_RunMonth IN ('10','11','12'), i_GuaranteeFee_Sep,
	    IFF(
	        v_ProfitSharingGuaranteeFlagFinal = '1', ROUND(v_ProfitSharingCommission * .15, 4),
	        0
	    )
	) AS v_GuaranteeFee,
	...
	IFF(
	    v_RunMonth IN ('10','11','12'),
	    IFF(
	        i_GuaranteedCommission > v_NetProfitSharingAmount, i_GuaranteedCommission,
	...
	ON LKP_SUPPROFTSHARINGBONUS_TO_INTEGER_ROUND_i_ProfitSharingEligibleDirectWrittenPremium_ROUND_v_NetLossRatio_1.DirectWrittenPremiumLow = CAST(ROUND(i_ProfitSharingEligibleDirectWrittenPremium) AS INTEGER)
