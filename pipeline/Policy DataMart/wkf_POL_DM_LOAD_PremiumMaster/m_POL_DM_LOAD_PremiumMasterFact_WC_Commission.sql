...
EXP_CalculateCommission AS (
	...
	--                                           ,'MI',59)
	--                                ,'SS',59)
	SET_DATE_PART(SET_DATE_PART(SET_DATE_PART(last_day(add_to_date(sysdate, 'MM', @{pipeline().parameters.NUM_OF_MONTH})), 'HH', 23), 'MI', 59), 'SS', 59) AS v_PremiumMasterBookedDate,
	...
	ON LKP_CALENDER_DIM_to_date_to_char_v_PremiumMasterBookedDate_MM_DD_YYYY_MM_DD_YYYY.clndr_date = to_date(to_char(v_PremiumMasterBookedDate, 'MM/DD/YYYY'), 'MM/DD/YYYY')
