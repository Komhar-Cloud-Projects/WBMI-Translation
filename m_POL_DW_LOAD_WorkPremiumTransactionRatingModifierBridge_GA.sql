...
EXP_Modifiers AS (
	...
	IFF(i_RiskUnitGroup != 'N/A', i_RiskUnitGroup, '000') AS v_RiskUnitGroup,
	...
	IFF(NOT v_Modifier IS NULL, v_Modifier, LKP_ARCHPIF43RXGASTAGE_i_PolicyKey_v_RiskUnitGroup_0000.Modifiers) AS v_Modifier_RiskUnitGroup,
	...
	IFF(NOT v_Modifier_RiskUnitGroup IS NULL, v_Modifier_RiskUnitGroup, LKP_ARCHPIF43RXGASTAGE_LOCATION_i_PolicyKey_v_LocationUnitNumber.Modifiers) AS v_Modifier_Location,
	-- *INF*: IIF(NOT ISNULL(v_Modifier_Location),v_Modifier_Location,:LKP.LKP_ArchPif43RXGAStage_Location(i_PolicyKey,'0000'))
	IFF(NOT v_Modifier_Location IS NULL, v_Modifier_Location, LKP_ARCHPIF43RXGASTAGE_LOCATION_i_PolicyKey_0000.Modifiers) AS v_Modifier_Final,
